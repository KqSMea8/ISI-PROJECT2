...
Disallow: /tmp/
Disallow: /temp/
Disallow: /http://sklepkrokodyl.pl/regulamin-pm-5.html
Disallow: /http://sklepkrokodyl.pl/polityka-prywatnosci-pm-13.html
Disallow: *.pdf
Sitemap: http://skorzanyraj.pl/sitemap.xml
