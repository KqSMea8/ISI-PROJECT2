...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Playfair+Display|Didact+Gothic&subset=latin-ext" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556139749"></script>
...
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1464282263" />
...
<a href="index.php" class="logo"><h2><img src="data/files/publicity_clear.jpg" style="border:0" id="WebsiteLogo" alt="" /><span></span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.ipublicity.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/communication_kid.jpg" data-parallax="1"  data-align="keditRight"  class=" parallax-window  keditDark  koHeaderHide  keditRight " style="background: url(data/files/communication_kid.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright (c)2015, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/publicitypublicity"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
