...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/18a.png" />
<link rel="shortcut icon" href="data/files/18a.png" />
<link rel="apple-touch-icon" href="data/files/18a.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556131405"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="systemy ochrony przeciwslonecznej, markizy, rolety, refleksole, zaluzje, sunbreaker, system veranda, produkty marki SELT" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; ADRAMA systemy ochrony przeciwslonecznej</title>
...
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(data/files/page_3.jpg);}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_desktop.css?1456345126" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>.container_content{background:none;}#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/ghj.goy.png" style="border:0" id="WebsiteLogo" alt="ADRAMA Systemy Ochrony Przeciwslonecznej" /></a>
...
<li ><a href="http://www.adrama.pl/"><span>Home</span></a></li>
<li ><a href="1_5_produkty.html" rel="dropmenu_1_5"><span>Produkty</span></a></li>
<li ><a href="1_48_galeria.html"><span>Galeria</span></a></li>
...
<h2><span class="CurrentPageName">Blad 404: Strona nie istnieje!<span class="CurrentPageName"><strong><span class="CurrentPageName"><a href="index.php?p=1_6_markizy"><span class="CurrentPageName"><br /></span></a></span></strong></span></span></h2>
</div>
</div></div></div></div>
...
<div class="margins">
<div class="row-fluid" style="margin-left: 180px; text-align: left;"><form action="index.php" method="get"></form><form style="margin-left: 30px;" action="index.php" method="get"><span style="color: #ffffff;"><span style="font-size: 12px; line-height: 1.6;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><a href="http://www.adrama.pl/"><span style="font-size: 12px; line-height: 1.6;"><span style="color: #ffffff;">HOME </span></span></a>&nbsp; <a style="font-size: 12px; line-height: 1.6;" href="index.php?p=1_5_produkty"><span style="color: #ffffff;">PRODUKTY</span></a>&nbsp; &nbsp;<a style="font-size: 12px; line-height: 1.6;" href="1_48_galeria.html"><span style="color: #ffffff;">GALERIA</span></a>&nbsp; &nbsp;<a style="font-size: 12px; line-height: 1.6;" href="index.php?p=1_4_kontakt"><span style="color: #ffffff;">KONTAKT</span></a>&nbsp; &nbsp; </span><br /><br /><span style="color: #000000;">&nbsp;<span style="color: #ffffff;">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ADRAMA Tomasz Obzejta Al.Jerozolimskie 135/94 02-304 Warszawa</span></span><br /><span style="color: #ffffff;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; tel: 781 23 23 34&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; e-mail: kontakt@adrama.pl</span><span style="color: #ffffff;"><br /></span></form></div>
</div>
</div>        </div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-37465931-1']);
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$("body").backstretch("data/files/_mg_4356duzy1.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
