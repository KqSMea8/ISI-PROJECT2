...
<link rel="bookmark" href="data/files/logoblackznak.png" />
<link rel="shortcut icon" href="data/files/logoblackznak.png" />
<link rel="apple-touch-icon" href="data/files/logoblackznak.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Josefin+Slab|Josefin+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Josefin+Slab|Josefin+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Josefin Slab","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Josefin Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556050571"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="produkcja i projektowanie opraw oswietleniowych, oprawy typu LED, oprawy oswietleniowe biurowe, oprawy dostosowane do potrzeb klienta, oprawy do oswietlenia sklepow, oprawy do oswietlenia polek regalowych sklepowych" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Danler</title>

</head>
<body class="koThemeDark" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1480620637" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {}

.koTheme1 #headerMenu {border:none} </style>
...
<a href="index.php" class="logo"><img src="data/files/logowhite.png" style="border:0" id="WebsiteLogo" alt="DANLER" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://danler.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<li  ><a href="1_6_abc-oswietlenia.html"><span>ABC&nbsp;oswietlenia</span></a></li>
<li  ><a href="1_7_ogolne-warunki-sprzedazy.html"><span>Ogolne&nbsp;warunki&nbsp;sprzedazy</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#000000" data-background="data/files/lantern-2677894_1920.jpg" data-align="keditLeft"  class=" keditDark  keditLeft " style="background:#000000 url(data/files/lantern-2677894_1920.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 DANLER, All Rights Reserved.</div>
</div>
