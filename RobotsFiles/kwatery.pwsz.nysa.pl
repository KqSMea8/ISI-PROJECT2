...
var dane = { "loginuzytkownika": loginuzytkownika,csrfmiddlewaretoken:'gRfU7R9pLQDv0hmGizVXMa7Z6dGZx8wP' };
...
<form method="post" action="/lista/pokaz/"><input type='hidden' name='csrfmiddlewaretoken' value='gRfU7R9pLQDv0hmGizVXMa7Z6dGZx8wP' />
Tytul ogloszenia: <br>
...
<form method="post" action="/accounts/authorization/"><input type='hidden' name='csrfmiddlewaretoken' value='gRfU7R9pLQDv0hmGizVXMa7Z6dGZx8wP' />
...
<form method="post" onsubmit="wyslij_nowe_haslo();" action="javascript:void(0);"><input type='hidden' name='csrfmiddlewaretoken' value='gRfU7R9pLQDv0hmGizVXMa7Z6dGZx8wP' />
<div class="body-srodek-dodawanie">
