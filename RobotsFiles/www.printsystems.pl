...
# You can find an MU-plugin to ban robots not obeying "nofollow" rules here: https://github.com/szepeviktor/wordpress-plugin-construction/blob/master/mu-nofollow-robot-trap/nofollow-robot-trap.php

# 2015.07.28 Googlebot needs JS and CSS
...
# kostenlose Backlinkchecker von Torsten Ruckert Internetdiestleistungen
...
User-agent: MJ12bot
Crawl-delay: 10
Disallow: /printsystems/wp-admin/

User-agent: Googlebot
Disallow: /wp-admin/

#Sitemap: https://www.printsystems.pl/sitemap.xml
#Sitemap: https://www.printsystems.pl/sitemap_index.xml
################
