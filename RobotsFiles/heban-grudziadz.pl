...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/img0021.png" />
<link rel="shortcut icon" href="data/files/img0021.png" />
<link rel="apple-touch-icon" href="data/files/img0021.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556079480"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Stolarnia HEBAN FPUH Tadeusz Czyzak - Grudziadz. Wykonujemy drzwi drewniane wewnetrzne i zewnetrzne, okna, okiennice, balustrady, meble ogrodowe. Najnizsze ceny tylko u nas. Sprzedaz tarcicy." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Stolarnia HEBAN FPUH Tadeusz Czyzak - Grudziadz</title>


<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />

<link href="inc/js/bootstrap/bootstrap.css?1419857735" rel="stylesheet">
<link href="data/templates/ko02/images/bootstrap-responsive-2.css?1419857735" rel="stylesheet">
...
<link type="text/css" rel="stylesheet" href="data/templates/ko02/images/style_template.css" />
<link type="text/css" rel="stylesheet" href="data/templates/ko02/images/style_content.css" />
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_ko02.css?1445195742" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style>
...
<a href="index.php" class="logo"><img src="data/files/img0002_1444848011.png" style="border:0" id="WebsiteLogo" alt="HEBAN" /></a>
...
<li ><a href="http://heban-grudziadz.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div class="margins"><span id="footerHitCounter">Liczba odwiedzin: 27437</span></div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> FPUH <em>HEBAN</em>,<br /> Wszelkie Prawa Zastrzezone</div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-69010140-1']);
