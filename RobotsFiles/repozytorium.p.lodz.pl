...
# The http://repozytorium.p.lodz.pl will be auto-filled with the value in dspace.cfg
# XML sitemap is listed first as it is preferred by most search engines
Sitemap: http://repozytorium.p.lodz.pl/sitemap
Sitemap: http://repozytorium.p.lodz.pl/htmlmap
