...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556115011"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; LIBERAVIS</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1545380334" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>LIBERAVIS</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://liberavis.pl/"><span>Home</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderContent" data-background="data/files/theme/3-1.jpg" data-parallax="1"  class=" parallax-window  keditDark  kfilter1 " style="background: url(data/files/theme/3-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#d8d8d8" class=" keditDark " style="background:#d8d8d8">

<div class="kedit keditRow keditLeft" id="kpg_330258" data-align="keditLeft">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_781" ><div class="keditable keditable-auto">Copyright (c)2018 LIBERAVIS, All Rights Reserved.</div></div>
</div>
