<head>
<title>Gminny Osrodek Sportu i Rekreacji Gminy Debica</title>
...
<link rel="shortcut icon" href="https://bip-files.idcom-web.pl/sites/47137/favicon/favicon.ico?123" />
...
'<p style="display: inline-block; padding: 20px 20px 0px 20px;">Strona ta wykorzystuje pliki cookies w celu realizacji swoich uslug i funkcji zgodnie z <a href="http://gosrdebica.bipstrona.pl/cookie" style="color: #ffffff;"><u>Polityka Plikow Cookies</u></a>. Mozesz samodzielnie dostosowac warunki przechowywania lub dostepu do plikow cookies w Twojej przegladarce.</p>'+
