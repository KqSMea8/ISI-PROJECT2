...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556050803"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Nazwa strony - slogan, haslo reklamowe</title>
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_contrast.css?1525297058" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style></style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Nazwa strony</h2><h4>slogan, haslo reklamowe</h4></div><!--Logo--></a>
...
<li ><a href="http://davincidigitech.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<li><a href="index.php?p=1_3_galeria-zdjec"><span>Galeria&nbsp;Zdjec</span></a></li>
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
</ul> <br /> <br /> Zeby modyfikowac footer (stopke), <a href="admin.php?p=teditor&amp;template=contrast&amp;tab=footer#footer">kliknij tutaj</a>. Mozesz tutaj dodac jakas tresc, np. numer telefonu, link lub dodatkowe informacje.</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> My Company,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <span id="footerHitCounter">Liczba odwiedzin: 4092</span></div>
</div>        </div>
</div>
</div>
</div>
