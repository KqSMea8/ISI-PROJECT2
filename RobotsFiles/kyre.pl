...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/zrzutekranu2016-12-21o22.12.18-kopia.png" />
<link rel="shortcut icon" href="data/files/zrzutekranu2016-12-21o22.12.18-kopia.png" />
<link rel="apple-touch-icon" href="data/files/zrzutekranu2016-12-21o22.12.18-kopia.png" /><script>var tinyMcePath="/";</script><script src="/inc/js/tinymce/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Avenir|Avenir&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Avenir|Avenir&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556114417"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="PROJEKTOWANIE INSTALACJI, WYKONASWTWO I NADZOR
OFERTY, KONSULTACJE, ADAPTACJE.
INSTALACJE CO, WOD KAN OGZEWANIE PODLOGOWE." />
<meta name="keywords" content="ogrzewanie podlogowe, grzejniki, woda, kanalizacja, zawory, rozdzielacze, projektowanie, design, oferowanie, konsultacje, nadzor, wylewka, stelaze podtynkowe, TECEflex, TECEfloor, TECEprofil, automatyka, WLM, sterowanie, silowniki, anhydryt, dylatacje." />
<title>Blad 404: Strona nie istnieje! &raquo; KYRE HVAC Consulting &amp; Designing</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1483014547" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {color:#fff}#headerMenu.koMenu3 .topmenu a:hover {color:rgba(255,255,255,0.7);} </style>
...
<a href="index.php" class="logo"><img src="data/files/logobyfreelogo.me-2.png" style="border:0" id="WebsiteLogo" alt="KYRE" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://kyre.pl/"><span>Home</span></a></li>
<li  ><a href="kontakt"><span>Kontakt</span></a></li>
<li  ><a href="http://www.kyre.com.pl" target="_blank"><span>Shop</span></a></li>
<li  ><a href="http://www.stelazepodtynkowe.pl" target="_blank"><span>Blog</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderContent" data-background="data/files/theme/8-1.jpg" data-parallax="1"  class=" parallax-window  keditDark " style="background: url(data/files/theme/8-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#000000" class=" keditDark " style="background:#000000">

<div data-pcid="1250" id="kpg_686066" class="kedit keditRow kfilter1">


<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_676851" ><div class="keditable">KYRE (c)2017, Wszelkie Prawa Zastrzezone</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_426691" ><div class="keditable keditable-auto"><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Stelaze-podtynkowe-194978100911346"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div></div></div>
</div>
</div>
