...
# The http://tandis.odihr.pl will be auto-filled with the value in dspace.cfg
# XML sitemap is listed first as it is preferred by most search engines
Sitemap: http://tandis.odihr.pl/sitemap
Sitemap: http://tandis.odihr.pl/htmlmap
Sitemap: ${resourcesync.base-url}
