...
<link rel="stylesheet" type="text/css" href="http://www.kurzatkowski.pl/wp-content/plugins/maintenance/lib/style.css" />
...
body { background:
#fff
url(http://www.kurzatkowski.pl/wp-content/plugins/maintenance/lib/images/theme-bg-default.jpg) repeat-x scroll 0 0;}
...
<script type="text/javascript" src="http://www.kurzatkowski.pl/wp-content/plugins/maintenance/lib/js/jquery.placeholder.js"></script>
<script type="text/javascript">
$(document).ready(function() {
...
<div id="wrapper">
<div class="company">
<a href="http://www.kurzatkowski.pl"><img src="http://www.kurzatkowski.pl/wp-content/plugins/maintenance/lib/images/fruitfulcode.png" alt="logo"/></a>
</div>
...
<span>Please login to see website</span>
</div>
...
<input type="hidden" name="redirect_to" value="http://www.kurzatkowski.pl" />
</div>
