...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Brawler|Varela+Round&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Brawler|Varela+Round&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Brawler","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556058887"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Maciej Kowalski ENERES</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://eneres.pl/"><span>O&nbsp;firmie</span></a></li>
<li  ><a href="1_5_uslugi.html"><span>Uslugi</span></a></li>
<li  ><a href="1_8_realizacje.html"><span>Realizacje</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#78909C" data-parallax="1"  class=" parallax-window  keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#78909C">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2017 Maciej Kowalski Eneres, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/EneresMaciejKowalski"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
