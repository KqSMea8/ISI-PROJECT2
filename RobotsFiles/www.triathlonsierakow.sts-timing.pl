...
<html>
<head>
<title>STS-TIMING.PL - REJESTRACJA Triathlon Sierakow 2015 - Sierakow - 30-31.05.2015</title>
...
var twoja_pocz = document.getElementById('twoja_pocz');
var telefon = document.getElementById('telefon');
var dodatkowa1 = document.getElementById('dodatkowa1');
var error = 0;
...
if(!dodatkowa1.value.length){
document.getElementById('error_dodatkowa1').className = 'error';
error = 1;
}
else{
document.getElementById('error_dodatkowa1').className = 'ok';
}


var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
if(reg.test(twoja_pocz.value) == false){
document.getElementById('error_twoja_pocz').className = 'error';
error = 1;
}
else{
document.getElementById('error_twoja_pocz').className = 'ok';
}
if(error == 0){
...
<tr valign="middle">
<td colspan="3">
<div class="center"><p class="head">STS-TIMING.PL - REJESTRACJA / REGISTRATION<br>Triathlon Sierakow 2015<br>Sierakow - 30-31.05.2015</p></div>
<div class="center"><p class="head"> <a href="lista.php">LISTA STARTOWA / START LIST - Triathlon Sierakow 2015</a></p></div>
