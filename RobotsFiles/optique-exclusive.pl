Sitemap: https://optique-exclusive.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://optique.pl/sitemap.xml.gz
...
Disallow: /*noproduct.php?reason=product?lang=pol
Disallow: /*noproduct.php?reason=product?lang=eng
