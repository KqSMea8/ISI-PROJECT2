...
<link rel="bookmark" href="data/files/logokwadrat.jpg" />
<link rel="shortcut icon" href="data/files/logokwadrat.jpg" />
<link rel="apple-touch-icon" href="data/files/logokwadrat.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Catamaran|Montserrat&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Catamaran|Montserrat&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Catamaran","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Montserrat","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556131938"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Aneta Nowakowska Photography</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1476996986" />
...
<a href="index.php" class="logo"><img src="data/files/anplogoverost500.png" style="border:0" id="WebsiteLogo" alt="Aneta Nowakowska Photography" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.anetanowakowska.pl/"><span>MENU</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialInstagramHover" target="_blank" href="http://instagram.com/anetasnowakowska"><i class="fa fa-instagram"></i></a><a class="koSocialPinterestHover" target="_blank" href="http://pinterest.com/asnowakowska"><i class="fa fa-pinterest"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-background="data/files/tlo.jpg" data-align="keditLeft"  class=" keditLeft " style="background: url(data/files/tlo.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div style="text-align: left;"><span style="font-size: 12px;">Copyright &copy;2018 anetanowakowska.pl -&nbsp;all rights reserved</span></div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://instagram.com/anetasnowakowska"><i class="fa fa-instagram fa-2x fa-fw"></i></a><a target="_blank" href="http://pinterest.com/asnowakowska"><i class="fa fa-pinterest fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
