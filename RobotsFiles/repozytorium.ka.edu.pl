...
# The https://repozytorium.ka.edu.pl/ will be auto-filled with the value in dspace.cfg
# XML sitemap is listed first as it is preferred by most search engines
Sitemap: https://repozytorium.ka.edu.pl//sitemap
Sitemap: https://repozytorium.ka.edu.pl//htmlmap
