...
# Pages
Disallow: /*best-sales
Disallow: /*content/6-jak-zamawiac
Disallow: /*content/3-regulamin-sklepu
Disallow: /*content/2-pytania-odpowiedzi
Disallow: /*content/5-bezpieczne-platnosci
# Sitemap
Sitemap: https://www.strefa998.pl/1_index_sitemap.xml
