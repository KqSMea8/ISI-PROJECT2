Sitemap: https://crystaline.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://crystaline.pl/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: *firm-pol-*
Disallow: *-DAMSKA-*
Disallow: *_LINIA-DAMSKA-*
Disallow: *_LINIA-MESKA-*
Disallow: /signin.php
Disallow: *?source*Disallow: /checkup.php
