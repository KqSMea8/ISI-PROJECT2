Sitemap: https://picco.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://picco.pl/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: /Polityka-dotyczaca-wykorzystania-cookies-cterms-pol-39.html
Disallow: /Regulamin-cterms-pol-29.htmlDisallow: /checkup.php
