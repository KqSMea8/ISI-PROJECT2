...
<title>Blad 404: Strona nie istnieje! &raquo; GrafAS</title>

</head>
<body class="koThemeDark"  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1516629017" /><style> .koTheme1  .logoHolder #logoReplacer h2 {     line-height: 80px;     display: inline-block;     outline: 3px solid #FFF; outline-offset:-10px;     padding-right: 30px;     padding-left: 30px; }
...
<a href="index.php" class="logo"><img src="data/files/logo-grafas-waciwe-srebro-i-bordo-2012-07-25-proba.png" style="border:0" id="WebsiteLogo" alt="GrafAS" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://grafas.pl/"><span>O&nbsp;firmie</span></a></li>
...
<div id="subpageHeaderContent" data-background="data/files/theme/14-1.jpg" class=" keditDark " style="background: url(data/files/theme/14-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit keditRow" id="kpg_600">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_31" ><div class="keditable keditable-auto">Copyright (c)2018 GrafAS, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_702" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/reklamowa.grafas"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://twitter.com/Twitter"><i class="fa fa-twitter fa-2x fa-fw"></i></a><a target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube fa-2x fa-fw"></i></a></ul><style></style></div></div>
</div>
</div>
</div>
