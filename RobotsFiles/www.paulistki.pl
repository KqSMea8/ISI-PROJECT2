...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556150941"></script>
...
<div id="keditFooterModule"><span id="footerHitCounter">Liczba odwiedzin: 2481</span></div>
</div>
</div>
</div>
</div>
