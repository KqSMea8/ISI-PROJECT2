...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556050387"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Dach Top</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1488060061" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {color:#fff}#headerMenu.koMenu3 .topmenu a:hover {color:rgba(255,255,255,0.7);} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Dach Top</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://dachtop-wlodawa.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="1_3_uslugi.html"><span>Uslugi</span></a></li>
<li  ><a href="1_5_realizacje.html"><span>Realizacje</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/img-707888.jpg" data-align="keditRight"  class=" keditDark  koHeaderAutoHeight  keditRight  kfilter3 " style="background:#90A4AE url(data/files/img-707888.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2017 Agnieszka Florek. flobit@op.pl, All Rights Reserved.</div></div>
</div>
