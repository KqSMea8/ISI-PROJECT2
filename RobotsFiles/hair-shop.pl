...
Sitemap:http://hair-shop.pl/modules/iqitcontentcreator/export/iqcreator/sitemap.xml
Sitemap:http://hair-shop.pl/modules/iqitmegamenu/models/mega/sitemap.xml
User-agent: *
# Allow Directives
Allow: */modules/*.css
Allow: */modules/*.js
...
# Sitemap
Sitemap: http://nowy.hair-shop.pl/1_index_sitemap.xml
