Sitemap: https://www.bizuteriazegarki.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://www.bizuteriazegarki.pl/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: /noproducts.php
Disallow: /search.php?firm=*&node=*&text=*Disallow: /checkup.php
