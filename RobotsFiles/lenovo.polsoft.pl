...
# Sitemap
Sitemap: http://lenovo.polsoft.pl/1_index_sitemap.xml
# Allow Directives
Allow: */modules/*.css
Allow: */modules/*.js
Allow: */modules/themeconfigurator/img
Allow: */modules/homeslider/images/*.*
Allow: */modules/homesliderpro/images/*.*
Allow: */modules/smartblog/images/*.*
Allow: */modules/tmmegamenu/images/*.*
Allow: */modules/tmmediaparallax/media/*.*
