Sitemap: https://wstadzie.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://wstadzie.iai-shop.com/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: *text=*
Disallow: /cat-pol-*
Disallow: /Dostawa-cinfo-pol-4.html
Disallow: /Linki-clinks-pol-8.html
Disallow: /Pomoc-chelp-pol-2.html
Disallow: /news.php?zone=2
