#Blokujemy niepotrzebne roboty, ktore zuzywaja zapytania do bazy danych
User-agent: MJ12bot
Disallow: /
...
#Blokowanie katalogow i motobazy
User-agent: *
...
Disallow: /temp/
Disallow: /motobaza*/
Disallow: /index.php?motor_category_id=*
Disallow: /errordoc/

#Pozwol google na analize
