...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556113436"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Krajowy Osrodek Medycyny Hiperbarycznej - Gdynia, Polska</title>
...
<link href="http://fonts.googleapis.com/css?family=Amaranth|Varela+Round&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Amaranth","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_stretched.css?1451463692" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>.container_top,.container_header,.container_splash2,.container_content{background:none;}#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/logopanorama.jpg" style="border:0" id="WebsiteLogo" alt="Krajowy Osrodek Medycyny Hiperbarycznej" /></a>
...
<li ><a href="http://komh.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="index.php?p=1_2_nasz-osrodek"><span>Nasz&nbsp;Osrodek</span></a></li>
<li ><a href="index.php?p=1_9_kursy"><span>Kursy</span></a></li>
<li ><a href="index.php?p=1_6_publikacje"><span>Publikacje</span></a></li>
<li ><a href="index.php?p=1_7_projekty"><span>Projekty</span></a></li>
<li ><a href="index.php?p=1_8_wspolpraca"><span>Wspolpraca</span></a></li>
...
<li><a href="index.php?p=1_8_wspolpraca"><span>Wspolpraca</span></a></li>
<li><a href="index.php?p=1_5_kontakt"><span>Kontakt</span></a></li>
</ul> <br /> <br />Kontakt: komh@komh.pl</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">2015-2018 (c)<!--?php echo date("Y")?--> KOMH GUMED,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-65038577-1-']);
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files/panorama_q1.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
