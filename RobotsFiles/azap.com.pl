...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Oswald|Open+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Oswald|Open+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Oswald","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Open Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556040913"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; AZAP</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481102655" /><style>.koTheme2 #header { background-color: #2b3a42;} .koTheme2 #headerMenu { margin: 0 100px;} .koTheme2 .menuHolder li a {color: #fff; }</style>
...
<a href="index.php" class="logo"><img src="data/files/logo-azap.png" style="border:0" id="WebsiteLogo" alt="AZAP" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://azap.com.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="o-nas"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="oferta" rel="dropmenu_1_5"><span>Oferta</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/baner_1482152503.jpg" data-align="keditLeft"  class=" koHeaderAutoHeight  keditLeft " style="background: url(data/files/baner_1482152503.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<li><a href="oferta-opony-radialne-hilo"><span>Opony&nbsp;radialne&nbsp;HILO</span></a></li>
<li><a href="oferta-opony-diagonalne"><span>Opony&nbsp;diagonalne</span></a></li>
<li><a href="opony-ceizarowe-annaite"><span>Opony&nbsp;ciezarowe&nbsp;firmy&nbsp;ANNAITE</span></a></li>
<li><a href="oferta-felgi-do-maszyn-budowlanych"><span>Felgi&nbsp;do&nbsp;maszyn&nbsp;budowlanych</span></a></li>
<li><a href="oferta-a-cuchy"><span>Lancuchy</span></a></li>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 AZAP, All Rights Reserved.</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 1586</span></div>
</div>
</div>
</div>
</div>
