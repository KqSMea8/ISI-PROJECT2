...
<meta name="description" content="ESTATUS Biuro Wycen Majatkowych" />
<meta name="keywords" content="wycena nieruchomosci operat szacunkowy kredyt bankowy oszacowac wartosc rynkowa" />
<title>Blad 404: Strona nie istnieje! &raquo; ESTATUS Biuro Wycen Majatkowych</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1511447838" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {color:#fff}#headerMenu.koMenu3 .topmenu a:hover {color:rgba(255,255,255,0.7);} </style>
...
<a href="index.php" class="logo"><img src="data/files/estatuslogobyfreelogo.me_1511460519.png" style="border:0" id="WebsiteLogo" alt="ESTATUS Biuro Wycen Majatkowych" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://estatus.pl/"><span>Strona&nbsp;glowna</span></a></li>
...
<div id="subpageHeaderContent" data-bgcolor="#90A4AE" data-background="data/files/theme/8-1.jpg" data-align="keditRight"  class="keditDark"  data-old-class="   koHeaderAutoHeight  keditRight  kfilter3 " style="background:#90A4AE url(data/files/theme/8-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit keditRow" id="kpg_760">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_781" ><div class="keditable keditable-auto">(c)2017 ESTATUS All Rights Reserved</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_52" ><div class="footerHolder" id="keditFooterModule"></div></div>
</div>
</div>
</div>
