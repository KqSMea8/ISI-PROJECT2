Sitemap: https://www.labut.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://www.labut.pl/sitemap.xml.gz
User-agent: *
Disallow: /signin.php
Disallow: /signin.php?operation=client_orders_rma
...
Disallow: /search.php*
Disallow: /signin.php
Crawl-delay: 5Disallow: /checkup.php
