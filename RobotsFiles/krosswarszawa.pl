Sitemap: https://kupserower.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://nowakolekcjarowerow.pll/sitemap.xml.gz
...
disallow: /Regulamin-sklepu-cterms-pol-1.htmlDisallow: /checkup.php
