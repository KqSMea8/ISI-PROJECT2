...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556124724"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; schody-kotowski.pl - Dlubiemy w drewnie</title>
...
<body><link type="text/css" rel="stylesheet" href="style_extra.css?2.0" /><style></style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>schody-kotowski.pl</h2><h4>Dlubiemy w drewnie</h4></div><!--Logo--></a>
...
<li ><a href="index.php?p=1_3_galeria"><span>Galeria</span></a></li>
<li ><a href="index.php?p=1_2_oferta"><span>Oferta</span></a></li>
<li ><a href="http://schody-kotowski.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
</ul> <br /> <br /> Kopage SiteBuilder dostarczyl HEKKONET, (c)2015, wersja: 2.0</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Tomcio<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
<script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_top").backstretch("data/templates/builder/images/header_4280091.png",{centeredRight:true});k_Backstretch++;}kBackstretch();</script></body>
</html>
