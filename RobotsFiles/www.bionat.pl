...
<link rel="bookmark" href="data/files/logor-pantone-www-ma-e.gif" />
<link rel="shortcut icon" href="data/files/logor-pantone-www-ma-e.gif" />
<link rel="apple-touch-icon" href="data/files/logor-pantone-www-ma-e.gif" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556133122"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Bionat. Polprodukty dla piekarni i cukierni. Srodki wypiekowe. Zakwas piekarski BIO. Polepszacze. Mieszanki wieloziarniste. Makrowit. Pomoc technologiczna." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Bionat. Polprodukty dla piekarni i cukierni. Zakwas BIO.</title>
...
<link href="http://fonts.googleapis.com/css?family=Ubuntu|Varela+Round&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Ubuntu","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(data/files/orawski-t-o-www-15x9.jpg);}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_rocksand.css?1416573165" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style></style>
...
<a href="index.php" class="logo"><img src="data/files/logor-pantone-www-ma-e.gif" style="border:0" id="WebsiteLogo" alt="Strona Glowna" /></a>
...
<li ><a href="http://www.bionat.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="bionat-galeria-zdja-a"><span>Galeria&nbsp;Zdjec</span></a></li>
<li ><a href="bionat-kontakt"><span>Kontakt</span></a></li>
<li ><a href="produkty" rel="dropmenu_1_14"><span>Piekarnictwo</span></a></li>
...
<div class="container_splash2 adminTipHolder"><div class="container"><div class="grid_16" id="splash2"><div class="row-fluid"><br />&nbsp;</div></div></div></div>
...
<div class="margins"><br />Copyright (c)<!--?php echo date("Y")?--> My Company,<br />Wszelkie Prawa Zastrzezone <br /><br /><ul class="social_fa social_bw social_bwh social_footer"></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-76110523-1']);
