...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Droid+Serif|Merriweather&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Droid+Serif|Merriweather&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Droid Serif","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Merriweather","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
<title>Blad 404: Strona nie istnieje! &raquo; A&amp;A Motor&#039;s</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1480757543" /><style>.topmenu a {border-radius:0 15px 0 15px}</style>
...
<a href="index.php" class="logo"><h2><img src="data/files/logo.jpg" style="border:0" id="WebsiteLogo" alt="A&amp;A Motor&#039;s" /><span>A&amp;A Motor&#039;s</span></h2></a>
</div>
...
<li  ><a href="http://aamotors.pl/"><span>Strona&nbsp;Glowna</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#dbe5f1" data-background="data/files/replacement_car_parts.jpg" class=" kfilter1 " style="background:#dbe5f1 url(data/files/replacement_car_parts.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 A&A Motor's, All Rights Reserved.</div>
</div>
