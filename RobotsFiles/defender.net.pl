Sitemap: https://defender.net.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://www.defender.net.pl/sitemap.xml.gz
User-agent: *
...
Disallow: *text=*
Disallow: *date=*
Disallow: *getProductXML=*
Disallow: *last_visited=*
Disallow: *firm=*
Disallow: *Stare-menu*
Disallow: /pol_m_Dla-motocyklisty_Kaski-962.htmlDisallow: /checkup.php
