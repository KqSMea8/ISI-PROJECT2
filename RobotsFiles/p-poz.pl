...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo-small.png" />
<link rel="shortcut icon" href="data/files/logo-small.png" />
<link rel="apple-touch-icon" href="data/files/logo-small.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556120114"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; P-poz Ochrona przeciwpozarowa - Szybko i profesjonalnie</title>


<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />

<link href="inc/js/bootstrap/bootstrap.css?1419857734" rel="stylesheet">
<link href="data/templates/crowd/images/bootstrap-responsive-2.css?1419857734" rel="stylesheet">
...
<link type="text/css" rel="stylesheet" href="data/templates/crowd/images/style_template.css" />
<link type="text/css" rel="stylesheet" href="data/templates/crowd/images/style_content.css" />
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_crowd.css?1427749335" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>.container_splash2{background:none;}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>P-poz Ochrona przeciwpozarowa</h2><h4>Szybko i profesjonalnie</h4></div><!--Logo--></a>
...
<li ><a href="http://p-poz.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="oferta" rel="dropmenu_1_2"><span>Oferta</span></a></li>
<li ><a href="porady" rel="dropmenu_1_3"><span>Porady</span></a></li>
<li ><a href="akty-prawne-ppoz"><span>Prawo</span></a></li>
<li ><a href="czujniki-czadu"><span>Czujniki&nbsp;czadu</span></a></li>
<li ><a href="sprzet-serwisowy"><span>Sprzet&nbsp;serwisowy</span></a></li>
<li ><a href="znakii"><span>Znaki</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?-->&nbsp;<a href="http://p-poz.pl/">P-poz Ochrona przeciwpozarowa</a>,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files/logo.png",{centeredRight:true});k_Backstretch++;}kBackstretch();</script></body>
</html>
