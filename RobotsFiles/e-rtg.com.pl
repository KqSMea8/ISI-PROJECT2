...
<link rel="bookmark" href="data/files/logo_1554754092.png" />
<link rel="shortcut icon" href="data/files/logo_1554754092.png" />
<link rel="apple-touch-icon" href="data/files/logo_1554754092.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Dosis|Varela+Round&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Dosis|Varela+Round&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Dosis","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556107302"></script>
...
<a href="index.php" class="logo"><h2><img src="data/files/logo_1554754092.png" style="border:0" id="WebsiteLogo" alt="Rentgen stomatologiczny" /><span>Rentgen stomatologiczny</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://e-rtg.com.pl/"><span>Home</span></a></li>
...
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/e-rtg"><i class="fa fa-facebook-square"></i></a><a class="koSocialYouTubeHover" target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#1A237E" data-background="data/files/theme/hospital.jpg" data-align="keditRight"  class=" keditDark  keditRight " style="background:#1A237E url(data/files/theme/hospital.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#448AFF" class=" keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#448AFF">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2019 eRTG, All Rights Reserved.</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/e-rtg"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
