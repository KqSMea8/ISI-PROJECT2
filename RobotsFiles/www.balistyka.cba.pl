...
User-agent: dialogsearch.com
Disallow: /

User-agent: diffbot
Disallow: /

User-agent: dj-research
Disallow: /

User-agent: DomainAppender
Disallow: /

User-agent: DomainMacroCrawler
Disallow: /
...
User-agent: JS-Kit URL Resolver
Disallow: /
...
User-agent: newsme/1.0; feedback@news.me
Disallow: /
...
User-agent: Pulsepoint XT3 web scraper
Disallow: /
...
Disallow: /stab/
Disallow: /przyst/
Disallow: /parabolka.xls


#User-agent: 65.36.241.79
#Disallow: /
