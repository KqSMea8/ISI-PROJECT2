...
<script type="text/javascript" src="http://formwell.pl/js/local.js" ></script>
<link href="http://formwell.pl/css/reset.css" type="text/css" rel="stylesheet" />
<link href="http://formwell.pl/css/portal.css" type="text/css" rel="stylesheet" />
<link href="http://formwell.pl/css/sg.css" type="text/css" rel="stylesheet" />
<link href="http://formwell.pl/css/cookieinfo.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="http://formwell.pl/js/ga.js"></script>
<script type="text/javascript" src="http://formwell.pl/js/jquery-min.js"></script>
<script type="text/javascript" src="http://formwell.pl/js/swfobject.js"></script>


<!--[if IE 6]>
<script type="text/javascript" src="http://formwell.pl/js/jquery/pngFix.js"></script>
...
<div id="top2">
<div id="logo">
<a id="logo2" href="http://formwell.pl/" title="Formwell.pl">
...
<form name="odh" method="post" action="index.php" id="odh" onsubmit="return spr_form_odh(); "><input type="hidden" name="akcja" value="u_od2" /><div style="padding-top:10px;">adres e-mail:</div><div style="padding-top:5px;"><input type="text"  name="login" id="loginod" class="f_sredni" value="" maxlength="50" /></div><div style="padding-top:5px;"><input type="submit"  class="formularz2 f_krotki formularz2spec" value="wyslij" /></div><div style="padding-top:10px;"></div><div style="padding-top:10px;"><a class="odzyskloginpan" href="index.php?akcja=u_zaloguj" >Powrot do logowania</a></div><input type="hidden"  name="crtoken" id="odh_crtoken" value="404e15cfdd6bb6a991e053b635c73346" /></form></div></div></div><div id="logowaniepan"><div class="zalogujpang"><div><b>Zaloguj sie</b></div></div><div  class="zalogujpand"><div class="zalogujpand2"><script type="text/javascript">
...
<script src="http://formwell.pl/js/cookieinfo.js"></script>
</body></html>
