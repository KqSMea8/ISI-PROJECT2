...
<a href="http://vincio.pl"><div class="menu-logo-new"></div></a>
</div>
<div class="menu-links-new">
<a id="menu-1"href="/obraz-na-plotnie.html">Oferta</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-107"href="/Koszty_dostawy.html">Koszty dostawy</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-108"href="/Dlaczego_warto.html">Dlaczego warto?</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-109"href="/O_nas.html">O nas</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-31"href="/FAQ_-_Najcz%C4%99%C5%9Bciej_zadawane_pytania.html">FAQ</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-106"href="/Bezpiecze%C5%84stwo_zakup%C3%B3w.html">Bezpieczenstwo zakupow</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-105"href="/Rejestracja.html">Rejestracja</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-29"href="/regulamin_sklepu.html">Regulamin sklepu</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-6"href="/Podgl%C4%85d_koszyka.html">Koszyk</a><span class="menu-link-sep">&nbsp;|&nbsp;</span><a id="menu-11"href="/Sklep-z-obrazami-kontakt.html">Kontakt</a>
</div>
<form class="menu-form-new" method="post" action="http://vincio.pl/Wyszukiwarka.html">
...
<option value="obraz_drukowany_58" selected="selected">Obraz drukowany</option>
<option value="obraz_olejny_57">Obraz olejny</option>
<option value="fototapeta_609">Fototapeta</option>
<option value="obraz_malowany_675">Obraz malowany</option>
<option value="malowanka_dla_dzieci_689">Pojedyncza malowanka</option>
<option value="fotozegar_na_plotnie_947">Obrazy z zegarem</option>
<option value="naklejka_1166">Naklejka napisowa</option>
<option value="naklejka_kolorowa_1167">Naklejka kolorowa</option>
<option value="okleina_1257">Okleina</option>
<option value="naklejka_na_drzwi_1285">Naklejka na drzwi</option>
</select>
</label>
</div>
...
$.ajax({
url: 'http://vincio.pl/autocomplete/gallerySearch/' + $('.menu-search-input select').val() + '/' + request.term,
dataType: "json",
...
<a href="http://vincio.pl/Logowanie.html" class="jq-rep">
...
console.log('/obraz-na-plotnie.html' + 'features-' + $(this).find('input').val());
window.location.href = '/obraz-na-plotnie.html' + '?features-' + $(this).find('input').val();
...
window.location.href = '/obraz-na-plotnie.html' + queryLink;
});
...
<a href="http://vincio.pl"><div class="footer-logo"></div></a>
<div id="innerfooter">
<div class="footer-menu-link">

<a id="menu-1"
href="/obraz-na-plotnie.html">Oferta</a>
<span class="menu-link-sep">&nbsp;|&nbsp;</span>

<a id="menu-107"
href="/Koszty_dostawy.html">Koszty dostawy</a>
<span class="menu-link-sep">&nbsp;|&nbsp;</span>

<a id="menu-108"
href="/Dlaczego_warto.html">Dlaczego warto?</a>
<span class="menu-link-sep">&nbsp;|&nbsp;</span>

<a id="menu-109"
href="/O_nas.html">O nas</a>
<span class="menu-link-sep">&nbsp;|&nbsp;</span>
...
<a id="menu-106"
href="/Bezpiecze%C5%84stwo_zakup%C3%B3w.html">Bezpieczenstwo zakupow</a>
<span class="menu-link-sep">&nbsp;|&nbsp;</span>
...
<a id="menu-29"
href="/regulamin_sklepu.html">Regulamin sklepu</a>
<span class="menu-link-sep">&nbsp;|&nbsp;</span>
...
<a id="menu-11"
href="/Sklep-z-obrazami-kontakt.html">Kontakt</a>
