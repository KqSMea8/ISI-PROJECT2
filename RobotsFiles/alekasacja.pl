...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Allerta+Stencil|Oswald&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Allerta+Stencil|Oswald&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Allerta Stencil","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Oswald","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
<title>Blad 404: Strona nie istnieje! &raquo; ALE KASACJA</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1523955675" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/logo1.png" style="border:0" id="WebsiteLogo" alt="ALE KASACJA" /><span>ALE KASACJA</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://alekasacja.pl/"><span>Strona&nbsp;glowna</span></a></li>
<li  ><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="1_5_skup-aut.html"><span>Skup&nbsp;aut</span></a></li>
<li  ><a href="1_6_sprzedaz-czesci.html"><span>Sprzedaz&nbsp;czesci</span></a></li>
<li  ><a href="1_7_skup-zlomu.html"><span>Skup&nbsp;zlomu</span></a></li>
<li  ><a href="1_8_ubezpieczenia.html"><span>Ubezpieczenia</span></a></li>
...
<div id="subpageHeaderContent" data-bgcolor="#90A4AE" data-background="data/files/to.jpg" class=" keditDark " style="background:#90A4AE url(data/files/to.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit keditRow koZeroPadding keditDark" id="kpg_290" data-background="data/files/to.jpg" style="background: url(data/files/to.jpg) no-repeat center center;background-size:cover"><div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_891"><div class="keditable">(c)2018, All Rights Reserved</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_432" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/AleKasacja"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 15200</span></div></div>
</div>
</div></div>
