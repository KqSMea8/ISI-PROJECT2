...
Disallow: /*n=
Disallow: /content/1-dostawa-platnosci
Disallow: /content/3-regulamin-sklepu
Disallow: /content/2-polityka-prywatnosci?content_only=1
Disallow: /content/9-polityka-cookies?content_only=1
Disallow: /logowanie
Disallow: /logowanie?back=my-account
Disallow: /logowanie?back=history
Disallow: /logowanie?back=addresses
...
# Sitemap
Sitemap: http://fitness-food.pl/sitemap.xml
