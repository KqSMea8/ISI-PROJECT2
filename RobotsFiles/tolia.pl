Sitemap: https://tolia.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://www.toison.pl/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: /data/include/cms/toison/gazetka_interaktywna_toison_sierpien_2012.pdf
