...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556146006"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Mikrotronik Piotr Czarnecki Malgorzata Czarnecka Spolka Jawna</title>

</head>
<body class="" data-bgcolor="#ffffff" style="background:#ffffff" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1543786644" /><style>     .koTheme2 #contentArea,.koTheme2 #headerMenu {     margin: 0 5%;} .koTheme2 #header{margin:50px 0} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Mikrotronik Piotr Czarnecki Malgorzata Czarnecka Spolka Jawna</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.mikrotronik.com.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2018 Mikrotronik Piotr Czarnecki Malgorzata Czarnecka Spolka Jawna, All Rights Reserved.</div>
</div>
