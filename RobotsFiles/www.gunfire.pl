Sitemap: https://gunfire.com/sitemap.xml.gz
...
User-agent: TwengaBot-2.0
Disallow: /
Sitemap: http://gunfire.com/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: /affiliate-calculations.php?lang=engDisallow: /checkup.php
Disallow: /affiliate-clients.html
Disallow: /search.php
Disallow: /parameters
