...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556122521"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; PROSPE - big-bagi</title>
...
<link href="http://fonts.googleapis.com/css?family=Roboto|Roboto&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Roboto","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Roboto","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_stretched.css?1445293671" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>.container_splash2{background:none;}#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>PROSPE</h2><h4>big-bagi</h4></div><!--Logo--></a>
...
<li ><a href="http://prospe.pl/"><span>Strona&nbsp;glowna</span></a></li>
<li ><a href="index.php?p=1_8_o-nas"><span>O&nbsp;Nas</span></a></li>
<li ><a href="index.php?p=1_5_oferta"><span>Oferta</span></a></li>
<li ><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li ><a href="index.php?p=1_7_sklep"><span>Sklep</span></a></li>
...
<li><a href="index.php?p=1_2_strona-glowna"><span>Strona&nbsp;glowna</span></a></li>
<li><a href="index.php?p=1_8_o-nas"><span>O&nbsp;Nas</span></a></li>
<li><a href="index.php?p=1_5_oferta"><span>Oferta</span></a></li>
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li><a href="index.php?p=1_7_sklep"><span>Sklep</span></a></li>
</ul> <br /> <br /> Zeby modyfikowac footer (stopke), <a href="admin.php?p=teditor&amp;template=stretched&amp;tab=footer#footer">kliknij tutaj</a>. Mozesz tutaj dodac jakas tresc, np. numer telefonu, link lub dodatkowe informacje.</div>
</div>
...
<script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/templates/stretched/images/un29bw.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
