...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo-ikonka.png" />
<link rel="shortcut icon" href="data/files/logo-ikonka.png" />
<link rel="apple-touch-icon" href="data/files/logo-ikonka.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556039891"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Zapraszam na warsztaty rozwojowe, na ktorych uczymy sie relaksu, medytacji, wizualizacji i intuicyjnego malowania. Mozesz zmienic swoje zycie, poznac swoje przeznaczenie, skorygowac bledy, uwolnic sie od negatywnych uczuc, odzyskac radosc zycia i spokoj." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; ART-LIFE Tworcze Zycie</title>
...
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Neuton","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Lora","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_book.css?1427000596" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>.container_content{background:none;}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/logo-same-litery.png" style="border:0" id="WebsiteLogo" alt="ART-LIFE" /></a>
...
<li ><a href="https://art-life.pl/"><span>Witamy</span></a></li>
...
<div class="margins"><span style="color: #047f64;">Copyright (c)<!--?php echo date("Y")?--> ART-LIFE Tworcze Zycie,</span><br /><span style="color: #047f64;"> Wszelkie Prawa Zastrzezone </span></div>
</div>        </div>
</div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$("body").backstretch("data/files/rozblysk.gif");k_Backstretch++;}kBackstretch();</script></body>
</html>
