...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556130481"></script>
...
<li ><a href="http://wianki.net.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Folk Flora,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <span id="footerHitCounter">Liczba odwiedzin: 810</span></div>
</div>        </div>
</div>
</div>
</div>
