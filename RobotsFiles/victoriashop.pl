...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556129750"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Victoria Shop Sp. z o.o.</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1477464710" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {color:#fff}#headerMenu.koMenu3 .topmenu a:hover {color:rgba(255,255,255,0.7);} </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/logo_fb.jpg" style="border:0" id="WebsiteLogo" alt="Victoria Shop Sp. z o.o." /><span>Victoria Shop Sp. z o.o.</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://victoriashop.pl/"><span>Home</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/victoriashoppoland"><i class="fa fa-facebook-square"></i></a><a class="koSocialGoogleHover" target="_blank" href="http://plus.google.com/115722997680916159629"><i class="fa fa-google-plus-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/theme/8-1.jpg" data-align="keditRight"  class=" keditDark  koHeaderAutoHeight  keditRight  kfilter3 " style="background:#90A4AE url(data/files/theme/8-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
