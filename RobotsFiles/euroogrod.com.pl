Sitemap: https://euroogrod.com.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://euroogrod.com.pl/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: /data/include/cms/GEOSIATKI-OFERTA-EUROOGROD_COM_PL.pdf
