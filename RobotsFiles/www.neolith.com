...
Crawl-Delay: 10
Sitemap: https://www.neolith.com/sitemap_index.xml
...
User-agent: Baiduspider+(+http://www.baidu.jp/spider/)
User-agent: Baiduspider-image
User-agent: Baiduspider-video
User-agent: Black Hole
User-agent: BlackWidow
User-agent: BlackWidow 4.40
User-agent: cfetch/1.0
User-agent: CheeseBot
User-agent: CherryPicker
User-agent: Comodo+HTTP(S)+Crawler
...
User-agent: flash processor
User-agent: flash+processor
User-agent: flatlandbot
User-agent: flatlandbot/baypup
...
User-agent: Mozilla/5.0 (compatible; YandexBlogs/0.99; robot; B; +http://yandex.com/bots)
User-agent: Mozilla/5.0 (compatible; YandexBot/3.0; +http://yandex.com/bots)
User-agent: Mozilla/5.0 (compatible; YandexBot/3.0; MirrorDetector; +http://yandex.com/bots)
User-agent: Mozilla/5.0 (compatible; YandexMedia/3.0; +http://yandex.com/bots)
...
User-agent: Yanga WorldSearch Bot v1.1/beta (http
User-agent: Yeti
...
# No rastrear parametro Product-cata

Disallow: /*?product-cata=
Noindex: /*?product-cata=
