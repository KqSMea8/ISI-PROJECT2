...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Architects+Daughter|Architects+Daughter&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Architects+Daughter|Architects+Daughter&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Architects Daughter","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Architects Daughter","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556067187"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; GARDA - SPORT - Super Slogan</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1535712338" />
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/3-logo.png" style="border:0" id="WebsiteLogo" alt="GARDA-SPORT" /><span>GARDA-SPORT</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="index.php?p=1_1_o-firmie"><span>O&nbsp;firmie</span></a></li>
<li  ><a href="index.php?p=1_2_kontakt"><span>Kontakt</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-background="data/files/theme/3-1.jpg" data-parallax="1"  data-align="keditRight" class=" parallax-window  keditRight " style="background: url(data/files/theme/3-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2018 GARDA-SPORT, All Rights Reserved.</div>
</div>
