...
<link rel="bookmark" href="Copyright (c)2017 {%WebsiteName%}" />
<link rel="shortcut icon" href="Copyright (c)2017 {%WebsiteName%}" />
<link rel="apple-touch-icon" href="Copyright (c)2017 {%WebsiteName%}" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556143372"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Strona internetowa parafii sw. Krzyza w Szczecinie" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Parafia p.w. Sw. Krzyza w Szczecinie</title>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Parafia p.w. Sw. Krzyza</h2><h4>ul. Wieniawskiego 4, Szczecin</h4></div><!--Logo--></a>
...
<li ><a href="index.php?p=1_2_duszpasterstwo" rel="dropmenu_1_2"><span>Duszpasterstwo</span></a></li>
<li ><a href="index.php?p=1_11_informacje" rel="dropmenu_1_11"><span>Informacje</span></a></li>
<li ><a href="index.php?p=1_10_historia"><span>Historia</span></a></li>
...
<div class="margins">Parafia Rzymskokatolicka p.w. Swietego Krzyza, ul. Wieniawskiego 4, 71 - 142 Szczecin<br />T: +48 91 487 33 63</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Numer rachunku Parafii:<br />PKO Bank Polski S.A. I/O w Szczecinie<br />70-404 Szczecin Al. Niepodleglosci 40<br />78 1020 4795 0000 9702 0105 4014&nbsp;<br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files/3.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
