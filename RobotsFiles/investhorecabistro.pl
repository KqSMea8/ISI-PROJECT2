...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556097371"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; INVEST HORECA BISTRO</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481718555" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>INVEST HORECA BISTRO</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://investhorecabistro.pl/"><span>Start</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#ECEFF1" data-parallax="1"  class=" parallax-window  koHeaderAutoHeight " style="background:#ECEFF1">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 Nazwa Firmy, All Rights Reserved.</div>
</div>
