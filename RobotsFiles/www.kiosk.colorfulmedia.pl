# robots.txt assssutomaticaly generated by PrestaShop e-commerce open-source solution
...
# Sitemap
Sitemap: http://www.kiosk.colorfulmedia.pl/1_index_sitemap.xml
