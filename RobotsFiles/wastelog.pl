...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556130140"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Wastelog - Domy modulowe</title>
...
<body><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>.container_header{background:none;}#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Wastelog</h2><h4>Domy modulowe</h4></div><!--Logo--></a>
...
<li ><a href="http://wastelog.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="index.php?p=1_2_domy"><span>Domy</span></a></li>
<li ><a href="index.php?p=1_3_garaze"><span>Garaze</span></a></li>
<li ><a href="index.php?p=1_4_hale"><span>Hale</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Wastelog,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
</style><a href="http://www.ibc.pl/kreator" class="poweredBy"><em><img src="editor_images/favicon.png" alt=""></em> <span class="poweredBy"> Strona zbudowana z  Kopage<br /><strong>&larr; Zbuduj swoja teraz</strong></span></a>
...
<a href="http://www.ibc.pl/kreator" class="kopageBarPowered">Powered by Kopage</a>
</div>
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$("body").backstretch("data/templates/nature2/images/un2.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
