...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556132237"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; ARSTOL</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1504855006" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>ARSTOL</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.arstol.com.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/img-2165756.jpg" data-align="keditLeft"  class=" keditDark  koHeaderAutoHeight  keditLeft " style="background: url(data/files/img-2165756.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2017 ARSTOL, All Rights Reserved.</div>
</div>
