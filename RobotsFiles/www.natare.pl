...
Allow: /modules/x13privacymanager/views/fonts/
Allow: /themes/leo_otis/css/
Allow: /themes/leo_otis/img/
Allow: /themes/leo_otis/js/
Allow: /img/

Sitemap: http://natare.pl/1_index_sitemap.xml
