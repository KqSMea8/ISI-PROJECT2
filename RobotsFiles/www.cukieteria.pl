...
Allow: /*modules/*.png
Allow: /*modules/*.gif
Allow: /*themes/leo_happycook/*.js
Allow: /*themes/leo_happycook/*.css
Allow: /*themes/leo_happycook/*.jpg
Allow: /*themes/leo_happycook/*.png
Allow: /*themes/leo_happycook/*.gif
...
# Sitemap
Sitemap: http://cukieteria.pl/sitemap.xml
