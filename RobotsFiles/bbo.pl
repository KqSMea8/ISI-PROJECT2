...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556041582"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; bbo.pl</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1532866903" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><img src="data/files/bbo_logo_fin_02_pngkopia.png" style="border:0" id="WebsiteLogo" alt="bbo.pl" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://bbo.pl/"><span>O&nbsp;nas</span></a></li>
<li  ><a href="1_3_juliusz-verne.html"><span>Juliusz&nbsp;Verne</span></a></li>
<li  ><a href="1_1_mirek-misayat.html"><span>Mirek&nbsp;Misayat</span></a></li>
...
<div id="subpageHeaderContent" data-bgcolor="#90A4AE" class=" keditDark  koZeroPadding " style="background:#90A4AE">
</div>
...
<div class="kedit keditRow koZeroPadding" id="kpg_840">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_11" ><div class="keditable keditable-auto">Copyright (c)2018 bbo.pl, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_142" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/brak.biblioteczki.oglupia"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div></div>
</div>
</div>
</div>
