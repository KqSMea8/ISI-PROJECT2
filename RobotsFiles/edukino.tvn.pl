...
User-agent: *
Disallow: /materials_double,{1}\d+,{2}\d+.html
Disallow: /materials,{1}\d+,{2}\d+.html
Disallow: /tvnplayer,{1}\d+.html
Disallow: /epg,{1}\d+.html
Disallow: /quiz,{1}\d+.html
Disallow: /social_media_aggregate,{1}\d+.html
