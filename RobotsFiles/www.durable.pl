...
Disallow: /system/                            # Nothing to see here
Disallow: /localConfiguration/
Disallow: /pic_alg/
Disallow: /*.pdf$
Disallow: /*?id=*                             # Disable non-realurl
Disallow: /*?query=*
Allow: /typo3conf/ext/nxs_templates/Resources/Public/Durable/css/
Allow: /*.js
Allow: /*.css
Allow: /*.jpg
Allow: /*.png

Sitemap: https://www.durable.pl/sitemap.xml
