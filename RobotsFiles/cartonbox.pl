Sitemap: https://cartonbox.pl/sitemap.xml.gz
...
User-agent: Yandex
Disallow: /
Sitemap: http://www.cartonbox.pl/sitemap.xml.gz
User-agent: *
Crawl-delay: 1
...
Disallow: /Regulamin-cterms-pol-19.html
Disallow: /Polityka-Prywatnosci-cterms-pol-20.htmlDisallow: /checkup.php
