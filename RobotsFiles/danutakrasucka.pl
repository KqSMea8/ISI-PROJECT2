...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556050588"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Danuta Krasucka Fotograf</title>

</head>
<body class="koThemeDark" data-bgcolor="#212121" style="background:#212121" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1536954048" /><style>


.koTheme3 #headerMenu{position:absolute;top:-120px;}

.koTheme3 #header{margin-top:150px}
.koTheme3 #website{box-shadow:0 0 50px rgba(0,0,0,0.5)}
.koTheme3 .koMenu3 .logoHolder h2 {color:rgba(0,0,0,0.8)}


.koTheme3 .koThemeDark #headerMenu.koMenu3 .topmenu a:hover,.koTheme3 .koThemeDark #headerMenu.koMenu3 .topmenu .active a {     color: rgba(255,255,255,0.7); border-color:#fff }
...
<a href="index.php" class="logo"><h2><img src="data/files/logo12.jpg" style="border:0" id="WebsiteLogo" alt="Danuta Krasucka Fotograf" /><span>Danuta Krasucka Fotograf</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://danutakrasucka.pl/"><span>Strona&nbsp;glowna</span></a></li>
<li  ><a href="1_3_o-mnie.html"><span>O&nbsp;mnie</span></a></li>
...
<div id="subpageHeaderContent" data-align="keditLeft"  class="koZeroPadding keditDark"  data-old-class="     keditLeft " style="background:">
</div>
...
<div data-pcid="1252" id="kpg_803426" class="kedit keditRow koZeroPadding">
...
<div class="kedit" id="kpg_649372" ><div class="keditable">
(c)2018, Wszelkie Prawa Zastrzezone</div></div>
</div>
<div class="col-sm-3 keditColumn">
<div class="kedit" id="kpg_628981" ><div class="keditable keditable-auto"><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/539456532853396"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div></div></div>
</div>
</div>
</div>
