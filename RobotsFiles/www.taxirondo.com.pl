...
SetEnvIfNoCase User-Agent "^Sogou webSpider/3.0" bad_bot
...
SetEnvIfNoCase User-Agent "^Xenu's LinkSleuth 1.1c" bad_bot
...
SetEnvIfNoCase User-Agent "^KenjinSpider" bad_bot
