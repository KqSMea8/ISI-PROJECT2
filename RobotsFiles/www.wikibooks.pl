...
#
# Te strony nie pojawia sie w wynikach wyszukiwania Google'a
#
Disallow: /wiki/Wikibooks:Strony_do_usuni%C4%99cia
Disallow: /wiki/Wikibooks%3AStrony_do_usuni%C4%99cia
Disallow: /wiki/Wikibooks:Strony_do_usuni%C4%99cia/
Disallow: /wiki/Wikibooks%3AStrony_do_usuni%C4%99cia/
Disallow: /wiki/Wikibooks:Ekspresowe_kasowanko
Disallow: /wiki/Wikibooks%3AEkspresowe_kasowanko
Disallow: /wiki/Wikibooks:Bar
Disallow: /wiki/Wikibooks%3ABar
Disallow: /wiki/Wikibooks:Bar/
Disallow: /wiki/Wikibooks%3ABar/
Disallow: /wiki/WB:
Disallow: /wiki/WB%3A

# Don't index blacklist stuff
Disallow: /wiki/MediaWiki:Spam-blacklist
Disallow: /wiki/MediaWiki%3ASpam-blacklist
