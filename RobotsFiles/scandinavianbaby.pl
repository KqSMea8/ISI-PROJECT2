Sitemap: https://scandinavianbaby.pl/sitemap.xml.gz
...
Disallow: /
Sitemap: http://scandinavianbaby.pl/sitemap.xml.gz
...
Disallow: /search.php
Disallow: /settings.php
Disallow: *lang=eng&lang=eng*Disallow: /checkup.php
