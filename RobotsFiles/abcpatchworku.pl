...
<link rel="bookmark" href="data/files/abcfaviconx.png" />
<link rel="shortcut icon" href="data/files/abcfaviconx.png" />
<link rel="apple-touch-icon" href="data/files/abcfaviconx.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; ABCpatchworku.pl - Jak uszyc patchwork od A do Z, najlepszy internetowy kurs patchworku</title>


<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />

<link href="inc/js/bootstrap/bootstrap.css?1419857734" rel="stylesheet">
<link href="data/templates/simple/images/bootstrap-responsive-2.css?1419857734" rel="stylesheet">
...
<link type="text/css" rel="stylesheet" href="data/templates/simple/images/style_template.css" />
<link type="text/css" rel="stylesheet" href="data/templates/simple/images/style_content.css" />
...
<link href="http://fonts.googleapis.com/css?family=Alegreya+Sans|Istok+Web&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,h3,#content h3,.topmenu{font-family:"Alegreya Sans","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Istok Web","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_simple.css?1424724466" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>.container_splash2,.container_content{background:none;}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/abclogox.png" style="border:0" id="WebsiteLogo" alt="ABCpatchworku.pl" /></a>
...
<li ><a href="http://abcpatchworku.pl/"><span>Glowna</span></a></li>
<li ><a href="zanim-zaczniesz" rel="dropmenu_1_2"><span>Zanim&nbsp;zaczniesz</span></a></li>
<li ><a href="krok-po-kroku" rel="dropmenu_1_12"><span>Krok&nbsp;po&nbsp;kroku</span></a></li>
<li ><a href="bloki" rel="dropmenu_1_5"><span>Bloki</span></a></li>
<li ><a href="techniki-zszywania" rel="dropmenu_1_6"><span>Techniki</span></a></li>
<li ><a href="o-stronie" rel="dropmenu_1_36"><span>O&nbsp;stronie</span></a></li>
<li ><a href="czytanki"><span>Czytanki</span></a></li>
<li ><a href="galeria-patchworkow"><span>Galeria</span></a></li>
<li ><a href="prawa-i-zasady"><span>Prawa&nbsp;i&nbsp;Zasady</span></a></li>
...
<div style="text-align: center;"><span style="font-size: 18px;"><strong><a href="https://plus.google.com/114700624375861772808" rel="publisher"><span style="color: #800000;"><img title="ABC logo star" src="data/files/abciconsmall.png" alt="ABC-ikonka" width="54" height="54" /><br /><span style="font-size: 16px;">ABCpatchworku na Google+</span></span></a></strong></span></div>
<div style="text-align: center;"><strong><br /><span style="color: #333300;">Copyright (c)<!--?php echo date("Y")?--> 2015 ABCpatchworku.pl</span></strong><br /><span style="color: #333300;"><strong> Wszelkie Prawa Zastrzezone</strong> </span><br /> <br /> </div>        </div>
</div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files/abcbanner.png");k_Backstretch++;}kBackstretch();</script></body>
</html>
