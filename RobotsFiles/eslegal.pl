...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/favicon_xxx.ico" />
<link rel="shortcut icon" href="data/files/favicon_xxx.ico" />
<link rel="apple-touch-icon" href="data/files/favicon_xxx.ico" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556059620"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Prawo dla biznesu. Kancelaria Radcy Prawnego dla klientow biznesowych. Specjalizacje: prawo telekomunikacyjne, pracy, gospodarcze, zobowiazan." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; ESLEGAL to krakowska kancelaria radcowska. Radca prawny specjalizujacy sie w zagadnieniu: prawo dla biznesu.</title>
...
$(".container_top").backstretch("",{centeredRight:true});
...
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:'Varela Round',arial,serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_lawyer.css?1413724443" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style>
...
<a href="index.php" class="logo"><img src="data/files/logo_test5.png" style="border:0" id="WebsiteLogo" alt="ESLEGAL" /></a>
...
<li ><a href="http://eslegal.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<li><a href="1_6_strona-glowna.html"><span>Strona&nbsp;Glowna</span></a></li>
<li><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li><a href="1_3_oferta.html"><span>Oferta</span></a></li>
<li><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
</ul></div>
</div>
<div class="FooterCopyright span4 footerSpan">Copyright (c)<!--?php echo date("Y")?--> ESLEGAL, Wszelkie Prawa Zastrzezone <br /><br />ESLEGAL Kancelaria Radcowska Ewa Szymanska<br />ul. Soltysowska 12F/21, 31-589 Krak&oacute;w <br />T: 12 30 77 902</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-68567660-1']);
