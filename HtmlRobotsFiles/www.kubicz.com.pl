...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Playfair+Display|Asap&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Playfair+Display|Asap&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Playfair Display","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Asap","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556143489"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; VEO BOOKS</title>

</head>
<body class="" data-bgcolor="#BCAAA4" style="background:#BCAAA4" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481704103" />
...
<a href="index.php" class="logo"><h2><img src="data/files/logo..jpg" style="border:0" id="WebsiteLogo" alt="VEO BOOKS" /><span>VEO BOOKS</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://veo-books.pl/O-firmie-VEO-BOOKS/"><span>VEO&nbsp;Books</span></a></li>
<li  ><a href="oferta"><span>Oferta</span></a></li>
<li  ><a href="1_7_rabaty.html"><span>RABATY</span></a></li>
<li  ><a href="1_9_aktualne-promocje.html" rel="dropmenu_1_9"><span>AKTUALNE&nbsp;PROMOCJE</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/dreamstime_xl_35936218.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditDark  koHeaderAutoHeight  keditLeft  kfilter1 " style="background: url(data/files/dreamstime_xl_35936218.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<li><a href="1_10_biblical-studies-and-theology.html"><span>Biblical&nbsp;Studies&nbsp;and&nbsp;Theology</span></a></li>
<li><a href="1_12_springer-yellow-sale.html"><span>Springer&nbsp;Yellow&nbsp;Sale</span></a></li>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#4E342E" class=" keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#4E342E">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2017 VEO BOOKS, All Rights Reserved.</div></div>
</div>
