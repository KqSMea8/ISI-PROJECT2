...
<link rel="bookmark" href="data/files/ls_salma-fashion_cz.jpg" />
<link rel="shortcut icon" href="data/files/ls_salma-fashion_cz.jpg" />
<link rel="apple-touch-icon" href="data/files/ls_salma-fashion_cz.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556124520"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Modna odziez damska, garsonki, zakiety, sukienki, tuniki, spodnice i spodnie damskie. Garnitur damski do szkoly, garsonka do biura, na kazda pore roku,  limitowane kolekcje Salma Fashion. Czarny zakiet, sukienka, spodnica i czarne spodnie." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Salma Fashion Producent Garsonki Zakiety Spodnice Sukienki Spodnie damskie</title>
...
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Crete Round","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(data/files/tlo_strona_logo_salma.jpg);}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1430650335" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style></style>
...
<a href="index.php" class="logo"><img src="data/files/logo_salma-fashion.jpg" style="border:0" id="WebsiteLogo" alt="Salma Fashion Producent" /></a>
...
<li ><a href="http://salma-fashion.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="nasza-firma"><span>Nasza&nbsp;Firma</span></a></li>
<li ><a href="galeria-zdjec"><span>Galeria&nbsp;Zdjec</span></a></li>
<li ><a href="nowosci"><span>Nowosci</span></a></li>
<li ><a href="kontakt"><span>Kontakt</span></a></li>
<li ><a href="oferta-hurtowa"><span>Oferta&nbsp;Hurtowa</span></a></li>
...
<li><a href="kontakt"><span>Kontakt</span></a></li>
<li><a href="oferta-hurtowa"><span>Oferta&nbsp;Hurtowa</span></a></li>
</ul> <br /> <br /> Zakiety Spodnice Sukienki Marynarki Garsonki Spodnie damskie</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?-->&nbsp;Salma Fashion,<br />Zakaz kopiowania zdjec<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-62126694-1']);
