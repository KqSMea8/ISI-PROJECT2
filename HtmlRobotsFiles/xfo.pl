...
<title>Zaloguj sie &lsaquo; Kazar &#8212; WordPress</title>
<link rel='dns-prefetch' href='//s.w.org' />
<link rel='stylesheet' href='http://xfo.pl/wp-admin/load-styles.php?c=0&amp;dir=ltr&amp;load%5B%5D=dashicons,buttons,forms,l10n,login&amp;ver=4.9.10' type='text/css' media='all' />
...
<form name="loginform" id="loginform" action="http://xfo.pl/wp-login.php" method="post">
<p>
...
<input type="hidden" name="redirect_to" value="http://xfo.pl/robots.txt" />
<input type="hidden" name="testcookie" value="1" />
</p>
</form>

<p id="nav">
<a href="http://xfo.pl/wp-login.php?action=lostpassword">Nie pamietasz hasla?</a>
</p>
...
<p id="backtoblog"><a href="http://xfo.pl/">&larr; Powrot do Kazar</a></p>
