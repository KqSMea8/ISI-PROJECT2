...
<!-- bootstrap -->
<link rel="stylesheet" href="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/bootstrap.min.css" /><!-- bootstrap -->
<!-- template style -->
<link rel="stylesheet" href="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/style.css" />
<!-- template color -->
<link rel="stylesheet" href="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/color.css" />
<!-- custom style -->
<link rel="stylesheet" href="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/custom.css" />
<link rel="icon" href="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/img/wp.png">
...
<!-- preloader -->
<div id="preloader">
<img id="preloader-img" src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/img/preloader.gif" alt="preloader">
</div>
<!-- /preloader -->
...
<div class="row">
<div class="col-md-12">
<img src="http://kogemus.pl/wp-content/uploads/2011/08/logo.png" alt="logo" class="logo">
...
<span class="letter"></span><span class="color">W przygotowaniu</span> <!-- letter and title-->
</h1>
</div>
<div class="section-content sec-desc">
<p>Nowa wersja w przygotowaniu</p>
</div>
...
<!-- script start -->
<script src='http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery-1.11.3.min.js'></script>
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/bootstrap.min.js"></script>
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/plugin.js"></script>
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/magnific.popup.js"></script>
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/backstretch.js"></script>
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery.countdown.js"></script>
<!--[if lt IE 10]>
<script src='assets/js/vendor/ie/jquery.placeholder.min.js'></script>
<![endif]-->
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/variable.js"></script>
<script>
...
function fn_single() {
$bg.backstretch('http://kogemus.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg'); // set single background image
}
...
slideShowImageSet.push('http://kogemus.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
slideShowImageSet.push('http://kogemus.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
...
<script src="http://kogemus.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/custom.js"></script>
