<head>
<title>Publiczne Gimnazjum w Sosnowce</title>
...
<meta name="keywords" content="gimnazjum, sosnowka, sosnowka, bip, szkola, szkola" />
...
'<p style="display: inline-block; padding: 20px 20px 0px 20px;">Strona ta wykorzystuje pliki cookies w celu realizacji swoich uslug i funkcji zgodnie z <a href="http://gim.sosnowka.bipszkola.pl/cookie" style="color: #ffffff;"><u>Polityka Plikow Cookies</u></a>. Mozesz samodzielnie dostosowac warunki przechowywania lub dostepu do plikow cookies w Twojej przegladarce.</p>'+
