...
<link rel="bookmark" href="data/files/logo_small3.png" />
<link rel="shortcut icon" href="data/files/logo_small3.png" />
<link rel="apple-touch-icon" href="data/files/logo_small3.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556127866"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Wegiel
Sklad Wegla Kopalnia Sztygar
Sklad Wegla
Bydgoszcz
Fordonska
Mial
...
<title>Blad 404: Strona nie istnieje! &raquo; Sklad Opalu Kopalnia Sztygar Bydgoszcz</title>
...
<a href="index.php" class="logo"><img src="data/files/logo_hd.png" style="border:0" id="WebsiteLogo" alt="KOPALNIA SZTYGAR" /></a>
...
<li ><a href="bydgoszcz"><span>BYDGOSZCZ</span></a></li>
<li ><a href="wloclawek"><span>WLOCLAWEK</span></a></li>
<li ><a href="lodz"><span>LODZ</span></a></li>
...
<li><a href="promocje"><span>Promocje</span></a></li>
<li><a href="kontakt"><span>Kontakt</span></a></li>
</ul> <br />Sklad Opalu Kopalnia Sztygar<br />Bydgoszcz&nbsp;ul. Fordonska 246<br />pn. - pt. <strong>8.00 - 16.00</strong>, sob. <strong>8.00 - 13.00</strong>&nbsp;</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Kopalnia Sztygar,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/kopalniasztygar"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://plus.google.com/+KopalniasztygarPl"><i class="fa fa-google-plus-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-58725757-1']);
...
<iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fkopalniasztygar&amp;width=325&amp;height=325&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color=%23ffffff&amp;header=false&amp;appId=346926555430054" scrolling="no" frameborder="0" style="border:none;overflow:hidden;width:325px;height:325px;" allowTransparency="true"></iframe>

</div>
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files/bcoal.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
