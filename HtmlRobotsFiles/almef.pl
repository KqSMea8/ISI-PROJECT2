...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556027015"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Profesjonalna firma zajmujaca sie nadzorami inwestorskimi, opiniami, ekspertyzami, pomiarami instalacji sanitarnych - wentylacja, klimatyzacja, ogrzewanie, cieplo technologiczne, alternatywne zrodla energii.
Optymalizacja kosztow inwestycji." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Almef - nadzory, projekty, opinie, pomiary</title>
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_bridge.css?1424624251" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>.container_splash2{background:none;}#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files1/logo_almef.jpg" style="border:0" id="WebsiteLogo" alt="Almef" /></a>
...
<li ><a href="http://almef.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="index.php?p=1_2_o-nas"><span>O&nbsp;Nas</span></a></li>
<li ><a href="index.php?p=1_3_zakres-dzialalnosci"><span>Zakres&nbsp;dzialalnosci</span></a></li>
<li ><a href="index.php?p=1_5_pomiary"><span>Pomiary</span></a></li>
...
<li><a href="index.php?p=1_5_pomiary"><span>Pomiary</span></a></li>
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
</ul> <br /> <br /> Przedsiebiorstwo Uslugowo - Handlowe Almef<br />ul. Anieli Krzywon 16<br />41-922 Radzionkow<br />tel. 728 104 140<br />d.ptak@almef.pl</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Almef,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-72974017-1']);
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files1/wentylacja_nadzor.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
