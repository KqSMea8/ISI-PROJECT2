...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=PT+Sans+Narrow|Didact+Gothic&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=PT+Sans+Narrow|Didact+Gothic&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<title>Blad 404: Strona nie istnieje! &raquo; KPDW</title>
<script src="/inc/domeny.js" type="text/javascript"></script>
</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1528498218" />
...
<a href="index.php" class="logo"><img src="data/files/smalllogo.png" style="border:0" id="WebsiteLogo" alt="KPDW" /></a>
</div>
...
<div id="subpageHeaderContent" data-bgcolor="#29B6F6" data-background="data/files/img-869061.jpg" class=" keditDark " style="background:#29B6F6 url(data/files/img-869061.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#E3F2FD" style="background:#E3F2FD">

<div class="kedit keditRow koZeroPadding" id="kpg_140" data-bgcolor="#BBDEFB" style="background:#BBDEFB">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_281"><div class="keditable keditable-auto"><div><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Prawa autorskie (c) 2018, Wszelkie prawa zastrzezone.</font></font></font></font></font></font></div></div></div>
</div>
