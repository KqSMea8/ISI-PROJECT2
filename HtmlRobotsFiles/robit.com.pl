...
<link rel="apple-touch-icon" href="data/files/beznazwy-1.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Droid+Sans|Varela+Round&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Droid+Sans|Varela+Round&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556124045"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Robit</title>

</head>
<body class="" data-bgcolor="#FAFAFA" style="background:#FAFAFA" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1501294387" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><img src="data/files/robit3.png" style="border:0" id="WebsiteLogo" alt="Robit" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://robit.com.pl/"><span>Start</span></a></li>
<li  ><a href="index.php?p=1_2_oferta"><span>Oferta</span></a></li>
<li  ><a href="index.php?p=1_3_o-nas"><span>O&nbsp;nas</span></a></li>
<li  ><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/robit.polska"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#000000" class=" keditDark  koHeaderAutoHeight " style="background:#000000">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy;2017 Robit.com.pl, Wszelkie Prawa Zastrzezone</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/robit.polska"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 1357</span></div>
</div>
</div>
</div>
</div>
...
_smartsupp.key = "332dd6532d30984cb202eb8a037b2b73757a7d53";
