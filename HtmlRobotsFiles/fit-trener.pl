...
<!-- bootstrap -->
<link rel="stylesheet" href="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/bootstrap.min.css" /><!-- bootstrap -->
<!-- template style -->
<link rel="stylesheet" href="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/style.css" />
<!-- template color -->
<link rel="stylesheet" href="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/color.css" />
<!-- custom style -->
<link rel="stylesheet" href="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/custom.css" />
<link rel="icon" href="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/img/wp.png">
...
<!-- preloader -->
<div id="preloader">
<img id="preloader-img" src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/img/preloader.gif" alt="preloader">
</div>
<!-- /preloader -->
...
<li><a href="#" data-link-to="#contact">Kontakt</a></li>
</ul>
</nav>
<!-- /menu -->
...
<span class="letter"></span><span class="color">Strona w budowie</span> <!-- letter and title-->
</h1>
</div>
...
<span><i class="fa fa-phone"> </i> : tel. 606 343 439</span>
</div>
</address>
<!-- /contact info -->
...
<li>
<a href="https://www.facebook.com/LukaszZorawskiTrenerOsobistyLodz/?ref=br_rs" title="facebook" target="_blank"> <!-- social link, title -->
...
<!-- script start -->
<script src='http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery-1.11.3.min.js'></script>
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/bootstrap.min.js"></script>
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/plugin.js"></script>
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/magnific.popup.js"></script>
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/backstretch.js"></script>
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery.countdown.js"></script>
<!--[if lt IE 10]>
<script src='assets/js/vendor/ie/jquery.placeholder.min.js'></script>
<![endif]-->
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/variable.js"></script>
<script>
...
function fn_single() {
$bg.backstretch('http://fit-trener.pl/wp-content/uploads/2018/05/lukasz.jpg'); // set single background image
}
...
slideShowImageSet.push('http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
slideShowImageSet.push('http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
...
<script src="http://fit-trener.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/custom.js"></script>
