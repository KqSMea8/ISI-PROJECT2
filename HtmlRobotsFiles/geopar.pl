...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/samaziemmia.png" />
<link rel="shortcut icon" href="data/files/samaziemmia.png" />
<link rel="apple-touch-icon" href="data/files/samaziemmia.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Cantarell|Varela+Round&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Cantarell|Varela+Round&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Cantarell","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556068558"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Realizujemy wszelkiego rodzaju prace geodezyjne
Swiadczymy uslugi dla osob prywatnych, firm i instytucji." />
<meta name="keywords" content="geodeta Rybnik geodeta Gliwice geodeta Jastrzebie geodeta Zory geodeta Pszczyna geodeta Raciborz geodeta Wodzislaw geodeta Slask  podzialy inwentaryzacje mapy do celow projektowych" />
<title>Blad 404: Strona nie istnieje! &raquo; GEO-PAR Uslugi Geodezyjne Macej Partyka</title>

</head>
<body class="" data-background="data/files/theme/18-6.jpg" style="background: url(data/files/theme/18-6.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1477308182" /><style>  .koTheme3 #headerMenu{position:absolute;top:-120px;} .koTheme3 #header{margin-top:150px}.koTheme3 #website{box-shadow:0 0 50px rgba(0,0,0,0.5)} .koTheme3 .koMenu1 .logoHolder h2 {color:#fff}
...
<a href="index.php" class="logo"><img src="data/files/logo34.png" style="border:0" id="WebsiteLogo" alt="GEO-PAR Uslugi Geodezyjne" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://geopar.pl/"><span>O&nbsp;nas</span></a></li>
<li  ><a href="oferta.html"><span>Oferta</span></a></li>
<li  ><a href="galeria.html"><span>Galeria</span></a></li>
<li  ><a href="kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/geopargeodezja"><i class="fa fa-facebook-square"></i></a><a class="koSocialYouTubeHover" target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#263238" data-background="data/files/dsc_0037.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditLeft " style="background:#263238 url(data/files/dsc_0037.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2016 GEO-PAR Uslugi Geodezyjne, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/geopargeodezja"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
