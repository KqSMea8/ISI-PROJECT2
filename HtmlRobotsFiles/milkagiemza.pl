...
<link rel="bookmark" href="data/files/wlala.jpg" />
<link rel="shortcut icon" href="data/files/wlala.jpg" />
<link rel="apple-touch-icon" href="data/files/wlala.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556117024"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Makijaz, stylizacja, doradztwo, stylizacja rzes. I w tym wszystkim kawalek mojego zycia.
Sprawie, ze poczujesz sie jeszcze piekniejsza.
Zapraszam." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; MakeUp, Style, Lash and Life</title>
...
<link href="http://fonts.googleapis.com/css?family=Alegreya+Sans|Alegreya+Sans&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Alegreya Sans","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Alegreya Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_sky.css?1467559947" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>/*repeat-splash-bg*/#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}.container_content{background:none;}.container_top{background:url(data/files/lala-tlo-bloga.jpg)}</style>
...
<a href="index.php" class="logo"><img src="data/files/logomilka.jpg" style="border:0" id="WebsiteLogo" alt="milka giemza" /></a>
...
<li ><a href="ja"><span>JA</span></a></li>
<li ><a href="kontakt"><span>KONTAKT</span></a></li>
<li ><a href="blog"><span>BLOG</span></a></li>
<li ><a href="oferta"><span>OFERTA&nbsp;</span></a></li>
<li ><a href="galeria" rel="dropmenu_1_7"><span>GALERIA</span></a></li>
<li ><a href="polecam"><span>POLECAM</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?-->&nbsp;milka giemza,<br /> Wszelkie Prawa Zastrzezone<br /> <br /> <ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/milka.giemza"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://instagram.com/milka_giemza"><i class="fa fa-instagram fa-2x fa-fw"></i></a></ul><style></style> &nbsp;</div>
</div>        </div>
</div>
</div>
</div>
