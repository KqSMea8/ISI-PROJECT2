...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/beznazwy_1467831509.png" />
<link rel="shortcut icon" href="data/files/beznazwy_1467831509.png" />
<link rel="apple-touch-icon" href="data/files/beznazwy_1467831509.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Asap|Asap&subset=latin-ext" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556125461"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Pasze Liszki
Pasze Krzeszowice" />
<meta name="keywords" content="Pasze Liszki
Pasze Krzeszowice" />
<title>Blad 404: Strona nie istnieje! &raquo; Pasze Liszki Pasze Krzeszowice</title>

</head>
<body class="" data-background="data/files/zielone-tlo-157876_1471329884.jpg" style="background: url(data/files/zielone-tlo-157876_1471329884.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1470306721" /><style> #headerMenu.koMenu4{background:#eee;border-top:0;border-bottom-width:10px;border-bottom-style:solid;margin-top:-50px;}    #headerMenu.koMenu4 li.active{background:#fff;}      .menuHolder li,#headerMenu .menuHolder, .logoLeft #headerMenu .menuHolder {     padding-top: 0px; padding-bottom: 0px;   }      #headerBanner,#subpageHeaderBanner{margin-top:150px}   .koTheme6 #subpageHeaderBanner,  .koTheme6 #headerBanner.koHeaderHide {     margin-bottom: 0; }   .logoCentered .menuHolder,.logoCentered .logoHolder,.logoCentered .logoReplacer {}      .logoHolder{position:absolute;top:-100px;left:0;right:0;}    .logoCentered .logoHolder{top:-110px}    .logoRight .logoHolder{text-align:right}   .logoCentered .logoHolder,.logoCentered .logoReplacer {margin:0 auto;width:100%;}   .koTheme6 #headerBanner.koHeaderAutoHeight .kedit,  .koTheme6 #headerBanner.koHeaderAutoHeight .k_Edit   {     margin-top: 0; }     </style>
...
<a href="index.php" class="logo"><img src="data/files/baner1x2mc1.jpg" style="border:0" id="WebsiteLogo" alt="Agro Centrum" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://sklep-agrocentrum.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_18_nasza-oferta.html"><span>Nasza&nbsp;Oferta&nbsp;</span></a></li>
<li  ><a href="1_4_kontakt-liszki.html"><span>Kontakt&nbsp;Liszki</span></a></li>
<li  ><a href="1_5_kontakt-krzeszowice.html"><span>Kontakt&nbsp;Krzeszowice</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#9CCC65" data-background="data/files/img-8948." class=" koHeaderAutoHeight " style="background:#9CCC65 url(data/files/img-8948.) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>(c)2015, All Rights Reserved</div>
<div>&nbsp;</div>
<div>Pasze Liszki</div>
<div>Pasze Krzeszowice</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/paszeliszki"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 1780</span></div>
</div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-93055511-1']);
