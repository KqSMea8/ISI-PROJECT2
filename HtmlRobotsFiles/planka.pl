...
<link rel="bookmark" href="data/files/p.png" />
<link rel="shortcut icon" href="data/files/p.png" />
<link rel="apple-touch-icon" href="data/files/p.png" /><script>var tinyMcePath="/";</script><script src="/inc/js/tinymce/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Pragati+Narrow|Didact+Gothic&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Pragati+Narrow|Didact+Gothic&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Pragati Narrow","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Didact Gothic","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
<meta name="keywords" content="Frezowanie CNC, toczenie CNC, obrobka skrawaniem Zywiec," />
<title>Blad 404: Strona nie istnieje! &raquo; Obrobka skrawaniem CNC, Frezowanie CNC, toczenie CNC, Zywiec</title>
<script src="/inc/domeny.js" type="text/javascript"></script>
</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1552145465" /><style>.logo{text-transform:uppercase}</style>
...
<a href="index.php" class="logo"><img src="data/files/logoplanka_v1dostosowanedoplikwsw.jpg" style="border:0" id="WebsiteLogo" alt="PLANKA" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://planka.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="1_3_aktualnosci.html"><span>Aktualnosci</span></a></li>
...
<div id="subpageHeaderContent" data-background="data/files/img-444473.jpg" data-parallax="1"  class=" parallax-window " style="background: url(data/files/img-444473.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit keditRow" id="kpg_140">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_351" ><div class="keditable keditable-auto"><div>PLANKA Sp. z o.o. 2018, All Rights Reserved.</div></div></div>
</div>
