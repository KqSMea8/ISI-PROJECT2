...
<link href="/templates/webio/css/all.css?v=e521c4" rel="stylesheet">
...
var csrfToken = '526877583105e139c3674498a94455aa5013deb2',
...
<script src="/templates/webio/js/scripts.js?v=e521c4"></script>
...
<a class="nav-link" href="/Aktualnosci.html"><i class="far fa-newspaper"></i>Aktualnosci</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link">Dostep do uslug:</a>
</li>
<li class="nav-item">
...
<a class="nav-link dropdown-toggle" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-wrench"></i>panele zarzadzania</a>
...
<li class="dropdown">
<div class="mrgtopten">
<a class="nav-link dropdown-toggle" href="#" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">swiadczone uslugi</a>
...
<a data-toggle="dropdown" aria-haspopup="true" id="customarea" aria-expanded="false" href="/StrefaKlienta.html">Strefa klienta</a> <!-- LOGIN BUTTON -->
<div class="dropdown-menu login-drop-down-header" aria-labelledby="customarea">

<form method="post" action="https://www.webio.pl/dologin.php" class="login-form" role="form">
<input type="hidden" name="token" value="526877583105e139c3674498a94455aa5013deb2" />
<div class="form-group">
<input type="email" name="username" class="form-control" id="inputEmail" placeholder="Wprowadz e-mail" autofocus>
</div>

<div class="form-group">
<input type="password" name="password" class="form-control" id="inputPassword" placeholder="Haslo" autocomplete="off" >
</div>
<p class="help-block"><a href="ResetHasla.html">Zapomniane haslo?</a></p>



<div align="center">
<input id="login" type="submit" class="btn btn-primary" value="Zaloguj sie" />
</div>
</form>
...
<input id="domain-text" type="text" name="domain" placeholder="Wpisz nazwe domeny, ktorej szukasz w tym polu .." />
...
<h5 class="tittle-head">.. a takze zapoznaj sie pozostalymi uslugami swiadczonymi przez Webio <span>podzielilismy je na kategorie w celu ulatwienia ich przegladania</span></h5> <!-- TITTLE -->
...
<h5>wybierz plan hostingowy (<a href="/hosting-asp-net/porownanie-planow-hostingowych.html">porownanie planow</a>)<span>odpowiedni dla Twoich potrzeb</span></h5>
...
<a href="/hosting-asp-net/konto-testowe-o-parametrach-planu-podstawowego.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=16" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-asp-net/plan-startowy.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=5" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fas fa-database" aria-hidden="true"></i><b>mssql, mysql</b></p>
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-asp-net/plan-podstawowy.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=6" role="button" class="btn btn-success">zamow</a>
</div>
</div>
</div>
...
<p><i class="fas fa-database" aria-hidden="true"></i><b>mssql, mysql</b></p>
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-asp-net/plan-rozszerzony.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=7" role="button" class="btn btn-success">zamow</a>
</div>
</div>

<div class="col-sm-4">
<div class="server-cnfg">
<p>dla wymagajacych</p>
<p><i class="fa fa-code" aria-hidden="true"></i><b>.net framework</b></p>
<p><i class="fa fa-dot-circle" aria-hidden="true"></i><b>.net core</b></p>
<p><i class="fab fa-php" aria-hidden="true"></i><b>php</b></p>
<p><i class="fab fa-expeditedssl" aria-hidden="true"></i><b>let's encrypt</b></p>
<p><i class="fas fa-database" aria-hidden="true"></i><b>mssql, mysql</b></p>
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-asp-net/plan-dla-wymagajacych.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=8" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fas fa-database" aria-hidden="true"></i><b>mssql, mysql</b></p>
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-asp-net/plan-premium.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=20" role="button" class="btn btn-success">zamow</a>
</div>
</div>
</div>
<div class="col-sm-12"><h5><span>Kazdy z planow mozna poszerzyc przy pomocy <a href="/hosting-asp-net/dodatki-hostingowe.html">dodatkow hostingowych</a></span></h5></div>
</div>
</div>
...
<div class="col-sm-4">
<div class="server-cnfg">
<p>wordpress / joomla (testowy)</p>
<p><i class="fa fa-code" aria-hidden="true"></i><b>php</b></p>
...
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="#" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=46" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="#" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=41" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="#" role="button" class="btn btn-info">szczegoly</a>
<a href="#" role="button" class="btn btn-success">zamow</a>
</div>
</div>
</div>
...
<h5>wybierz plan hostingowy (<a href="/hosting-poczty-elektronicznej/porownanie-planow-hostingowych.html">porownanie planow</a>)<span>odpowiedni dla Twoich potrzeb</span></h5>
<div class="serv-choices-wiz">
<div id="radios">
...
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-poczty-elektronicznej/plan-mini.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=9" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fas fa-sticky-note" aria-hidden="true"></i><b>notatki</b></p>
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-poczty-elektronicznej/plan-normal.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=10" role="button" class="btn btn-success">zamow</a>
</div>
</div>
...
<p><i class="fas fa-sticky-note" aria-hidden="true"></i><b>notatki</b></p>
<p><i class="fa fa-hdd-o" aria-hidden="true"></i> lokalizacja: <b>Polska</b></p>
<a href="/hosting-poczty-elektronicznej/plan-maxi.html" role="button" class="btn btn-info">szczegoly</a>
<a href="/Zamowienie.html?a=add&pid=11" role="button" class="btn btn-success">zamow</a>
</div>
</div>
</div>
<div class="col-sm-12"><h5><span>Kazdy z planow mozna poszerzyc przy pomocy <a href="/hosting-poczty-elektronicznej/dodatki-hostingowe.html">dodatkow hostingowych</a></span></h5></div>
</div>
</div>
...
<li data-toggle="tooltip" data-placement="top" title="poprzednia zakladka" class="previous"><a><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
<li data-toggle="tooltip" data-placement="top" title="nastepna zakladka" class="next"><a><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
</ul> <!-- END PAGER -->
</div> <!-- END WIZARD -->
...
<div class="container"> <!-- CONAINER -->
<h5 class="title-head">ogolna charakterystyka naszych uslug</h5> <!-- TITTLE -->
<div class="row justify-content-center"> <!-- ROW -->
<div class="col-sm-4 techno-icons wow fadeInUp">
<i class="fa fa-hdd"></i>
<h6>SSD</h6>
<p>Wszystkie nasze systemy pod strony internetowe i bazy danych uruchomione sa na macierzy z wysoko wydajnymi dyskami SSD</p>
</div>

<div class="col-sm-4 techno-icons">
<i class="fab fa-expeditedssl"></i>
<h6>SSL</h6>
<p>W kazdym planie dotyczacym stron internetowych klienci moga zainstalowac darmowy samo odnawiajacy sie certyfikat Let's Encrypt lub inny dostarczony przez siebie (nie musi byc kupiony w Webio)</p>
</div>

<div class="col-sm-4 techno-icons phonnochowop">
<i class="fas fa-server"></i>
<h6>kopia zapasowa</h6>
<p>Wykonujemy kopie zapasowe systemow bazodanowych, stron www i poczty elektronicznej</p>
</div>
...
<h6>pomoc dla klientow</h6>
<p>Staramy sie pomoc naszym i nie tylko naszym klientom na tyle ile jest to mozliwe czesto wychodzac poza wymagany od nas zakres pomocy</p>
</div>

<div class="col-sm-4 techno-icons wow fadeInUp">
<i class="far fa-thumbs-up"></i>
<h6>wysoka jakosc uzywanego oprogramowania</h6>
<p>Oprogramowanie uzywane przez Webio dobieramy tak aby jak najbardziej uproscic korzystanie z naszych uslug</p>
</div>

<div class="col-sm-4 techno-icons phonnochowop">
<i class="fas fa-question-circle"></i>
<h6>sluchamy klientow</h6>
<p>Probujemy wprowadzac zmiany sugerowane przez klientow do naszego oprogramowania na tyle ile to mozliwe badz zglaszac je do firm odpowiedzialnych za dane oprogramowanie</p>
</div>
...
<li class="nav-item">
<a class="nav-link" href="callto:957117188"><i class="fa fa-phone" aria-hidden="true"></i> 95 711-71-88</a>
</li>
</ul>
</div>
...
<h5 class="tittle-footer">Sposoby platnosci</h5>

<a href="https://tpay.com/jak-to-dziala" target="_blank" title="Obslugujemy platnosci internetowe przez system platnosci online tpay.com"><img src="https://tpay.com/img/banners/tpaycom_zaplac-z-200x135.png" style="border:0" alt="Zaplac z tpay.com" title="Zaplac z tpay.com" width="200" height="135" /></a>
</div>
...
<script src="/templates/webio/js/smoothscroll.js"></script>
