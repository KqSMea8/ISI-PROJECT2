...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=PT+Sans|Playfair+Display&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=PT+Sans|Playfair+Display&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"PT Sans","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Playfair Display","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556151006"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; PC-FAN</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1518267634" />
...
<a href="index.php" class="logo"><img src="data/files/pcfan_logo_male.gif" style="border:0" id="WebsiteLogo" alt="PC-FAN" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="o-nas"><span>O&nbsp;Nas</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#283593" data-align="keditLeft"  class=" keditDark  koHeaderAutoHeight  koHeaderHide  keditLeft " style="background:#283593">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2019 PC-FAN, All Rights Reserved.</div></div>
</div>
...
</div><script type="text/javascript" src="http://pc-fan.pl/index.php?supermode=ihelp&id=1&mid=1"></script>
