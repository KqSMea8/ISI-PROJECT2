...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556065959"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; ROMEX</title>

</head>
<body class="koThemeDark"  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1487861550" /><style> .koTheme1  .logoHolder #logoReplacer h2 {     line-height: 80px;     display: inline-block;     outline: 3px solid #FFF; outline-offset:-10px;     padding-right: 30px;     padding-left: 30px; }
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>ROMEX</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://fuhromex.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/przyciete1.png" data-parallax="1"  class=" parallax-window  keditDark " style="background: url(data/files/przyciete1.png) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2017 Romex, All Rights Reserved.</div>
</div>
