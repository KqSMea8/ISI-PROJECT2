...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556149689"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Obrzeza meblowe i przewijarki do obrzezy</title>


<meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;" />

<link href="inc/js/bootstrap/bootstrap.css?1400185923" rel="stylesheet">
<link href="data/templates/rocksand/images/bootstrap-responsive-2.css?1400185923" rel="stylesheet">
...
<link href="http://fonts.googleapis.com/css?family=Averia+Libre&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:'Averia Libre',arial,serif}.container_content{}</style>

</head>
<body><link type="text/css" rel="stylesheet" href="style_extra.css?1.0.9" />
...
<a href="index.php" class="logo"><img src="data/files/logo-elkana-czarne.png" style="border:0" id="WebsiteLogo" alt="Obrzeza meblowe i przewijarki do obrzezy" /></a>
...
<li ><a href="http://www.obrzezameblowe.pl/"><span>Strona&nbsp;glowna</span></a></li>
<li ><a href="index.php?p=1_7_przewijarki"><span>Przewijarki</span></a></li>
<li ><a href="index.php?p=1_2_o-nas"><span>O&nbsp;Nas</span></a></li>
<li ><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li ><a href="index.php?p=1_5_wspieramy"><span>Wspieramy</span></a></li>
...
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li><a href="index.php?p=1_5_wspieramy"><span>Wspieramy</span></a></li>
</ul> <br /> <br /> Obrzeza meblowe, przewijarka do obrzezy meblowych, profile meblowe.</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Uzytkownicy Online: 1</div>
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> P.W. Elkana,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
