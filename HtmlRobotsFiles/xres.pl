...
<h3>Juz teraz mozesz <a href="http://futurehost.pl/pomoc/poradniki/wgrywanie-usuwanie-i-aktualizowanie-plikow-na-serwerze?c=9&a=31">wgrac</a> swoje pliki do katalogu: <br /><em>domains&nbsp;/&nbsp;xres.pl&nbsp;/&nbsp;public_html&nbsp;/</em></h3>
<br />
