...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Bevan|Cardo&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Bevan|Cardo&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Bevan","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Cardo","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556179244"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; F.D.U. &quot;POZ-PROJKET&quot;</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1525817569" /><style>.topmenu a {border-radius:0 15px 0 15px}</style>
...
<a href="index.php" class="logo"><img src="data/files/we.jpg" style="border:0" id="WebsiteLogo" alt="F.D.U. &quot;POZ-PROJKET&quot;" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://poz-projekt.pl/"><span>Glowna</span></a></li>
...
<div id="subpageHeaderContent" data-bgcolor="#dbe5f1" data-background="data/files/theme/5-1.jpg" data-parallax="1"  class=" parallax-window  koZeroPadding  kfilter1 " style="background:#dbe5f1 url(data/files/theme/5-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit keditRow" id="kpg_20">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_501" ><div class="keditable keditable-auto">Copyright (c)2018 F.D.U. "POZ-PROJKET", All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_342" ><div class="footerHolder" id="keditFooterModule"></div></div>
</div>
</div>
</div>
