...
<div class="hp-main">
<div class="welcomeSlideshowContainer" id="cycle_7319">
<div class="welcomeSlideshow" id="cycle_container_7319">
...
<script>
var bc = $('#cycle_buttons_7319');
var $container_7319 = $('#cycle_container_7319').cycle({
fx: 'scrollLeft',
speed: 500,
timeout: 0
});
$('#welcomeSlideshowArrow').click(function() {
$('#cycle_container_7319').cycle('next');
});
</script>
</div>
</div>
