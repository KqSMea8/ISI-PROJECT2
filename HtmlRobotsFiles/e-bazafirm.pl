...
<meta  property="og:title" content="e-bazafirm.pl - sklep z domenami internetowymi."  /><meta  property="og:description" content="1 domena na sprzedaz - polecam!"  /><meta  property="og:image" content="https://epremium.pl/view-shop1555306371/img/logo.png"  /> </head>
...
<div class="top-bar">
<div class="f-left">
<a href="http://e-bazafirm.pl/" class="logo"><img src="https://epremium.pl/view-shop1555306371/style/shop/logo.png" alt="sklep premium.pl" /></a>
</div>
<div class="f-right">
...
<img src="https://premium.pl/token.png?_t=1556055853" id="token" alt="" class="mid" />
...
<a href="http://e-bazafirm.pl/kategorie">
...
<div class="listcmp-container" id="listlist_2234223235cbf872d6c2b8">
...
<div id="filters-top"
class="list-list_2234223235cbf872d6c2b8 filters-top-list filters-top-simple"
style="display: none">
...
<form class="disable-prevent"  action="http://e-bazafirm.pl/"
method="get"
...
<form action="http://e-bazafirm.pl/" method="get">
<div>
...
<a href="http://e-bazafirm.pl/?order=name&amp;desc=0&amp;page=0#oferty"
class="link-order"
>Domena</a>
...
<a href="http://e-bazafirm.pl/?order=value_bn&amp;desc=0&amp;page=0#oferty"
class="link-order"
>Kup Teraz</a>
...
id="list_2234223235cbf872d6c2b8_row_0_0">
...
<!--
var list_2234223235cbf872d6c2b8_o = $('#listlist_2234223235cbf872d6c2b8');

$(document).ready(function () {
list_2234223235cbf872d6c2b8_o.find('.bottomtab a').click(function (e) {
var was_hidden = list_2234223235cbf872d6c2b8_o.find('.' + $(this).children('span').attr('class').replace('tabname', 'tab')).is(':hidden');

list_2234223235cbf872d6c2b8_o.find('.tab').hide();

if (was_hidden) {
list_2234223235cbf872d6c2b8_o.find('.' + $(this).children('span').attr('class').replace('tabname', 'tab')).show();
}

if (list_2234223235cbf872d6c2b8_o.find('.tab-filters:not(:hidden), .tab-report:not(:hidden), .tab-legend:not(:hidden)').length > 0) {
$('.bottomtab-container').addClass('sep-b');
} else {
list_2234223235cbf872d6c2b8_o.find('.bottomtab-container').removeClass('sep-b');
}
