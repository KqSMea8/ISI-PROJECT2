...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Tinos|Tinos&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Tinos|Tinos&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Tinos","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Tinos","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556052602"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; DMA s.c.</title>

</head>
<body class="koThemeDark" data-bgcolor="#212121" data-background="data/files/keyboard-254582_1920.jpg" style="background:#212121 url(data/files/keyboard-254582_1920.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481467853" /><style>  .koTheme3 #headerMenu{position:absolute;top:-120px;} .koTheme3 #header{margin-top:150px}.koTheme3 #website{box-shadow:0 0 50px rgba(0,0,0,0.5)} .koTheme3 .koMenu3 .logoHolder h2 {color:rgba(0,0,0,0.8)}   .koTheme3 .koThemeDark #headerMenu.koMenu3 .topmenu a:hover,.koTheme3 .koThemeDark #headerMenu.koMenu3 .topmenu .active a {     color: rgba(255,255,255,0.7); border-color:#fff }          </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>DMA s.c.</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://dma.com.pl/"><span>O&nbsp;firmie</span></a></li>
<li  ><a href="1_5_sprzet-i-oprogramowanie.html"><span>Sprzet&nbsp;i&nbsp;oprogramowanie</span></a></li>
<li  ><a href="1_6_uslugi-i-serwis.html"><span>Uslugi&nbsp;i&nbsp;serwis</span></a></li>
...
<div id="subpageHeaderBanner" data-align="keditLeft"  class=" keditDark  koHeaderHide  keditLeft " style="background:">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#212121" data-background="data/files/hard-drive-1265259_1920.jpg" data-parallax="1"  class=" parallax-window  koHeaderAutoHeight  koHeaderHide  kfilter1 " style="background:#212121 url(data/files/hard-drive-1265259_1920.jpg) no-repeat 50% 0px;background-size:cover">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><h1>Copyright &copy;2016 DMA s.c., All Rights Reserved.</h1></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><span id="footerHitCounter">Liczba odwiedzin: 3398</span></div>
</div>
</div>
</div>
</div>
