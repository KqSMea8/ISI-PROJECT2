...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/amlogo.png" />
<link rel="shortcut icon" href="data/files/amlogo.png" />
<link rel="apple-touch-icon" href="data/files/amlogo.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556131844"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; AD-LINE  |  AM-STUDIO - agencja reklamowa</title>
...
<style type="text/css">h1,h2,h3,#content h3,.topmenu{font-family:'Capriola',arial,serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_greyaccent2.css?1553519408" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style></style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>AD-LINE  |  AM-STUDIO</h2><h4>agencja reklamowa</h4></div><!--Logo--></a>
...
<li ><a href="http://ad-line.pl/"><span>HOME</span></a></li>
<li ><a href="index.php?p=1_6_o-nas"><span>O&nbsp;NAS</span></a></li>
<li ><a href="index.php?p=1_4_kontakt"><span>KONTAKT</span></a></li>
<li ><a href="index.php?p=1_8_polityka-prywatnosci"><span>Polityka&nbsp;Prywatnosci</span></a></li>
...
<li><a href="index.php?p=1_4_kontakt"><span>KONTAKT</span></a></li>
<li><a href="index.php?p=1_8_polityka-prywatnosci"><span>Polityka&nbsp;Prywatnosci</span></a></li>
</ul><br />| AM-STUDIO | AM-24 | AD-LINE | Artur Darlak<br />T: +48 602 654 806 | E: biuro@am-studio.com.pl; artur@ad-line.pl <br /><br /></div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> AD-LINE | Artur Darlak,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/darlaczek"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
