...
<meta name="Keywords" content="skydiver.pl" />
<meta name="Description" content="skydiver.pl" />
<meta name="Robots" content="ALL" />
<meta name="viewport" content="width=device-width, initial-scale=0.9, maximum-scale=0.9, user-scalable=0" />
<title>skydiver.pl</title>
<!-- Rozrywka -->
...
background: #ffffff url('/templates/7.jpg') no-repeat;
...
<p class="center" style="font-weight: bold">Cena sprzedazy: 5 000,00 PLN netto</p>
<p class="center"><input type="hidden" name="dodanieDomen" value="doKoszyka" />
<input type="hidden" name="domains[]" value="skydiver.pl" />
