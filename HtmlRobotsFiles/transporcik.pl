...
<!-- bootstrap -->
<link rel="stylesheet" href="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/bootstrap.min.css" /><!-- bootstrap -->
<!-- template style -->
<link rel="stylesheet" href="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/style.css" />
<!-- template color -->
<link rel="stylesheet" href="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/color.css" />
<!-- custom style -->
<link rel="stylesheet" href="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/custom.css" />
<link rel="icon" href="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/img/wp.png">
...
<!-- preloader -->
<div id="preloader">
<img id="preloader-img" src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/img/preloader.gif" alt="preloader">
</div>
<!-- /preloader -->
...
<li><a href="#" data-link-to="#about">Kontakt</a></li>
</ul>
</nav>
<!-- /menu -->
...
<span class="letter"></span><span class="color">Juz niedlugo otwieramy :)</span> <!-- letter and title-->
</h1>
</div>
<div class="section-content sec-desc">
<p>Jesli chcesz dolaczyc do zespolu i tworzyc jeden z najwiekszych portali o ciezarowkach w Polsce to zapraszam do kontaktu.</p>
</div>
...
<a href="#" class="btn btn-theme btn-lg shadow" data-link-to="#about">Kontakt</a> <!-- link button -->
...
<span class="letter">K</span><span class="color">Kontakt</span> <!-- letter and title-->
</h2>
</div>
<div class="section-content sec-desc">
<p>Zapraszam do kontaktu na fb: https://www.facebook.com/TransporcikPL-2154407554847215/?modal=admin_todo_tour</p>
</div>
</div>
</div>
</div>
...
<!-- script start -->
<script src='http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery-1.11.3.min.js'></script>
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/bootstrap.min.js"></script>
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/plugin.js"></script>
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/magnific.popup.js"></script>
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/backstretch.js"></script>
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery.countdown.js"></script>
<!--[if lt IE 10]>
<script src='assets/js/vendor/ie/jquery.placeholder.min.js'></script>
<![endif]-->
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/variable.js"></script>
<script>
...
function fn_single() {
$bg.backstretch('http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg'); // set single background image
}
...
slideShowImageSet.push('http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
slideShowImageSet.push('http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
...
if($.find('#countdown')[0]) {
$('#countdown').countdown('2018/12/31 23:55').on('update.countdown', function(event) {
var $this = $(this).html(event.strftime(''
+ ''
+ '<li class="time-wrap col-xs-6 col-sm-3"><span class="time">%-D</span><p class="unit">Dni</p></li>'
+ '<li class="time-wrap col-xs-6 col-sm-3"><span class="time">%H</span><p class="unit">Godzin</p></li>'
+ '<li class="time-wrap col-xs-6 col-sm-3"><span class="time">%M</span><p class="unit">Minut</p></li>'
+ '<li class="time-wrap col-xs-6 col-sm-3"><span class="time">%S</span><p class="unit">Sekund</p></li>'
+''
));
});
};
...
<script src="http://www.transporcik.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/custom.js"></script>
