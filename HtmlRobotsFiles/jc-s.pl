...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556166490"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; JC Systems</title>

</head>
<body class="koThemeDark" data-bgcolor="#212121" style="background:#212121" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1473110899" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>JC Systems</h2></div><!--Logo--></a>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#203957" class=" keditDark " style="background:#203957">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 JC Systems, All Rights Reserved.</div>
</div>
