...
<link rel="SHORTCUT ICON" href="http://futurehost.pl/img/favicon.ico" />
<style>
html {
height: 100%;
}
...
<body>
<div class="Content">
<a href="http://futurehost.pl" class="Logo" title=""><img src="http://futurehost.pl/img/futurehost.png" alt="Serwery www - hosting dla wymagajacych" /></a>
<h2>Ta domena juz dziala!</h2>
<h3>Juz teraz mozesz <a href="http://futurehost.pl/pomoc/poradniki/wgrywanie-usuwanie-i-aktualizowanie-plikow-na-serwerze?c=9&a=31">wgrac</a> swoje pliki do katalogu: <br /><em>domains&nbsp;/&nbsp;tapicer-leszno.pl&nbsp;/&nbsp;public_html&nbsp;/</em></h3>
<br />
<h3>lub <a href="http://futurehost.pl/pomoc/poradniki/tworzenie-stron/strona-internetowa-w-10-minut-wordpress?c=10&a=25">utworzyc</a> swoja witryne w kilka minut!</h3>
<h1>Domena utrzymywana jest na serwerach <a href="http://futurehost.pl">Futurehost.pl</a></h1>
</div>
</body>
</html>
