...
<meta name="google-site-verification" content="aoRMBzDZToHJOd3rR5M6WNMWh2qWlOITONSbI0Dea-o" /><link rel="bookmark" href="editor_images/favicon.png" />
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556124462"></script>
...
<link href="data/templates/ko03/images/bootstrap-responsive-2.css?1419857734" rel="stylesheet">
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_ko03.css?1427129957" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style>
...
<li ><a href="http://saboo-art.pl/"><span>HOME</span></a></li>
<li ><a href="index.php?p=1_8_galeria" rel="dropmenu_1_8"><span>GALERIA</span></a></li>
<li ><a href="index.php?p=1_2_o-mnie"><span>O&nbsp;MNIE</span></a></li>
<li ><a href="index.php?p=1_5_kontakt"><span>KONTAKT</span></a></li>
<li ><a href="index.php?p=1_7_newsletter"><span>NEWSLETTER</span></a></li>
<li ><a href="index.php?p=1_6_sklep"><span>SKLEP</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Saboo Design Sabina Gontarewicz,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
