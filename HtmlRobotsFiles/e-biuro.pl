...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/favicon-96x96.png" />
<link rel="shortcut icon" href="data/files/favicon-96x96.png" />
<link rel="apple-touch-icon" href="data/files/favicon-96x96.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556055862"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; e-biuro - Twoja firma w jednym miejscu</title>


<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />

<link href="inc/js/bootstrap/bootstrap.css?1417616622" rel="stylesheet">
<link href="data/templates/desktop/images/bootstrap-responsive-2.css?1417616622" rel="stylesheet">
...
<body><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>.container_content{background:none;}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>e-biuro</h2><h4>Twoja firma w jednym miejscu</h4></div><!--Logo--></a>
...
<li ><a href="http://e-biuro.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<li><a href="1_2_o-nas.html"><span>O&nbsp;nas</span></a></li>
<li><a href="kontakt"><span>Kontakt</span></a></li>
</ul> <br /> <br /> Kontakt z <a href="http://inetcafe.pl" target="_blank">administratorem</a></div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">2015 Copyright (c)<!--?php echo date("Y")?--> AVAL Sp. z o.o.<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://twitter.com/icpc_pl"><i class="fa fa-twitter fa-2x fa-fw"></i></a></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$("body").backstretch("data/templates/desktop/images/un36.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
