...
<style>
#container {
background: url(shared/users_backgrounds/8/bgpattern.png);
...
<option value="malowanka_dla_dzieci_689">Malowanka dla dzieci</option>
<option value="fotozegar_na_plotnie_947">Fotozegar na plotnie</option>
...
<option value="fotoroleta_1777">Fotoroleta</option>
<option value="tablica_magnetyczna_1918">Tablica magnetyczna</option>
<option value="obraz_z_napisem_1934">Obraz z napisem</option>
<option value="zegar_dzieciecy_2032">Zegar dzieciecy</option>
...
$.ajax({
url: 'http://topobrazy.pl/autocomplete/gallerySearch/' + $('.menu-search-input select').val() + '/' + request.term,
dataType: "json",
...
$img.attr({
src: 'http://topobrazy.pl' + item.icon,
alt: item.label
});
...
<a href="http://topobrazy.pl/Logowanie.html" class="jq-rep">
...
<a href="http://topobrazy.pl"><div class="footer-logo"></div></a>
<div id="innerfooter">
