...
<title>Blad 404: Strona nie istnieje! &raquo; undro.pl</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1548697508" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {} </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/_mg_0598.jpg" style="border:0" id="WebsiteLogo" alt="undro.pl" /><span>undro.pl</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://undro.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div class="kedit keditRow" id="kpg_740" data-background="data/files/bieszczady.jerzyundrobies_0062.jpg" style="background: url(data/files/bieszczady.jerzyundrobies_0062.jpg) no-repeat center center;background-size:cover">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_291"><div class="keditable keditable-auto"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">(c) 2019, Wszelkie prawa zastrzezone</font></font></font></font></div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_192" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Facebook"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://twitter.com/Twitter"><i class="fa fa-twitter fa-2x fa-fw"></i></a><a target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube fa-2x fa-fw"></i></a></ul><style></style></div></div>
</div>
</div>
</div>
