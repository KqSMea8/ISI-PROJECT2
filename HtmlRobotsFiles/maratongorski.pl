...
<script src="/web/js/api/api.js?url=http://maratongorski.pl/"></script>
...
<a href="http://maratongorski.pl/" title="LESNIK maraton gorski" class="lg"><img src="/ts1/resize=w:400|h:250&img=strona/logo.png" alt="LESNIK maraton gorski"></a>
</div></div><!-- olghd -->
<a href="http://maratongorski.pl/" title="LESNIK maraton gorski" class="tptt">LESNIK maraton gorski</a>
