...
<html>
<head>
<title>STS-TIMING.PL - REJESTRACJA 4. Polmaraton Dwoch Mostow - Plock - 2015-09-13</title>
...
<tr valign="middle">
<td colspan="3">
<div class="center"><p class="head">STS-TIMING.PL - Rejestracja<br>4. Polmaraton Dwoch Mostow<br>Plock - 2015-09-13</p></div>
<div class="center"><p class="head"> <a href="lista.pdf">Lista startowa - 4. Polmaraton Dwoch Mostow</a></p></div>

<div class="center"><p class="head">Zanim sie zglosisz do imprezy, przeczytaj <a class="regulamin" href="regulamin.pdf">regulamin</a></p></div></td></tr>
...
<td width="400" class="row0">&nbsp;<input type="text" id="imie" name="imie" size="20" maxlength="20"></td>
</tr>
...
<td width="200" class="row0"> Klasyfikacja plocczanek i plocczan  <BR>   </td>
...
<td width="200" class="row1">   Rozmiar Koszulki <BR>   </td>
<td width="21" class="row1"><div class="row1">&nbsp;</div></td> <td width="400" class="row1">
&nbsp;
<select id="koszulka" name="koszulka" style="width: 150px">
<option>S</option>
<option>M</option>
<option>L</option>
<option>XL</option>
...
<td colspan="3"> <strong class="red">Prawidlowe zgloszenie (dajace pewnosc startu) obejmuje rejestracje i wniesienie oplaty startowej w terminie przewidzianym
w </strong><a class="regulamin" href="regulamin.pdf">regulaminie</a></td>
</tr><tr valign='middle'><td colspan='3'>
