...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo3.jpg" />
<link rel="shortcut icon" href="data/files/logo3.jpg" />
<link rel="apple-touch-icon" href="data/files/logo3.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Domine|Domine&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Domine|Domine&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Domine","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Domine","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556117804"></script>
...
<body class="" data-bgcolor="#EEEEEE" style="background:#EEEEEE" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1552567099" />
...
<a href="index.php" class="logo"><img src="data/files/beztytuu2.png" style="border:0" id="WebsiteLogo" alt="" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="index.php?p=1_2_o-firmie"><span>O&nbsp;FIRMIE</span></a></li>
<li  ><a href="index.php?p=1_7_spedycja"><span>SPEDYCJA</span></a></li>
<li  ><a href="index.php?p=1_5_transport"><span>TRANSPORT</span></a></li>
<li  ><a href="index.php?p=1_6_dokumenty"><span>DOKUMENTY</span></a></li>
<li  ><a href="index.php?p=1_8_kontakt"><span>KONTAKT</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/113095-oojrxm-10.jpg" data-align="keditLeft"  class=" koHeaderHide  keditLeft " style="background:#90A4AE url(data/files/113095-oojrxm-10.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>(c)2015, All Rights Reserved</div></div>
</div>
