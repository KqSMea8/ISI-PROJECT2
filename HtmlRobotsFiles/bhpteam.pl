...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556042165"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Uslugi i szkolenia z zakresu BHP i PPOZ. Szkolenia z zakresu pierwszej pomocy." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; bph ppoz kielce pierwsza pomoc szkolenia obsluga firm</title>
...
<link href="http://fonts.googleapis.com/css?family=Cantata+One|Varela+Round&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Cantata One","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1439570869" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style></style>
...
<a href="index.php" class="logo"><img src="data/files/mapabitowaloga.gif" style="border:0" id="WebsiteLogo" alt="BHP Team" /></a>
...
<li ><a href="http://bhpteam.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> BHPTeam,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
