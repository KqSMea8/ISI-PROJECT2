...
<link rel="bookmark" href="data/files/ejanosikbiuroreklamy.png" />
<link rel="shortcut icon" href="data/files/ejanosikbiuroreklamy.png" />
<link rel="apple-touch-icon" href="data/files/ejanosikbiuroreklamy.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Sniglet|Josefin+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Sniglet|Josefin+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Sniglet","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Josefin Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556136005"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="eJanosik.pl -  agencja reklamowa Zakopane, projektowanie stron internetowych , drukarnia internetowa, social media, agencja interaktywna, reklamy swietlne," />
<meta name="keywords" content="agencja reklamowa Zakopane, projektowanie stron internetowych , drukarnia internetowa, social media, agencja interaktywna, reklamy swietlne." />
<title>Blad 404: Strona nie istnieje! &raquo; eJanosik - agencja reklamowa Zakopane i Podhale</title>

</head>
<body class="koThemeDark"  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1487709104" /><style> .koTheme1  .logoHolder #logoReplacer h2 {     line-height: 80px;     display: inline-block;     outline: 3px solid #FFF; outline-offset:-10px;     padding-right: 30px;     padding-left: 30px; }   .koTheme1 #headerMenu {     border:0     </style>
...
<a href="index.php" class="logo"><img src="data/files/ejanosikwicejnireklama.png" style="border:0" id="WebsiteLogo" alt="Writer" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.ejanosik.pl/"><span>Agencja</span></a></li>
<li  ><a href="oferta"><span>Oferta</span></a></li>
<li  ><a href="http://dpdzakopane.pl/"><span>DPD&nbsp;Pickup&nbsp;</span></a></li>
<li  ><a href="poliytka-prywatnosci"><span>RODO</span></a></li>
<li  ><a href="1_6_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/ejanosik"><i class="fa fa-facebook-square"></i></a><a class="koSocialTwitterHover" target="_blank" href="http://twitter.com/ejanosik_pl"><i class="fa fa-twitter"></i></a><a class="koSocialYouTubeHover" target="_blank" href="http://www.youtube.com/ejanosikTV"><i class="fa fa-youtube"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-background="data/files/internet_ejanosik.jpg" data-parallax="1"  class=" parallax-window  keditDark  kfilter1 " style="background: url(data/files/internet_ejanosik.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Agencja eJanosik.pl</div>
<div>ul. Spyrk&oacute;wka 7a</div>
<div>34-500 Zakopane</div>
<div>Pn-Pt: <strong>9.00 - 16.00</strong></div>
<div><strong>tel. 507 507 577</strong></div>
<div><strong><a href="mailto:kontakt@ejanosik.pl">kontakt@ejanosik.pl</a></strong></div>
<div>&nbsp;</div>
<div>Copyright &copy;2011-2017 eJanosik.pl, All Rights Reserved.</div></div>
</div>
