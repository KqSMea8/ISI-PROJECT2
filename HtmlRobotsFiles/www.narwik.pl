...
<link rel="bookmark" href="data/files/fav_narwik.jpg" />
<link rel="shortcut icon" href="data/files/fav_narwik.jpg" />
<link rel="apple-touch-icon" href="data/files/fav_narwik.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Dosis|Avenir&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Dosis|Avenir&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556148432"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Scenariusz filmu Bitwa o Narwik powstal na podstawie relacji i opowiadan zolnierzy SBSP, ktorych wspolautor scenariusza poznal wiele lat wczesniej zarowno w Norwegii jak i w Polsce. To dzieki ich wspomnieniom przez kilkanascie lat dojrzewala mysl powstania tego obrazu, ktory jest holdem za ich bohaterstwo i odwage w walce o niepodleglosc." />
<meta name="keywords" content="Narwik 1940, bitwa o Narwik, Norwegia, Kazimierz Dziedzioch, Jan Lasowski, Hakvik, cmentarz polskich zolnierzy, Bjorn Bratbak, Losy niezagubione, ORP &quot;Grom&quot;, ORP &quot;Blyskawica&quot;, SBSP, Samodzielna Brygada Strzelcow Podhalanskich, General Szyszko-Bohusz, fjord Rombakken, ORP &quot;Burza&quot;" />
<title>Blad 404: Strona nie istnieje! &raquo; Bitwa o Narwik - przygotowania do produkcji dramatu wojennego</title>

</head>
<body class="" data-background="data/files/theme/sky.jpg" style="background: url(data/files/theme/sky.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1469886220" /><style>.koTheme1 #website{margin-left:5%;margin-right:5%;box-shadow:0 0 50px rgba(0,0,0,0.5);background-color:#fff} .koTheme1 #headerMenu{background:linear-gradient(to bottom, rgba(0,0,0,0.5) 0%,rgba(0,0,0,0) 100%);margin:0;border:0}
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Narwik 1940</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.narwik.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/theme/sky.jpg" data-align="keditLeft"  class=" keditDark  keditLeft  kfilter23 " style="background:#90A4AE url(data/files/theme/sky.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy; Raycom 2016-2019, All Rights Reserved</div></div>
</div>
