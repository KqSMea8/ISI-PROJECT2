...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/znak.png" />
<link rel="shortcut icon" href="data/files/znak.png" />
<link rel="apple-touch-icon" href="data/files/znak.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556054523"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="NARZEDZIA SKRAWAJACE, NARZEDZIA RECZNE, MATERIALY SCIERNE, TECHNIKA POMIAROWA, PNEUMATYKA, ZLACZKI DO FORM WTRYSKOWYCH, ELEMENTY ZLACZNE, CHEMIA PRZEMYSLOWA, FILTRY PRZEMYSLOWE, WYPOSAZENIE PRODUKCJI, ELEKTRONARZEDZIA, ARTYKULY BHP" />
<meta name="keywords" content="LEGNICA,NARZEDZIA LEGNICA, DRAMET, FORUM, FORUM+, NARZEDZIA SKRAWAJACE, NARZEDZIA RECZNE, MATERIALY SCIERNE, TECHNIKA POMIAROWA, PNEUMATYKA, ZLACZKI DO FORM WTRYSKOWYCH, ELEMENTY ZLACZNE, CHEMIA PRZEMYSLOWA, FILTRY PRZEMYSLOWE, WYPOSAZENIE PRODUKCJI, ELEKTRONARZEDZIA, ARTYKULY BHP" />
<title>Blad 404: Strona nie istnieje! &raquo; DRAMET-ZAOPATRZENIE PRZEMYSLU</title>

</head>
<body class="koThemeDark" data-bgcolor="#212121" style="background:#212121" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1487528908" />
...
<a href="index.php" class="logo"><img src="data/files/logorastrowebeztawhite_1480852043.png" style="border:0" id="WebsiteLogo" alt="dramet.pl- ZAOPATRZENIE PRZEMYSLU" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://dramet.pl/"><span>O&nbsp;FIRMIE</span></a></li>
<li  ><a href="oferta"><span>OFERTA</span></a></li>
<li  ><a href="producenci"><span>PRODUCENCI</span></a></li>
<li  ><a href="kontakt"><span>KONTAKT</span></a></li>
<li  ><a href="http://www.sklep.dramet.pl/"><span>SKLEP&nbsp;INTERNETOWY</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#dbe5f1" data-background="data/files/cnc_milling_1480850794.jpg" data-parallax="1"  class=" parallax-window  kfilter1 " style="background:#dbe5f1 url(data/files/cnc_milling_1480850794.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright (c)2015, All Rights Reserved</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><span id="footerHitCounter">Liczba odwiedzin: 374</span></div>
</div>
</div>
</div>
</div>
