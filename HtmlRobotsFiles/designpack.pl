...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/design_logo.png" />
<link rel="shortcut icon" href="data/files/design_logo.png" />
<link rel="apple-touch-icon" href="data/files/design_logo.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Playfair+Display|Varela+Round&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Playfair+Display|Varela+Round&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556051740"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Design Pack Producent Opakowan Tekturowych Janusz Tyc Zajmujemy sie produkcja opakowan tekturowych miedzy innymi opakowania na wino z logo firmy, personalizowane opakowania, opakowania klasyczne, opakowania wykrojnikowe." />
<meta name="keywords" content="Opakowania klapowe, wykrojnikowe, pudelka na wino, kartoniki ozdobne, materialy pakowe, tasma klejaca, folia stretch, folia babelkowa, tektura dwuwarstwowa, opakowania na wino z logo firmy, personalizowane, opakowania ozdobne, opakowania kaszerowane, opakowania na wino, opakowania weselne, opakowanie na ciasto," />
<title>Blad 404: Strona nie istnieje! &raquo; Design Pack Producent Opakowan Tekturowych, opakowania ozdobne na wino z logo, pudelka ozdobne, wykrojnikowe, klapowe, materialy pakowe Wroclaw dolnoslaskie</title>

</head>
<body class="" data-background="data/files/adobestock_49089142..jpg" style="background: url(data/files/adobestock_49089142..jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1505581580" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<ul class="menuHolder topmenu"><li  ><a href="http://www.designpack.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="oferta"><span>Oferta</span></a></li>
<li  ><a href="galeria"><span>Realizacje</span></a></li>
<li  ><a href="1_18_o-tekturze.html"><span>O&nbsp;tekturze&nbsp;</span></a></li>
<li  ><a href="kontakt"><span>Kontakt</span></a></li>
<li  ><a href="https://www.designpack.pl/sklep"><span>Sklep</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/DesignPack.Opakowania"><i class="fa fa-facebook-square"></i></a><a class="koSocialGoogleHover" target="_blank" href="http://plus.google.com/+DesignpackPl"><i class="fa fa-google-plus-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#203957" data-background="data/files/szablon_allegro/baner_allegro-designpack.png" class=" koHeaderAutoHeight  koHeaderHide " style="background:#203957 url(data/files/szablon_allegro/baner_allegro-designpack.png) no-repeat 50% 0px;background-size:cover">
</div>
