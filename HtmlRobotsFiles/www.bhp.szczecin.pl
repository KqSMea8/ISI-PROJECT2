...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/behalogo.png" />
<link rel="shortcut icon" href="data/files/behalogo.png" />
<link rel="apple-touch-icon" href="data/files/behalogo.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Exo|Exo&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Exo|Exo&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Exo","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Exo","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556132977"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Szkolenia i kursy BHP i PPOZ. Szczecin, Gryfino, Stargard, Goleniow, Police. Szkolenia wstepne i okresowe. Kurs operatorow wozkow jezdniowych. Szkolenia z pierwszej pomocy przedlekarskiej. Doradztwo BHP i PPOZ. OCHRONA SRODOWISKA. Instrukcje bezpieczenstwa pozarowego. Ocena ryzyka zawodowego. Nadzor bhp. Sprawozdania, raporty, zestawienia. Naliczanie oplat srodowiskowych. Artykuly BHP, odziez robocza, odziez ochronna, obuwie robocze, obuwie ochronne, hurtownia bhp, rekawice robocze, rekawice ochronne. Pomiary oswietlenia." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Szkolenia bhp, ppoz, wozki widlowe, pierwsza pomoc, pomiary oswietenia &quot;BEHAPERT&quot; Szczecin</title>

</head>
<body class="" data-bgcolor="#ffffff" style="background:#ffffff" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1483845158" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><img src="data/files/logobehapert.png" style="border:0" id="WebsiteLogo" alt="BEHAPERT - KOMPLEKSOWE ROZWIAZANIA DLA FIRM" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="http://behapert.pl" target="_blank"><span>SKLEP&nbsp;BHP/PPOZ.</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/behapert"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#EEEEEE" data-background="data/files/behapertbaner.jpg" class=" koHeaderAutoHeight  koHeaderHide " style="background:#EEEEEE url(data/files/behapertbaner.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy; 2000-2019 BEHAPERT Krzysztof Kuklinski, All Rights Reserved.</div></div>
</div>
...
_smartsupp.key = "e1ed8e2fe3b786f5dea8303d43b7f6b97d8d658b";
