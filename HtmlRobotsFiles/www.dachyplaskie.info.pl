...
<span style="cursor:pointer;width:800px;height:100px;" onclick="javascript:bannerClick('74');window.open('http://www.mercor.com.pl/', '_blank');"><img src="/imgs_upload/aktualnosci/2017/marzec2017/31032017_mercor_baner.jpg" border=0 width=800 height=100></span>
</div>
<!--end reklama top-->
