...
<script> var wersja_strony= 'auto';if(wersja_strony==='auto'){$.ajax({type:'GET',url:'/ajax/session.php?font_size='+font_size+'&kontrast='+kontrast+'&wersja_strony='+screen.width,success:function(){location.href='http://www.polmaraton.kietrz.pl/robots.txt/main/'}});}</script>
...
location.href='http://www.polmaraton.kietrz.pl//main/1556152516/';
}
}});
}
