...
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1544193940" />
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/3-logo.png" style="border:0" id="WebsiteLogo" alt="AIR-CONTROL" /><span>AIR-CONTROL</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://air-control.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderContent" data-background="data/files/theme/3-1.jpg" data-parallax="1"  class=" parallax-window  keditDark " style="background: url(data/files/theme/3-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit" id="kpg_351" ><div class="keditable keditable-auto">Copyright (c)2018 AIR-CONTROL, All Rights Reserved.</div></div>
</div>
