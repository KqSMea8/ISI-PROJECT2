...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Kameron|Delius&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Kameron|Delius&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Kameron","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Delius","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556040586"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Mieszalnia lakierow samochodowych i przemyslowych.
Blacharstwo i lakiernictwo pojazdowe" />
<meta name="keywords" content="lakiery samochodowe lakier samochodowy lakiery przemyslowe lakier w sprayu lakiernictwo blacharstwo wulkanizacja spawanie felg wymiana opon prostowanie felg" />
<title>Blad 404: Strona nie istnieje! &raquo; Auto Color Mix</title>

</head>
<body class="koThemeDark"  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1482184383" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Auto Color Mix</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="1_2_kontakt.html"><span>KONTAKT</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/img-185425.jpg" class=" koHeaderAutoHeight " style="background:#90A4AE url(data/files/img-185425.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><h5><span style="font-size: 14px;">Copyright &copy; 2016 Auto Color Mix. Wszelkie prawa zastrzezone.</span></h5></div>
</div>
