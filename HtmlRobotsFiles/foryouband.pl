...
<!-- Clock Countdown -->
<div id="clock-countdown" class="animated bounceInDown" data-animation-delay="600"></div>
<h3 class="color-white top-margin animated bounceInDown" data-animation-delay="600" >
Strona jest w przebudowie. <br>
Wkrotce wrocimy z nasza nowa niesamowita witryna.<br>
Sledz nas na Facebooku i badz na biezaco</h3>

<div class="header-section animated bounceInDown" data-animation-delay="700">
<!-- title section --><br>
<br>

<h2 class="title-section">Kontakt</h2><!-- /title section -->
...
<!-- maps section -->
<div class="col-xs-12 col-md-6 animated bounceInRight" data-animation-delay="700">
<div class="big-maps center" >
<ul>
<li><span>telefon: </span><a href="tel:+48508185352">508 185 352</a></li>
...
<li><span>email: </span><a href="mailto:foryoubandpl@gmail.com">foryoubandpl@gmail.com</a></li>
</ul>
</div>
</div><!-- /maps section -->
<!-- socials icons -->
...
<ul>
<li><a href="https://www.facebook.com/Zesp%C3%B3%C5%82-muzyczny-Foryouband-586182628186545/"><i class="ion-social-facebook"></i></a></li>
</ul>
</nav><!-- /socials icons -->
