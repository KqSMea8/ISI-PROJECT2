...
<div data-action-wrapper style="position: relative;"><div data-action="" data-action-params=[] data-action-id="6182p1cxa89u47gairximwg9vmznc8h1" style="position: relative; width: 100%;" data-hiding-delay="300" data-showing-delay="0"><div class="alert alert-danger text-center">
<h1>
