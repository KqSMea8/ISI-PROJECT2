...
<meta name="Keywords" content="dxa.pl" />
<meta name="Description" content="dxa.pl" />
...
<p class="center" style="font-weight: bold">Cena sprzedazy: 900,00 PLN netto</p>
<p class="center"><input type="hidden" name="dodanieDomen" value="doKoszyka" />
<input type="hidden" name="domains[]" value="dxa.pl" />
