...
<title>Narzedzia - testerzy.pl</title>
...
<ul class="nav">
<li><a href="http://generator-hasel.testerzy.pl/">Generatory</a></li>
<li><a href="http://walidator.testerzy.pl/">Walidatory</a></li>
<li><a href="http://test-lacza.testerzy.pl/">Test lacza</a></li>
<li class="active"><a href="http://whois.testerzy.pl/">WhoIs</a></li>
<li><a href="http://licznik-znakow.testerzy.pl/">Licznik znakow</a></li>
<li><a href="http://narzedzia-desktopowe.testerzy.pl/">Narzedzia desktopowe</a></li>
</ul>
</div>
</div>
...
<h1>Whois</h1>
<h3>Sprawdzenie IP i domeny - sprawdz, kto kryje sie za IP lub domena.</h3>
</div>

<div>
<p>W pole ponizej wpisz adres internetowy lub IP komputera/serwera, aby pozyskac informacje na temat autora, np. testerzy.pl lub 85.128.129.10.</p>
<form action="index.php" method="get">
<input type="text" name="domain" size="40" value="" class="border-brown wide-row">
<input type="submit" value="Sprawdz baze" class="button">
</form>
</div>
...
try {
var pageTracker = _gat._getTracker("UA-3160936-27");
