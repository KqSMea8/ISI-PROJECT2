...
<head>
<!--RSS-->
<meta name="google-site-verification" content="Gd5v9FE7-Om2Not4g3L6pXG03nJ3tNKwaTOrcGPzL8w" /><link rel="bookmark" href="data/files/fotoeaf.gif" />
<link rel="shortcut icon" href="data/files/fotoeaf.gif" />
<link rel="apple-touch-icon" href="data/files/fotoeaf.gif" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556054532"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Galeria zdjec. Bank zdjec. Zdjecia prosto z kamery. Prywatna Galeria fotograficzna. Photo. Foto. Abstrakcja. Architektura. Fauna i Flora. Ptaki. Czaple. Czapla. Tukan. Papugi. Papuga. Krajobraz. Ludzie. Martwa natura. Technologia. Transport. Zywnosc. Napoje. Wideo. Rysunek, niebo, photos, stock, zdjecia, galeria foto, fauna, flora, transport, niebo, moon, sun, slonce, kwiaty, abstrakcja, photos, sthock," />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Galeria Foto. Bank zdjec. Zdjecia prosto z kamery.</title>


<meta name="viewport" content="width=device-width, initial-scale=0.0", maximum-scale=1.0, user-scalable=0">
...
<link href="http://fonts.googleapis.com/css?family=Chivo|Chivo&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,h3,#content h3,.topmenu{font-family:"Chivo","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Chivo","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_stretchedBright.css?1485221719" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style></style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<li ><a href="http://www.drawgraf.pl/fotografia" rel="dropmenu_1_25"><span>Zdjecia</span></a></li>
<li ><a href="https://drawgraf.pl/info" rel="dropmenu_1_47"><span>Info</span></a></li>
<li ><a href="https://drawgraf.pl/rysunek"><span>Rysunek</span></a></li>
...
<div class="margins">Pracownia "EAF" /&nbsp; 1994<br />Copyright (c)<!--?php echo date("Y")?--> EAF/ www.drawgraf.pl,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/drawgraf"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-36190361-2']);
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_splash2").backstretch("data/files/tlo-1.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
