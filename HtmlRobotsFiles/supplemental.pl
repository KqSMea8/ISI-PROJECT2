...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/001.png" />
<link rel="shortcut icon" href="data/files/001.png" />
<link rel="apple-touch-icon" href="data/files/001.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556127282"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Supplemental</title>

</head>
<body class="" data-background="data/files/001.png" style="background: url(data/files/001.png) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481874281" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} #headerMenu.koMenu4 { background: #DEC1AB;}</style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Supplemental</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://supplemental.pl/"><span>Start</span></a></li>
<li  ><a href="1_2_o-mnie.html"><span>O&nbsp;mnie</span></a></li>
<li  ><a href="1_5_moje-uslugi.html"><span>Moje&nbsp;uslugi</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/001.png" class=" koHeaderAutoHeight " style="background:#90A4AE url(data/files/001.png) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 Supplemental, All Rights Reserved.</div>
</div>
