...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556114473"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; labstor.pl</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1542929691" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>labstor.pl</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://labstor.pl/"><span>Start</span></a></li>
<li  ><a href="1_2_o....html"><span>O...</span></a></li>
...
<div id="subpageHeaderContent" data-bgcolor="#90A4AE" class=" keditDark " style="background:#90A4AE">
</div>
