...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Asap|Asap&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Asap|Asap&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Asap","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Asap","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556152325"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Wynajem pokoi goscinnych w Ostrowie nad morzem." />
<meta name="keywords" content="Norda Ostrowo, pokoje goscinne, wynajem pokoi, wczasy nad morzem, kwatera nad morzem" />
<title>Blad 404: Strona nie istnieje! &raquo; http://www.pokojeostrowonorda.pl/</title>

</head>
<body class="" data-bgcolor="#FAFAFA" style="background:#FAFAFA" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1497898306" /><style>   .koTheme1 #headerMenu a {     color: #0066ff; }  </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Norda Ostrowo Pokoje Goscinne</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.pokoje-goscinne-norda-ostrowo.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_oferta.html"><span>Oferta</span></a></li>
<li  ><a href="1_3_cennik.html"><span>Cennik</span></a></li>
<li  ><a href="1_5_zdjecia.html"><span>Zdjecia</span></a></li>
<li  ><a href="1_4_kontakt-mapa.html"><span>Kontakt,&nbsp;Mapa</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-background="data/files/morze2.jpg" data-parallax="1"  class=" parallax-window " style="background: url(data/files/morze2.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright (c)2017,&nbsp; Norda Ostrowo Pokoje Goscinne</div>
<div><span style="color: #ded7d7;"><span style="color: #ded9d9;"><a href="http://stronywchmurze.pl" style="color: #ded9d9;">stronywchmurze.pl</a></span> Projektowanie<span style="color: #ded9d9;"> <a href="http://stronywchmurze.pl/1_1#oferta" style="color: #ded9d9;">strony www</a> </span>Szczecin | sklepy internetowe | tani hosting<br />Domki nad morzem Rusinowo Jaroslawiec <a href="https://domkijaroszowka.pl" style="color: #ded7d7;">https://domkijaroszowka.pl</a><br /></span></div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Pokoje-Go%C5%9Bcinne-Norda-Ostrowo-593058370793040"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 3085</span></div>
</div>
</div>
</div>
</div>
