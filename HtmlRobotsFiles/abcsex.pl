...
background: #ffffff url('/templates/10.jpg') no-repeat;
...
<div id="container">
<h1>abcsex.pl</h1>
<p class="center">Slownik seksu, tajemnice seksu, seksowna domena ;)</p>
