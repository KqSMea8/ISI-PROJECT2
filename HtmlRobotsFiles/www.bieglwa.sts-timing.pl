...
<html>
<head>
<title>STS-TIMING.PL - REJESTRACJA Bieg Lwa - Tarnowo Podgorne - 2015-05-24</title>
...
var koszulka = document.getElementById('koszulka');
var error = 0;
...
else if(rok.value >= 1998 && (dystans.value == '21km_standard' || dystans.value == '21km_premium')){
document.getElementById('error_rok').className = 'error';
document.getElementById('popraw_wiek').innerHTML = 'Musisz mie&#263 uko&#324czone 18 lat.';
error = 1;
}
else{
document.getElementById('error_rok').className = 'ok';
document.getElementById('popraw_wiek').innerHTML = '';
}

if(dystans.value == 0){
document.getElementById('error_dystans').className = 'error';
error = 1;
}
else{
document.getElementById('error_dystans').className = 'ok';
}
if(koszulka.value == 0){
document.getElementById('error_koszulka').className = 'error';
error = 1;
}
else{
document.getElementById('error_koszulka').className = 'ok';
}
...
<tr valign="middle">
<td colspan="3">
<div class="center"><p class="head">STS-TIMING.PL - Rejestracja<br>Bieg Lwa<br>Tarnowo Podgorne - 2015-05-24</p></div>
<div class="center"><p class="head"> <a href="lista.php">Lista startowa - Bieg Lwa</a></p></div>
