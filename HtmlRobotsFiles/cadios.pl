...
<link rel="bookmark" href="data/files/logoserce.png" />
<link rel="shortcut icon" href="data/files/logoserce.png" />
<link rel="apple-touch-icon" href="data/files/logoserce.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556046318"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Wylaczny autoryzowany przedstawiciel handlowy i serwisowy firmy Bionet w Polsce. Profesjonalna aparatura medyczna. Kardiotokografy, Elektrokardiografy, Kardiomonitory. 5 lat gwarancji!!!" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Cadios - aparatura medyczna</title>
...
<link href="http://fonts.googleapis.com/css?family=Noto+Sans|Varela+Round&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Noto Sans","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1452774046" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style>
...
<a href="index.php" class="logo"><img src="data/files/cadioslogoaparatura.png" style="border:0" id="WebsiteLogo" alt="CADIOS.PL" /></a>
...
<h2 style="text-align: center;"><span class="CurrentPageName">Blad 404: Strona nie istnieje!</span></h2>
</div>
</div></div></div></div>
...
<li><a href="1_5_produkty.html"><span>PRODUKTY</span></a><ul>
<li><a href="1_6_kardiotokografy.html"><span>KARDIOTOKOGRAFY</span></a></li>
<li><a href="1_8_elektrokardiografy.html"><span>ELEKTROKARDIOGRAFY</span></a></li>
<li><a href="1_10_kardiomonitory.html"><span>KARDIOMONITORY</span></a></li>
<li><a href="1_12_akcesoria.html"><span>AKCESORIA</span></a></li>
</ul></li>
<li><a href="1_4_kontakt.html"><span>KONTAKT</span></a></li>
<li><a href="1_9_o-firmie.html"><span>O&nbsp;FIRMIE</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> My Company,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <span id="footerHitCounter">Liczba odwiedzin: 157397</span></div>
</div>        </div>
</div>
</div>
</div>
