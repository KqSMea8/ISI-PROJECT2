...
<meta name="description" content="Nazwa restauracji "Ludowa" jest scheda po lokalu ktory dzialal w tym miejscu od lat powojennych do roku 1991 i byl w posiadaniu miejscowej Gminnej Spoldzielni. Firma nasza rozpoczela funkcjonowanie 01.05.1993 roku jako small business rodzinny. Przez kolejne lata dzialalnosci i przecieraniu szlakow przedsiebiorczosci, znalezlismy i umacniamy swoja pozycje na gastronomicznej mapie restauracji Kietrza, powiatu i nie tylko. Po roznych zawirowaniach i przeksztalceniach w formie wlasnosci nadal kultywujemy rodzinna forme prowadzenia firmy. Podstawa jadlospisu sa potrawy z tradycyjnej kuchni polskiej, a od 20.08.2003 roku rozszerzylismy menu o pizze wlasnej produkcji. Pizzeria jako novum na lokalnym rynku zdobyla wielu zwolennikow i smakoszy potraw z kuchni wloskiej, serwowanych do poznych godzin nocnych. Oprocz konsumpcji w lokalu, proponujemy dowoz pizzy i dan obiadowych do domu klienta. Swiadczymy rowniez uslugi cateringowe, a  takze organizujemy imprezy plenerowe. Potrawy przygotowywane sa przez doswiadczonych kucharzy na bardzo profesjonalnym sprzecie kuchennym, czego wyrazem jest zaskarbianie sobie klientow nie tylko z najblizszej okolicy, ale rowniez z dalekich zakatkow Polski i swiata.">
<meta name="keywords" content="restauracja,ludowa,kietrz,pokoje,goscinne,goscinne,pizza,pizzeria,pizzataxi,obiady,abonamentowe,imprezy,okolicznosciowe,okolicznosciowe">
<script> var kontrast= 'off';</script>
<script> var podstrona= 'main';</script>
<script> var font_size= '0';</script>
<script> var wersja_strony= 'auto';if(wersja_strony==='auto'){$.ajax({type:'GET',url:'/ajax/session.php?font_size='+font_size+'&kontrast='+kontrast+'&wersja_strony='+screen.width,success:function(){location.href='http://ludowa.com.pl/robots.txt/main/'}});}</script>
...
setTimeout('$("#biel").animate({"opacity":0},600,function(){$(this).detach(); if(document.getElementById(podstrona)) przewin_do_elementu(podstrona);})',500);
// o ile istnieje element o ID podstrona
//po zaladowaniu strony automatycznie przewija do odpowiedniego fragmentu
}else{
...
<div id="szybki-kontakt" class="left astable sama-gora">
<div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><table>
<tbody>
<tr>
<td><img src="/komponenty/fotografiki_upload/1456310419_galeria_telefon.png" alt="" width="22" height="20" /> 77 471 17 15&nbsp;&nbsp; <img src="/komponenty/fotografiki_upload/1456310419_galeria_kropka_telefony.png" alt="" width="7" height="7" />&nbsp; 77 471 17 17&nbsp; <img src="/komponenty/fotografiki_upload/1456310419_galeria_kropka_telefony.png" alt="" width="7" height="7" />&nbsp; 77 485 45 42</td>
<td><img src="/komponenty/fotografiki_upload/1456310419_galeria_mail.png" alt="" width="19" height="14" />&nbsp; restauracja@ludowa.com.pl</td>
</tr>
</tbody>
</table></div></div>            </div>
...
<div id="krotko-platnosci" class="astable right sama-gora">
<div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><table>
<tbody>
<tr>
<td><img src="/komponenty/fotografiki_upload/1456310817_galeria_karta.png" alt="" width="13" height="28" /></td>
<td>zam&oacute;w i zaplac przy odbiorze u kierowcy
<div>(chcesz zaplacic karta? poinformuj nas o tym przed zlozeniem zam&oacute;wienia)</div>
</td>
<td><img src="/komponenty/fotografiki_upload/1456310817_galeria_karty_loga.png" alt="" width="103" height="15" /></td>
</tr>
</tbody>
</table>
</div></div>            </div>
...
<hr/>
<a href="tel:774711717"><button id="zadzwon-mobilne"><span>kliknij i zadzwon</span><br/><div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><table>
<tbody>
<tr>
<td>77 471 17 17</td>
</tr>
...
<div id="menues" class='astable wPodstawowe'>
<!--            <div id="przelacznik-menu" class="astable left">
<ul class="">
</ul>
</div>-->
<div id="menu-glowne" class='astable marg-auto'>
<ul id="menu-pc" class="astable">
<li class='left'><a href="/robots.txt/oferta/"><div class="menus" link="oferta">Oferta</div></a></li>
<li class='left'><a href="/robots.txt/menu/"><div class="menus" link="menu">Menu</div></a></li>
<li class='left'><a href="/robots.txt/pokoje_goscinne/"><div class="menus" link="pokoje_goscinne">Pokoje goscinne</div></a></li>
<li class='left'><a href="/robots.txt/main/"><div class="menus" link="main"><img src="/komponenty/img/ludowa_logo.png" /></div></a></li>
<!--<li class='left'><a href="/robots.txt/zamow_online/"><div class="menus" link="/zamow_online/">zamow online</div></a></li>-->
<li class='left'><a href="http://zamow.s4honline.pl/ludowa/menu.php?id_category=100007"><div class="menus" link="zewnetrznie">zamow online</div></a></li>
<li class='left'><a href="/robots.txt/promocje/"><div class="menus" link="promocje">promocje</div></a></li>
<li class='left'><a href="/robots.txt/kontakt/"><div class="menus" link="kontakt">kontakt i dojazd</div></a></li>
</ul>
</div>
</div>
<hr/>
...
<section id="oferta" class="astable w100proc zbior-ikon-art-i-dzial">
<hr/>
<header class="tytul-sekcji-na-glownej"><h2>oferta</h2></header>
<div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><p><img style="display: block; margin-left: auto; margin-right: auto;" src="/komponenty/fotografiki_upload/1484218465_galeria_oferta_ikony.png" alt="" width="1579" height="77" /></p></div></div>    <div id="oferta-tekst"><div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><p>Nazwa restauracji "Ludowa" jest scheda po lokalu kt&oacute;ry dzialal w tym miejscu od lat powojennych do roku 1991 i byl w posiadaniu miejscowej Gminnej Sp&oacute;ldzielni.&nbsp;<br />Firma nasza rozpoczela funkcjonowanie 01.05.1993 roku jako small business rodzinny.&nbsp;Przez kolejne lata dzialalnosci i przecieraniu szlak&oacute;w przedsiebiorczosci, znalezlismy i umacniamy swoja pozycje na gastronomicznej mapie restauracji Kietrza, powiatu i nie tylko. Po r&oacute;znych zawirowaniach i przeksztalceniach w formie wlasnosci nadal kultywujemy rodzinna forme prowadzenia firmy.&nbsp;Podstawa jadlospisu sa potrawy z tradycyjnej kuchni polskiej, a od 20.08.2003 roku rozszerzylismy menu o pizze wlasnej produkcji. Pizzeria jako novum na lokalnym rynku zdobyla wielu zwolennik&oacute;w i smakoszy potraw z kuchni wloskiej, serwowanych do p&oacute;znych godzin nocnych. Opr&oacute;cz konsumpcji w lokalu, proponujemy dow&oacute;z pizzy i dan obiadowych do domu klienta. Swiadczymy r&oacute;wniez uslugi cateringowe, a&nbsp; takze organizujemy imprezy plenerowe. W kwietniu 2014 udostepnilismy 11 miejsc noclegowych, w pokojach goscinnych nad restauracja. Do dyspozycji gosci sa: jeden pok&oacute;j cztero osobowy z balkonem, jeden pok&oacute;j trzy osobowe i dwa pokoje dwu osobowe, og&oacute;lno dostepna kuchnia, wsp&oacute;lna lazienka i ubikacja.&nbsp; Naszych obecnych i przyszlych klient&oacute;w zapraszamy do skorzystania z naszego bogatego jadlospisu, gwarantujac smaczne dania i mila atmosfere</p></div></div></div>
<div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><table style="margin-left: auto; margin-right: auto;">
<tbody>
<tr>
<td><img src="/komponenty/fotografiki_upload/1456310003_galeria_zdjecie_oferta.png" alt="" width="284" height="85" /></td>
<td><img src="/komponenty/fotografiki_upload/1456310003_galeria_kafel_2.jpg" alt="" width="284" height="85" /></td>
<td><img src="/komponenty/fotografiki_upload/1456310003_galeria_kafel_3.jpg" alt="" width="284" height="85" /></td>
<td><img src="/komponenty/fotografiki_upload/1456310003_galeria_kafel_4.jpg" alt="" width="284" height="85" /></td>
</tr>
</tbody>
</table></div></div></section>
<section id="na_komorce" class="astable w100proc">
<div class="left">
<hr/>
<header class="tytul-sekcji-na-glownej"><h2>Przegladaj na komorce</h2></header>
<div>
<div id="ostatni_poziom" class="dla-artykulu"><div id="tresc-artykulu" class="tresc-artykulu"><p>Nasza nowa strona internetowa jest w pelni przystosowana do przegladania na urzadzeniach mobilnych. Teraz bez problemu moga Panstwo w komfortowych warunkach zaznajomic sie z naszym menu czy cenami. Wystarczy do tego telefon z dostepem do Internetu.<br /><br />Zapraszamy r&oacute;wniez do skladania zam&oacute;wien w naszym nowym systemie online!</p></div></div>            <div id="na-komorce-buttony">
<a href="#"><button>na gore strony</button></a>
<a href="http://zamow.s4honline.pl/ludowa/menu.php?id_category=100007"><button>zamowienia on-line</button></a>
</div>
</div>
</div>
<div class="right">
<img src="/komponenty/img/komorka.png"/>
</div>
</section>
</section>
<footer>
...
<div id="stopka-copyright" class="">
<img src="/komponenty/img/koleczko_stopka.png"/>
<div id="wysrodkowanie-stopki" class="astable marg-auto">
<div class="left"><div>Restauracja Ludowa <br/>48-130 Kietrz, ul Glubczycka 18A</div><img src="/komponenty/img/logo_ludowa_stopka.png"/></div>
<div class="right"><a href="http://www.smartraptor.pl/" target="_blank"><img src="/komponenty/img/smart_raptor_logo_stopka.png"/><div>Projekt i wdrozenie</div></a></div>
</div>
<hr/>
</div>
</footer>
...
location.href='http://ludowa.com.pl//main/1556115511/';
}
}});
}
