...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556060004"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Kancelaria EuroKonsult - Olga Naruszewicz</title>


<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />

<link href="inc/js/bootstrap/bootstrap.css?1419857735" rel="stylesheet">
<link href="data/templates/globe/images/bootstrap-responsive-2.css?1419857735" rel="stylesheet">
...
<link type="text/css" rel="stylesheet" href="data/templates/globe/images/style_template.css" />
<link type="text/css" rel="stylesheet" href="data/templates/globe/images/style_content.css" />
...
<link href="http://fonts.googleapis.com/css?family=Old+Standard+TT|Quattrocento+Sans&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Old Standard TT","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Quattrocento Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(data/templates/globe/images/pw_maze_white.png);}</style>

</head>
<body><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>.container_top,.container_header,.container_splash2{background:none;}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Kancelaria EuroKonsult</h2><h4>Olga Naruszewicz</h4></div><!--Logo--></a>
...
<li ><a href="http://eurokonsult.com.pl/"><span>Kontakt</span></a></li>
...
<div class="margins">Kancelaria Eurokonsult (c) 2016 <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_top").backstretch("data/templates/globe/images/header_1181919.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
