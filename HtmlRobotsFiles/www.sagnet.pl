...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Brawler|Asap&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Brawler|Asap&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556210655"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Mielecki Informator Regionalny</title>

</head>
<body class="" data-bgcolor="#ffffff" style="background:#ffffff" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1477692860" /><style>     .koTheme2 #contentArea,.koTheme2 #headerMenu {     margin: 0 5%;} .koTheme2 #header{margin:50px 0} </style>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div><span style="font-size: 10px;">Copyright &copy;2016 Mielecki Informator Regionalny, All Rights Reserved.</span></div></div>
</div>
