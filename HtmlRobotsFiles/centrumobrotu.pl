...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Bangers|Josefin+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Bangers|Josefin+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Bangers","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Josefin Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556047307"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Inwestycje rentierskie - lokale komercyjne, hale, grunty, inwestycje - t.723107999, 661441202</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1549547488" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {} </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/opti_nieruchomosci.png" style="border:0" id="WebsiteLogo" alt="Inwestycje rentierskie - lokale komercyjne, hale, grunty, inwestycje - t.723107999, 661441202" /><span>Inwestycje rentierskie - lokale komercyjne, hale, grunty, inwestycje - t.723107999, 661441202</span></h2></a>
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2019 RENTIERZY posrednictwo w obrocie, All Rights Reserved.</div>
</div>
