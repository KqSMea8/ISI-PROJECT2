...
<meta charset="UTF-8" />
<link rel="shortcut icon" href="/ts1/resize=w:16|h:16&img=../strona/logo.png" />
<title>404</title>
<meta name="description" content="LESNIK maraton gorski, 404" />
...
<script src="/web/js/api/api.js?url=http://www.maratongorski.pl/"></script>
...
body
{
background-image: url(/data/images/do-galerii/lib-trening-do-zimy.jpg);
}
...
<a href="http://www.maratongorski.pl/" title="LESNIK maraton gorski" class="lg"><img src="/ts1/resize=w:400|h:250&img=strona/logo.png" alt="LESNIK maraton gorski"></a>
</div></div><!-- olghd -->
<a href="http://www.maratongorski.pl/" title="LESNIK maraton gorski" class="tptt">LESNIK maraton gorski</a>
