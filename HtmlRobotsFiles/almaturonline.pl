...
AND  o.departure_date > '2019-04-23'
AND ( FALSE
...
<!-- /home/users/sykon_s/public_html/ajax2/_getoffers_v5.php, 0.078984975814819 ENDe koko -->
...
<ul>
<li>Termin:</li>
<li><input name="r_termin" value="2019-04-24" type="text" readonly="readonly" style="width: 70px;"></li>
</ul>
<ul>
<li>Cennik:</li>
<li>
