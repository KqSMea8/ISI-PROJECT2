...
<meta  property="og:title" content="bazamedyczna.com.pl - sklep z domenami internetowymi."  /><meta  property="og:description" content="1 domena na sprzedaz - polecam!"  /><meta  property="og:image" content="https://epremium.pl/view-shop1555306371/img/logo.png"  /> </head>
...
<div class="top-bar">
<div class="f-left">
<a href="http://bazamedyczna.com.pl/" class="logo"><img src="https://epremium.pl/view-shop1555306371/style/shop/logo.png" alt="sklep premium.pl" /></a>
</div>
<div class="f-right">
...
<form action="https://premium.pl/profil/web/kontakt/send" method="POST">
...
<img src="https://premium.pl/token.png?_t=1556041539" id="token" alt="" class="mid" />
...
<label>Sprzedajacy: <strong>web</strong> (firma)</label>

<div class="profile-button button-cat">
<a href="http://bazamedyczna.com.pl/kategorie">
<span>Pokaz kategorie</span>
</a>
</div>

<div class="profile-button button-rss">
<a href="https://premium.pl/subskrypcja/web.rss">
<span>RSS</span>
</a>
</div>

<div class="profile-button button-watch">
<a href="https://premium.pl/subskrypcja/web">
...
<div class="listcmp-container" id="listlist_20176409125cbf4f43bb4d8">
...
<div id="filters-top"
class="list-list_20176409125cbf4f43bb4d8 filters-top-list filters-top-simple"
style="display: none">
...
<form class="disable-prevent"  action="http://bazamedyczna.com.pl/"
method="get"
...
<form action="http://bazamedyczna.com.pl/" method="get">
<div>
...
<span class="list-size mid">Wynikow: <span>1</span></span>
...
<a href="http://bazamedyczna.com.pl/?order=name&amp;desc=0&amp;page=0#oferty"
class="link-order"
>Domena</a>
...
<a href="http://bazamedyczna.com.pl/?order=value_bn&amp;desc=0&amp;page=0#oferty"
class="link-order"
>Kup Teraz</a>
...
id="list_20176409125cbf4f43bb4d8_row_0_0">
...
<a title="CENNARADA.PL" class="dname" href="https://sklep.premium.pl/cennarada.pl">cennarada.pl</a>
...
<div>
<div>
<a class="option" href="https://sklep.premium.pl/cennarada.pl">Zaproponuj cene</a>
</div>
</div>
</div>
...
<a class="price-icon price-icon-offer" href="https://sklep.premium.pl/cennarada.pl"></a>
</div>
...
<td style="width: 33,333333333333%;"></td>
...
<!--
var list_20176409125cbf4f43bb4d8_o = $('#listlist_20176409125cbf4f43bb4d8');

$(document).ready(function () {
list_20176409125cbf4f43bb4d8_o.find('.bottomtab a').click(function (e) {
var was_hidden = list_20176409125cbf4f43bb4d8_o.find('.' + $(this).children('span').attr('class').replace('tabname', 'tab')).is(':hidden');

list_20176409125cbf4f43bb4d8_o.find('.tab').hide();

if (was_hidden) {
list_20176409125cbf4f43bb4d8_o.find('.' + $(this).children('span').attr('class').replace('tabname', 'tab')).show();
}

if (list_20176409125cbf4f43bb4d8_o.find('.tab-filters:not(:hidden), .tab-report:not(:hidden), .tab-legend:not(:hidden)').length > 0) {
$('.bottomtab-container').addClass('sep-b');
} else {
list_20176409125cbf4f43bb4d8_o.find('.bottomtab-container').removeClass('sep-b');
}
