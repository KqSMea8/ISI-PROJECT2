...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556117265"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; MM s.c. Biuro Rachunkowe</title>


<meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;" />

<link href="inc/js/bootstrap/bootstrap.css?1383648628" rel="stylesheet">
<link href="inc/js/bootstrap/bootstrap-responsive.css?1383648628" rel="stylesheet">
...
<link type="text/css" rel="stylesheet" href="data/templates/stretched2_beta/images/style_template.css" />
<link type="text/css" rel="stylesheet" href="data/templates/stretched2_beta/images/style_content.css" />



<script src="data/templates/stretched2_beta/images/jquery.backstretch.min.js" type="text/javascript"></script>
<script type="text/javascript">jQuery(function(){
/*Fixed Header Effect:*/
if(!( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) )) {
$fpos=$(".container_footer").height();$cpos=$(".container_content").offset();$spos=$(".container_splash").offset();$sspos=$(".container_splash2").offset();$hpos=$(".container_header").offset();
$(".container_header").css({"position":"fixed","z-index":"10","width":"100%","top":$hpos["top"]});if($sspos === null || typeof ($sspos) === "undefined"){$(".container_splash").css({"position":"fixed","z-index":"8","width":"100%","top":$spos["top"]})}else{$(".container_splash2").css({"position":"fixed","z-index":"8","width":"100%","top":$sspos["top"]});}$(".container_content").css({"position":"relative","z-index":"9","width":"100%","top":$cpos["top"]});$(".container_footer").css({"position":"relative","z-index":"9","width":"100%","top":$cpos["top"]});
/*End of Fixed Header Effect*/



/* Parallax header */$(window).scrollTop(0);var startTop=$('.container_splash2').offset();

if(startTop){startTop=startTop.top;var startHeaderTop=$('.container_header').offset().top;$(window).bind('scroll',function(e){

var scrolled = $(window).scrollTop();$('.container_splash2').css('top',(startTop-(scrolled*.55))+'px');$('.container_header').css('top',(startHeaderTop-(scrolled*.25))+'px');

});}/* Parallax header - End */

}
/* Stretched Image setup */
$(".container_splash").backstretch("data/templates/stretched2_beta/images/slide-bw.png");
$(".container_splash2").backstretch("data/templates/stretched2_beta/images/slide-bw.png");
/* End of Stretched Image setup */
});</script>

<link href="http://fonts.googleapis.com/css?family=Kreon&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:'Kreon',arial,serif}.container_content{}</style>

</head>
<body><link type="text/css" rel="stylesheet" href="data/colors_stretched2_beta.css?1384629744" /><link type="text/css" rel="stylesheet" href="style_extra.css?1.0.7" />
...
<li ><a href="http://mmsc.com.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="index.php?p=1_2_nasza-firma"><span>Nasza&nbsp;Firma</span></a></li>
<li ><a href="index.php?p=1_5_zakres-uslug"><span>Zakres&nbsp;uslug</span></a></li>
<li ><a href="index.php?p=1_7_kalendarz"><span>Kalendarz</span></a></li>
<li ><a href="index.php?p=1_6_do-pobrania"><span>Do&nbsp;pobrania</span></a></li>
...
<h2><span class="CurrentPageName" style="color: #ff6600;">Blad 404: Strona nie istnieje!</span></h2>
</div>
</div></div></div></div>
...
<div class="span8 footerMenu" style="font-family: Georgia,Times New Roman,Times,serif;"><ul>
...
<li><a href="index.php?p=1_6_do-pobrania"><span>Do&nbsp;pobrania</span></a></li>
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
</ul> <br /> <br /> "MM" spolka cywilna Marta Goluda - Suchodolska &amp; Marek Suchodolski&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />Kosynierow Gdynskich 104/2, 66-400 Gorzow Wlkp. <br /><br />tel: +48 95 783 60 01 <br />fax: +48 95 783 60 02<br />e-mail: info@mmsc.com.pl</div>
<div class="FooterCopyright span4 footerSpan">Copyright (c)2013 My Company,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>        </div>
</div>
</div>
</div>
...
// hide
$('#kopageBar')./*slideUp*/animate({'bottom':'-50px'},function(){
...
$('#kopageBar').animate({'bottom':'10px'});//slideDown();
...
<iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FBiuroobrachunkoweMMSC/?ref=aymt_homepage_panel&amp;width=325&amp;height=325&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color=%23ffffff&amp;header=false&amp;appId=346926555430054" scrolling="no" frameborder="0" style="border:none;overflow:hidden;width:325px;height:325px;" allowTransparency="true"></iframe>
