...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556163610"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Zajazd Gibson</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1494430417" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Zajazd Gibson</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://zajazdgibson.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_cennik.html"><span>Cennik</span></a></li>
<li  ><a href="1_3_zdjecia.html"><span>Zdjecia</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li  ><a href="1_5_film.html"><span>Film</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#ffffff" class=" koHeaderAutoHeight " style="background:#ffffff">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy; 2017-2019 Zajazd Gibson, All Rights Reserved.</div></div>
</div>
