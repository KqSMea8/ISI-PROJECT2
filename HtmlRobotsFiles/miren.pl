...
<link rel="apple-touch-icon" href="data/files/logo.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Asap|Varela+Round&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Asap|Varela+Round&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556117107"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Kompleksowe wyposazenie warsztatu samochodowego i wulkanizacji. Montazownica, Wywazarka, Kompresor, Podnosnik, Narzedzia, Klucze, Klimatyzacja, Geometria, Materialy Wulkanizacyjne, Akcesoria," />
<meta name="keywords" content="Ciezarki, ciezarek, ciezarek klejony, ciezarki klejone, ciezarek nabijany ciezarki nabijane,  Zawory, zawor, Montazownica, montazownica do kol,  montazownice do kol,  Wywazarka, wywazarki do kol, wywazarki do kol,  Kompresor, kompresory, kompresory srubowe, kompresory tlokowe, Podnosnik, podnosniki, podnosnik 4t, podnosnik 3t, podnosnik dwukolumnowy, podnosniki dukolumnowe, podnosniki czterokolumnowe, podnosnik czterokolumnowy,  Narzedzia, Klucze, Klimatyzacja, Geometria, Wymiana opony, Naprawa opony, prasa, prostowarka do felg, piaskarka, piaskarki, spawarki, wozki narzedziowe, wozek narzedziowy, montazownice do opon, podnosniki pneumatyczne, cegi, skrobaki, sciernice, lyzki montazowe, latki do opon radialnych i diagonalnych, zestawy naprawcze, kleje, uszczelniacze, ciezarki, zawory, pasty montazowe, czesci do montazownic i wywazarek, klucze, wkretaki, szczypce, gwintowniki, szafki narzedziowe, podnosniki nozycowe, podnosniki plytowe,  phu szczepan, phu-szczepan, le gum, le-gum, swistowski, tip top, tip-top, levor, ats, normet, elkur, mk tools, asta, techwar, techwa, coframa, nortec, lincos, ath,hoffmann, castex, ctx, stix, werther, unitrol, uni-trol, bosch, jonnesway, yato, hi-tachi, walter, airpres, maktek, beta, twin busch, kin gton, hilti, stanley, dunlop, royal tools, wulcar, kupczyk, vagtech, vag tech, vag-tech, prasy warsztatowa, pasty do opon, pasta do opon, opona, opony zimowe, opony letnie, opony uzywane, montazownica uzywana, montazownice uzywane, wywazarka uzywana, wywazarki uzywane, uzywane wywazarki do opon, uzywane montazownice do opon, stozki do wywazarki, wulkanizator, termopres, wysysarki oleju, zlewarko wysysarki, pasta zimowa, pasta do opon," />
<title>Blad 404: Strona nie istnieje! &raquo; MIREN - Wyposazenie Warsztatu Wulkanizacji</title>

</head>
<body class="" data-bgcolor="#ECEFF1" style="background:#ECEFF1" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1477393658" /><style>body{background:linear-gradient(to bottom,#000 0%,#000 100px, #966642 100px,#966642 200px, #774829 200px, #774829 100%)}.koTheme1 #website {margin-left:5%;margin-right:5%}.koTheme1 #header,.koTheme1 #contentArea{background:#fff;box-shadow:0 0 30px rgba(0,0,0,0.2)}.koTheme1 #headerMenu.koMenu2{margin:50px 30px 0;} .koTheme1 #headerMenu.koMenu2   {background:#000;box-shadow:0 0 20px #000}  .koTheme1 #headerMenu.koMenu2 .logoHolder, .koTheme1 #headerMenu.koMenu2 .logoHolder h2,.koTheme1 #headerMenu.koMenu2 .menuHolder li a {height:50px;line-height:50px;}  #headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><img src="data/files/logo.png" style="border:0" id="WebsiteLogo" alt="MIREN" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://miren.pl/"><span>STRONA&nbsp;GLOWNA</span></a></li>
<li  ><a href="promocje"><span>PROMOCJE</span></a></li>
<li  ><a href="finansowanie"><span>FINANSOWANIE</span></a></li>
<li  ><a href="o-nas"><span>O&nbsp;NAS</span></a></li>
<li  ><a href="kontakt"><span>KONTAKT</span></a></li>
<li  ><a href="http://allegro.pl/listing/user/listing.php?us_id=21073537" target="_blank"><span>ALLEGRO</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#774829" data-background="data/files/warsztatt.jpg" class=" koHeaderAutoHeight " style="background:#774829 url(data/files/warsztatt.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#455A64" class=" keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#455A64">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div style="text-align: left;">Copyright &copy;2016 MIREN, Wszelkie prawa zastrzezone.</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/mirenpl"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://twitter.com/miren_pl"><i class="fa fa-twitter fa-2x fa-fw"></i></a><a href="skype:mirenmirenmiren?call"><i class="fa fa-skype fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
