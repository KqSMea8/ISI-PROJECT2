...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/baner1.jpg" />
<link rel="shortcut icon" href="data/files/baner1.jpg" />
<link rel="apple-touch-icon" href="data/files/baner1.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Francois+One|Source+Sans+Pro&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Francois+One|Source+Sans+Pro&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Francois One","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Source Sans Pro","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556130421"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Szkola jezyka angielskiego w Gabinie" />
<meta name="keywords" content="angielski Gabin" />
<title>Blad 404: Strona nie istnieje! &raquo; WHAT&#039;S UP?</title>

</head>
<body class="" data-background="data/files/whatsuo_to.jpg" style="background: url(data/files/whatsuo_to.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481146794" /><style>.koTheme1 #website{margin-left:5%;margin-right:5%;box-shadow:0 0 50px rgba(0,0,0,0.5);background-color:#fff} .koTheme1 #headerMenu{background:linear-gradient(to bottom, rgba(0,0,0,0.5) 0%,rgba(0,0,0,0) 100%);margin:0;border:0}
.koTheme1 #headerMenu.koMenu3 .topmenu a:hover, .koTheme1 #headerMenu.koMenu3 .topmenu .active a {
color: #fff;
}
</style>
...
<a href="index.php" class="logo"><img src="data/files/baner1.jpg" style="border:0" id="WebsiteLogo" alt="WHAT&#039;S UP?" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://whatsup.szkola.pl/"><span>AKTUALNOSCI</span></a></li>
<li  ><a href="szkoa-a"><span>SZKOLA</span></a></li>
<li  ><a href="oferta"><span>OFERTA</span></a></li>
<li  ><a href="galeria"><span>GALERIA</span></a></li>
<li  ><a href="kontakt"><span>KONTAKT</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/whatsup.szkola"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/12.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditLeft " style="background:#90A4AE url(data/files/12.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 WHAT'S UP?, All Rights Reserved.</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/whatsup.szkola"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 1939</span></div>
</div>
</div>
</div>
</div>
