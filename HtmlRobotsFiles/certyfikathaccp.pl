...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Puritan|PT+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Puritan|PT+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Puritan","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"PT Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556047419"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; certyfikatHACCP.pl</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1484131153" />
...
<a href="index.php" class="logo"><h2><img src="data/files/nowelogo00.png" style="border:0" id="WebsiteLogo" alt="certyfikatHACCP.pl" /><span>certyfikatHACCP.pl</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://certyfikathaccp.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="1_5_certyfikacja.html"><span>CERTYFIKACJA</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/theme/9-1.jpg" data-align="keditLeft"  class=" koHeaderAutoHeight  keditLeft " style="background:#90A4AE url(data/files/theme/9-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>certyfikatHACCP.pl | Audyt i certyfikacja Systemu Zarzadzania Bezpieczenstwem Zywnosci | Wroclaw i cala Polska</div></div>
</div>
