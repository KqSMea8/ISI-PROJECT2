...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556121315"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Agnieszka Podgorska</title>

</head>
<body class="koThemeDark"  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481271483" /><style> .koTheme1  .logoHolder #logoReplacer h2 {     line-height: 80px;     display: inline-block;     outline: 3px solid #FFF; outline-offset:-10px;     padding-right: 30px;     padding-left: 30px; }
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Agnieszka Podgorska</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://podgorska.pl/"><span>Strona&nbsp;Glowna</span></a></li>
