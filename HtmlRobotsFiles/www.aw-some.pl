...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/aw-some.png" />
<link rel="shortcut icon" href="data/files/aw-some.png" />
<link rel="apple-touch-icon" href="data/files/aw-some.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Bevan|Josefin+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Bevan|Josefin+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Bevan","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Josefin Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556132570"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; AW-SOME</title>

</head>
<body class="koThemeDark" data-background="data/files/top.jpg" style="background: url(data/files/top.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1528106814" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>AW-SOME</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.aw-some.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_5_galeria.html"><span>Galeria</span></a></li>
<li  ><a href="1_7_cennik.html"><span>Cennik</span></a></li>
<li  ><a href="1_6_wspolpraca.html"><span>Wspolpraca</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#FAFAFA" class=" koHeaderAutoHeight " style="background:#FAFAFA">
</div>
