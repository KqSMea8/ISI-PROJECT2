...
<meta name="Keywords" content="summerparty.pl" />
<meta name="Description" content="summerparty.pl" />
<meta name="Robots" content="ALL" />
<meta name="viewport" content="width=device-width, initial-scale=0.9, maximum-scale=0.9, user-scalable=0" />
<title>summerparty.pl</title>
<!-- Domyslny -->
...
<p class="center" style="font-weight: bold">Cena sprzedazy: 1 000,00 PLN netto</p>
<p class="center"><input type="hidden" name="dodanieDomen" value="doKoszyka" />
<input type="hidden" name="domains[]" value="summerparty.pl" />
