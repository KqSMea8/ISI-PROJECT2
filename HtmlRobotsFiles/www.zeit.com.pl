...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/padblack.png" />
<link rel="shortcut icon" href="data/files/padblack.png" />
<link rel="apple-touch-icon" href="data/files/padblack.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Playfair+Display|Playfair+Display&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Playfair+Display|Playfair+Display&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556162280"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="" />
<meta name="keywords" content="klocki hamulcowe ZEIT, klocki rowerowe, okladziny, tarczowe, do tarczowek, klocki," />
<title>Blad 404: Strona nie istnieje! &raquo; Klocki hamulcowe ZEIT</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1487955822" />
...
<a href="index.php" class="logo"><img src="data/files/theme/zeit-logo-noadress-klockihamulcowe.gif" style="border:0" id="WebsiteLogo" alt="Klocki hamulcowe ZEIT" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="info"><span>Poznaj&nbsp;nas</span></a></li>
<li  ><a href="metal"><span>Klocki&nbsp;metaliczne</span></a></li>
<li  ><a href="semimetal"><span>Klocki&nbsp;polmetaliczne</span></a></li>
<li  ><a href="alu"><span>Klocki&nbsp;aluminiowe</span></a></li>
<li  ><a href="cennik"><span>Cennik</span></a></li>
<li  ><a href="kontakt"><span>Kontakt</span></a></li>
<li  ><a href="http://allegro.pl/listing/user/listing.php?us_id=9340096"><span>Nasze&nbsp;Allegro</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/klocki.ZEIT"><i class="fa fa-facebook-square"></i></a><a class="koSocialInstagramHover" target="_blank" href="http://instagram.com/klocki_zeit"><i class="fa fa-instagram"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-background="data/files/logo.png" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditDark  keditLeft " style="background: url(data/files/logo.png) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2017 Klocki hamulcowe ZEIT, All Rights Reserved.</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/klocki.ZEIT"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://instagram.com/klocki_zeit"><i class="fa fa-instagram fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
