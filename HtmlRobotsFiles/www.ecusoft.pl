...
<link rel="stylesheet" href="./css/style.css?t=1556135914">
<style type="text/css">
.version-php-app {
text-align: center;
color: #fff;
...
Your PHP version is outdated. Our template's requirements are: <strong>PHP version 5.4, 5.5, 5.6, 7.0 or 7.1.</strong><br/><br/>Please contact your hosting provider and kindly ask them to switch your PHP version up to the recommended version.    </div>
</div>
</body>
</html>
