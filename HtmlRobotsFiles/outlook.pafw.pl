...
<link rel="shortcut icon" href="/owa/auth/15.1.225/themes/resources/favicon.ico" type="image/x-icon">
...
src: url("/owa/auth/15.1.225/themes/resources/segoeui-regular.eot?#iefix") format("embedded-opentype"),
url("/owa/auth/15.1.225/themes/resources/segoeui-regular.ttf") format("truetype");
}

@font-face {
font-family: "wf_segoe-ui_semilight";
src: url("/owa/auth/15.1.225/themes/resources/segoeui-semilight.eot?#iefix") format("embedded-opentype"),
url("/owa/auth/15.1.225/themes/resources/segoeui-semilight.ttf") format("truetype");
}

@font-face {
font-family: "wf_segoe-ui_semibold";
src: url("/owa/auth/15.1.225/themes/resources/segoeui-semibold.eot?#iefix") format("embedded-opentype"),
url("/owa/auth/15.1.225/themes/resources/segoeui-semibold.ttf") format("truetype");
}
</style>
...
window.document.getElementById("username").placeholder = "nazwa uzytkownika";
window.document.getElementById("password").placeholder = "haslo";
window.document.getElementById("passwordText").placeholder = "haslo";
}
...
<td style="width:100%">Aby mozna bylo uzywac aplikacji Outlook, przegladarka musi zezwalac na uruchamianie skryptow. Informacje na ten temat znajdziesz w Pomocy przegladarki. Jesli uzywana przegladarka nie obsluguje skryptow, mozesz pobrac program <a href="http://www.microsoft.com/windows/ie/downloads/default.mspx">Windows Internet Explorer</a>, ktory umozliwia dostep do aplikacji Outlook.</td>
</tr>
</table>
</div>
</noscript>
...
<input type="hidden" name="destination" value="https://outlook.pafw.pl/owa/robots.txt">
...
<div class="signInInputLabel" id="userNameLabel" aria-hidden="true">Nazwa uzytkownika:</div>
<div><input id="username" name="username" class="signInInputText" role="textbox" aria-labelledby="userNameLabel"/></div>
<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Haslo:</div>
...
alt=""><span class="signinTxt">zaloguj sie</span>
</div>
...
<div class="signInExpl">Wlacz pliki cookie dla tej witryny internetowej. <br><br>W uzywanej przegladarce pliki cookie sa obecnie wylaczone. Aplikacja Outlook wymaga wlaczenia obslugi plikow cookie. <br><br>Aby dowiedziec sie, jak wlaczyc obsluge plikow cookie, otworz Pomoc przegladarki internetowej.<br><br><br></div>
<div class="signInEnter" >
...
alt=""><span class="signinTxt" tabIndex="0">ponow probe</span>
</div>
</div>
</div>
</div>
