...
<html>
<head>
<title>STS-TIMING.PL - REJESTRACJA IX Polmaraton Dabrowski - Dabrowa Gornicza - 2016-04-10</title>
...
<tr valign="middle">
<td colspan="3">
<div class="center"><p class="head">STS-TIMING.PL - Rejestracja<br>IX Polmaraton Dabrowski<br>Dabrowa Gornicza - 2016-04-10</p></div>
<div class="center"><p class="head"> <a href="lista.php">Lista startowa - IX Polmaraton Dabrowski</a></p></div>
