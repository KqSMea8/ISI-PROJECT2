...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo-kom-kasceneo.jpg" />
<link rel="shortcut icon" href="data/files/logo-kom-kasceneo.jpg" />
<link rel="apple-touch-icon" href="data/files/logo-kom-kasceneo.jpg" /><script>var tinyMcePath="/";</script><script src="/inc/js/tinymce/embed.js" type="text/javascript"></script>
...
<meta name="keywords" content="serwis naprawa komputer kasa fiskalna program drukarka monitor monitoring toner atrament kamera fiskalizacja Novitus Elzab oprgramowanie eksploatacja router siec komputerowa Internet polaczenie" />
<title>Blad 404: Strona nie istnieje! &raquo; KOM-KAS</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1529616565" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {color:#fff}#headerMenu.koMenu3 .topmenu a:hover {color:rgba(255,255,255,0.7);} </style>
...
<a href="index.php" class="logo"><img src="data/files/logonew.png" style="border:0" id="WebsiteLogo" alt="KOM-KAS ZBIGNIEW GORNIK" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.kom-kas.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderContent" data-bgcolor="#90A4AE" data-background="data/files/theme/8-1.jpg" class=" keditDark " style="background:#90A4AE url(data/files/theme/8-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit keditRow" id="kpg_510">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_151" ><div class="keditable keditable-auto">Copyright (c)2018 KOM-KAS ZBIGNIEW GORNIK, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_612" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Mediaperfekt"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 12576</span></div></div>
</div>
</div>
</div>
