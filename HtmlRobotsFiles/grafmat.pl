...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logogotowe.jpg" />
<link rel="shortcut icon" href="data/files/logogotowe.jpg" />
<link rel="apple-touch-icon" href="data/files/logogotowe.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556073600"></script>
...
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1482132859" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><img src="data/files/logogotowe.jpg" style="border:0" id="WebsiteLogo" alt="" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://grafmat.pl/"><span>Start</span></a></li>
<li  ><a href="o-nas"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="oferta"><span>Oferta</span></a></li>
<li  ><a href="mieszalnia-farb-offseowych"><span>Mieszalnia&nbsp;farb&nbsp;offsetowych</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/444_1482140542.jpg" class=" keditDark  koHeaderAutoHeight " style="background:#90A4AE url(data/files/444_1482140542.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#E0F7FA" class=" koHeaderAutoHeight  koHeaderHide " style="background:#E0F7FA">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2016 Grafmat, All Rights Reserved.</div></div>
</div>
