...
<meta name="Keywords" content="goto.pl" />
<meta name="Description" content="goto.pl" />
...
<p class="center" style="font-weight: bold">Cena sprzedazy: 10 000,00 PLN netto</p>
<p class="center"><input type="hidden" name="dodanieDomen" value="doKoszyka" />
<input type="hidden" name="domains[]" value="goto.pl" />
