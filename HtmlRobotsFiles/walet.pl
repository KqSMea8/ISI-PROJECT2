...
<p class="center" style="font-weight: bold">Cena sprzedazy: 12 000,00 PLN netto</p>
<p class="center"><input type="hidden" name="dodanieDomen" value="doKoszyka" />
<input type="hidden" name="domains[]" value="walet.pl" />
