...
<!-- bootstrap -->
<link rel="stylesheet" href="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/bootstrap.min.css" /><!-- bootstrap -->
<!-- template style -->
<link rel="stylesheet" href="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/style.css" />
<!-- template color -->
<link rel="stylesheet" href="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/color.css" />
<!-- custom style -->
<link rel="stylesheet" href="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/css/custom.css" />
<link rel="icon" href="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/img/wp.png">
...
<!-- preloader -->
<div id="preloader">
<img id="preloader-img" src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/img/preloader.gif" alt="preloader">
</div>
<!-- /preloader -->
...
<div class="row">
<div class="col-md-12">
<img src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/img/wp.png" alt="logo" class="logo">
...
<li><a href="#" data-link-to="#about">About Us</a></li>
...
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent id dolor dui, dapibus gravida elit. Donec conseenigmat laore gittis. Suspendisse ultricies ultrices viverra. Morbi rhoncus laoreet tincidunt. Mauris interdum convallis metus. Suspendiss lacus est.</p>
</div>
...
<a href="#" class="btn btn-theme btn-lg shadow" data-link-to="#about">About Us</a> <!-- link button -->
...
<span class="letter">A</span><span class="color">About Us</span> <!-- letter and title-->
</h2>
</div>
<div class="section-content sec-desc">
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent id dolor dui, dapibus gravida elit. Donec conseenigmat laore gittis. Suspendisse ultricies ultrices viverra. Morbi rhoncus laoreet tincidunt. Mauris interdum convallis metus. Suspendiss lacus est.</p>
...
<div class="section-footer">
<a href="#" class="btn btn-theme btn-lg shadow" data-link-to="#contact">Contact</a>
</div>
</div>
</div>
</div>
...
<li>
<a href="#" title="google plus" target="_blank"> <!-- social link, title -->
<i class="icons fa fa-google-plus"></i> <!-- social icon -->
</a>
</li>
<li>
...
<div class="section-footer">
<a href="#" class="btn btn-theme btn-lg shadow" data-link-to="#intro">Home</a>
</div>
</div>
</div>
</div>
...
<!-- script start -->
<script src='http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery-1.11.3.min.js'></script>
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/bootstrap.min.js"></script>
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/plugin.js"></script>
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/magnific.popup.js"></script>
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/backstretch.js"></script>
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/vendor/jquery.countdown.js"></script>
<!--[if lt IE 10]>
<script src='assets/js/vendor/ie/jquery.placeholder.min.js'></script>
<![endif]-->
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/variable.js"></script>
<script>
...
function fn_single() {
$bg.backstretch('http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg'); // set single background image
}
...
slideShowImageSet.push('http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
slideShowImageSet.push('http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/img/bg.jpg');
...
if($.find('#countdown')[0]) {
$('#countdown').countdown('2017/11/22 10:50').on('update.countdown', function(event) {
...
<script src="http://pwprofit.pl/wp-content/plugins/responsive-coming-soon/templates/template1/assets/js/custom.js"></script>
