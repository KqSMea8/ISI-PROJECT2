...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Arvo|Catamaran&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Arvo|Catamaran&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Arvo","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Catamaran","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556026955"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Almarin</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1524745393" />
...
<a href="index.php" class="logo"><img src="data/files/logo_1524745729.png" style="border:0" id="WebsiteLogo" alt="Almarin" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://almarin.pl/"><span>Home</span></a></li>
...
<div id="subpageHeaderContent" data-background="data/files/satel.jpg" data-parallax="1"  class=" parallax-window  keditDark  koZeroPadding  kfilter1 " style="background: url(data/files/satel.jpg) no-repeat 50% 0px;background-size:cover">
</div>
