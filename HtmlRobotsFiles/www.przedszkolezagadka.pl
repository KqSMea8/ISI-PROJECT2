...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/chmura-z-logiem-e1465557393214.png" />
<link rel="shortcut icon" href="data/files/chmura-z-logiem-e1465557393214.png" />
<link rel="apple-touch-icon" href="data/files/chmura-z-logiem-e1465557393214.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556153720"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; PrzedszkoleZagadka.pl</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1530814408" /><style>#headerMenu.koMenu5 .topmenu .active a,#headerMenu.koMenu5 .topmenu a:hover {background:rgba(255,255,255,0.1)}#headerMenu.koMenu5 .topmenu a {margin:0 20px;border:1px solid rgba(255,255,255,0.3);border-radius:3px;padding:5px 15px;font-size:130%} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>PrzedszkoleZagadka.pl</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.przedszkolezagadka.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_o-nas.html"><span>O&nbsp;nas</span></a></li>
<li  ><a href="1_5_informacje.html"><span>Informacje</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/kindergarten-2204239_1920.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  koHeaderAutoHeight  keditLeft " style="background:#90A4AE url(data/files/kindergarten-2204239_1920.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2018 PrzedszkoleZagadka.pl, All Rights Reserved.</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/przedszkolezagadka"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
