...
function MenuPiosenek()
{
$wynik = mysql_query("SELECT id, tytul FROM piosenki");
$num_rows = mysql_num_rows($wynik);
echo "\n<BR><STRONG>$num_rows piosenek</STRONG><BR><BR>\n";
while ($wiersz = mysql_fetch_array($wynik)) {
echo '&lt;STRONG&gt;&lt;A href="piosenki.php?piosenka=';
echo $wiersz['id'];
echo '"&gt;';
echo $wiersz['tytul'];
echo "&lt;/A&gt;&lt;/STRONG&gt;&lt;BR&gt;\n";
...
function WybierzPiosenke($Apiosenka)
{
$wynik  = mysql_query("SELECT * FROM piosenki WHERE id=$Apiosenka ");
...
<TABLE>
<TR>
<TD id="naglowek" colspan="2">
<H1><A href="piosenki.php">Piosenki religijne</A></H1>
</TD>
</TR>
<TR valign="top">
<TD id="menu"><br />
<b>Fatal error</b>:  Call to undefined function MenuPiosenek() in <b>/profiles/k/ko/kod/kodlibertydirect/kodlibertydirect.cba.pl/index.php</b> on line <b>69</b><br />
<!-- cba <!--]--><div style="text-align:center;font-size:11px" class="cbalink"><a href="https://www.cba.pl/" title="darmowy hosting">Darmowy Hosting</a> CBA.PL<br/><br/></div>
