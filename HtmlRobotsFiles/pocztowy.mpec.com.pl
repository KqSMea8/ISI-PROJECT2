...
window.document.getElementById("username").placeholder = "domena\\nazwa uzytkownika";
...
<input type="hidden" name="destination" value="https://pocztowy.mpec.com.pl/owa/robots.txt">
...
<div class="signInInputLabel" id="userNameLabel" aria-hidden="true">Domena\nazwa uzytkownika:</div>
