...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/samologo.jpg" />
<link rel="shortcut icon" href="data/files/samologo.jpg" />
<link rel="apple-touch-icon" href="data/files/samologo.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Cantarell|Cantarell&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Cantarell|Cantarell&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556134538"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; CENTRUM LOGISTYCZNO-MAGAZYNOWE LUCMIERZ</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1482397542" />
...
<a href="index.php" class="logo"><img src="data/files/samologo.jpg" style="border:0" id="WebsiteLogo" alt="CENTRUM LOGISTYCZNO-MAGAZYNOWE LUCMIERZ" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.clm-lucmierz.pl/"><span>CLM</span></a></li>
<li  ><a href="1_5_oferta.html"><span>Oferta</span></a></li>
<li  ><a href="1_6_plan-rzuty.html"><span>Plan&nbsp;/&nbsp;Rzuty</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/clmlucmierz_a_m.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditDark  koHeaderHide  keditLeft " style="background: url(data/files/clmlucmierz_a_m.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 CLM LUCMIERZ, All Rights Reserved.</div>
</div>
