...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556133215"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Bistro Chata</title>
...
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Trocchi","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(data/files/to2.jpg);}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_above.css?1448463068" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>.container_top,.container_header,.container_splash2{background:none;}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/logo.png" style="border:0" id="WebsiteLogo" alt="Bistro Chata" /></a>
...
<li ><a href="http://www.bistrochata.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="catering"><span>Catering</span></a></li>
<li ><a href="menu" rel="dropmenu_1_3"><span>Menu</span></a></li>
...
<h2><strong><span style="color: #b85c29;"><span class="CurrentPageName">Blad 404: Strona nie istnieje!</span></span></strong></h2>
</div>
</div></div></div></div>
...
<p id="footer-info"><span style="font-size: medium;">Designed by <a title="Firma informatyczna, Obsluga firm, Odzyskiwanie danych, Programy, Oprogramowanie, Strony WWW, Pozycjonowanie, Domeny, Hosting, Server, Web design, Web development, Software" href="http://www.kamlegit.pl">kamlegIT</a> | (c) 2015 Bistro Chata. Wszystkie Prawa Zastrzezone.</span></p>
</div>
</center>        </div>
</div>
</div>
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$(".container_top").backstretch("data/files/tlo.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
