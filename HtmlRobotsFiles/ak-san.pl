...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556022217"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; ak-san Piotr Krogulec</title>

</head>
<body class="koThemeDark"  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1486922932" /><style> .koTheme1  .logoHolder #logoReplacer h2 {     line-height: 80px;     display: inline-block;     outline: 3px solid #FFF; outline-offset:-10px;     padding-right: 30px;     padding-left: 30px; }
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>ak-san Piotr Krogulec</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://ak-san.pl/"><span>O&nbsp;Nas</span></a></li>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2017 ak-san Piotr Krogulec, All Rights Reserved.</div>
</div>
