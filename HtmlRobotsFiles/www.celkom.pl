...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo-ikona.jpg" />
<link rel="shortcut icon" href="data/files/logo-ikona.jpg" />
<link rel="apple-touch-icon" href="data/files/logo-ikona.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Oswald|Francois+One&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Oswald|Francois+One&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Oswald","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Francois One","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556134233"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Biuro Rachunkowe CELKOM z Kalisza - rok zalozenia 1991, doradztwo podatkowe, obsluga ksiegowa, pelna ksiegowosc - ksiegi rachunkowe, ksiegi przychodow i rozchodow KPiR, VAT, kadry i place, rozliczenia pracownikow i ZUS, INTRASTAT, PFRON" />
<meta name="keywords" content="biura rachunkowe, biuro rachunkowe, biuro podatkowe, biuro ksiegowe, doradca podatkowy, doradztwo podatkowe, uslugi ksiegowe, uslugi rachunkowe, doradcy podatkowi, doradztwo podatkowe, ksiegowi, ksiegowosc, ksiegowy, ksiegowy, podatki kalisz, kadry kalisz, rozliczenia podatkowe, rozliczenia PIT, PIT Kalisz, prowadzenie ksiegi, KPIR, zwrot vat, ksiegi rachunkowe, rachunkowosc, pelna ksiegowosc kalisz, rozliczenia vat," />
<title>Blad 404: Strona nie istnieje! &raquo; Biuro Rachunkowe CELKOM z Kalisza | Doradca podatkowy Kalisz nr wpisu 08666 | Biuro podatkowe i uslugi ksiegowe</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1475152258" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {} </style>
...
<a href="index.php" class="logo"><img src="data/files/logo.jpg" style="border:0" id="WebsiteLogo" alt="Biuro Rachunkowe CELKOM" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.celkom.pl/"><span>HOME</span></a></li>
<li  ><a href="o-nas"><span>O&nbsp;NAS</span></a></li>
<li  ><a href="doradztwo-podatkowe"><span>DORADZTWO&nbsp;PODATKOWE</span></a></li>
<li  ><a href="oferta-dla-firm"><span>OFERTA&nbsp;DLA&nbsp;FIRM</span></a></li>
<li  ><a href="pity-roczne"><span>PITY&nbsp;ROCZNE</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#4E342E" data-background="data/files/accountant-1238598_1280.jpg" data-parallax="1"  class=" parallax-window  keditDark  koHeaderAutoHeight " style="background:#4E342E url(data/files/accountant-1238598_1280.jpg) no-repeat 50% 0px;background-size:cover">
</div>

</div>

<!-- Content -->
<div class="WxEditableArea" id="contentArea">Blad 404: Strona nie istnieje!</div>

<!-- Footer -->
<div id="footerContent" data-bgcolor="#3E2723" class=" keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#3E2723">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>&nbsp;Copyright &copy;2017 &nbsp; Biuro Rachunkowe CELKOM Cecylia Urbanska &nbsp;&nbsp; <a href="mailto:biuro@celkom.pl">biuro@celkom.pl </a>&nbsp;&nbsp; Tel. 62 764-08-10</div>
<div>Wszelkie Prawa Zastrzezone</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Biuro-Rachunkowe-Celkom-1265046106847304"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://plus.google.com/local/writereview?placeid=ChIJ83xa8ezFGkcRUTiHgF_947g"><i class="fa fa-google-plus-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
