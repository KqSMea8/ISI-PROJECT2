...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556057849"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Electro Connect - Electro Connect</title>
...
<link href="http://fonts.googleapis.com/css?family=Electrolize|Ubuntu&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Electrolize","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Ubuntu","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
<a href="index.php" class="logo"><img src="data/files/logo.png" style="border:0" id="WebsiteLogo" alt="Electro Connect" /></a>
...
<li ><a href="http://electroconnect.pl/"><span>Nasza&nbsp;Firma</span></a></li>
<li ><a href="index.php?p=1_6_oferta"><span>Oferta</span></a></li>
<li ><a href="index.php?p=1_3_realizacje"><span>Realizacje</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Electro Connect,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
