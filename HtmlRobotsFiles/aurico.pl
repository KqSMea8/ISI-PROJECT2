...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556040457"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Aurico strona w budowie</title>

</head>
<body class="" data-bgcolor="#546E7A" style="background:#546E7A" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1527535678" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Aurico strona w budowie</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#dbe5f1" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  koHeaderAutoHeight  keditLeft " style="background:#dbe5f1">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#d8d8d8" class=" koHeaderAutoHeight  koHeaderHide " style="background:#d8d8d8">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2018 Aurico, All Rights Reserved.</div></div>
</div>
