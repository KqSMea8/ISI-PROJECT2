...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556041710"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Bialystok. Korekta i redakcja tekstow, poprawianie ksiazek, artykulow, prac licencjackich, magisterskich, doktoratow, stron www, ulotek, raportow i wielu innych." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; be correct.pl</title>
...
<link href="http://fonts.googleapis.com/css?family=Quintessential|Noto+Sans&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Quintessential","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Noto Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_book.css?1442934387" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>.container_content{background:none;}#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style><script src="inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>be correct</h2><h4>korekta, redakcja tekstow</h4></div><!--Logo--></a>
...
<li ><a href="http://becorrect.pl/"><span>Home</span></a></li>
<li ><a href="1_2_oferta.html"><span>Oferta</span></a></li>
<li ><a href="1_3_wspolpraca.html"><span>Wspolpraca</span></a></li>
<li ><a href="1_5_portfolio.html"><span>Portfolio</span></a></li>
...
<div class="margins">&nbsp;23-04-2019</div>
</div>
<div class="span8 footerMenu">
<div class="margins"><span id="footerHitCounter">Liczba odwiedzin: 18069</span></div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-68008622-1']);
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$("body").backstretch("data/templates/book/images/un11.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
