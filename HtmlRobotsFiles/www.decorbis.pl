...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/theme/14-4.jpg" />
<link rel="shortcut icon" href="data/files/theme/14-4.jpg" />
<link rel="apple-touch-icon" href="data/files/theme/14-4.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556135058"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Domain for sale</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.decorbis.pl/"><span>Strona&nbsp;Glowna</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/theme/sky.jpg" data-align="keditLeft"  class=" keditDark  koHeaderAutoHeight  koHeaderHide  keditLeft  kfilter23 " style="background:#90A4AE url(data/files/theme/sky.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>(c)2018, All Rights Reserved</div></div>
</div>
