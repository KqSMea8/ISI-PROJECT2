<br />
<b>Notice</b>:  Undefined index: HTTP_ACCEPT_LANGUAGE in <b>/strony_www/orlandi-2019/WebRoot/index.php</b> on line <b>149</b><br />
<br />
<b>Notice</b>:  Undefined variable: newQuery in <b>/strony_www/orlandi-2019/Engine/Routing/Router.php</b> on line <b>417</b><br />
...
<span class="value">/strony_www/orlandi-2019/Engine/Core.php</span>
</div>
...
<span class="value">https://orlandi.pl:443/robots.txt</span>
</div>
...
#1 /strony_www/orlandi-2019/Engine/Core.php:807                    </div>
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#3 /strony_www/orlandi-2019/Engine/Routing/Router.php:417                    </div>
<div class="trace-details">
<div class="function-doc"></div>
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#5 /strony_www/orlandi-2019/Engine/Network/Request.php:334                    </div>
<div class="trace-details">
<div class="function-doc"></div>
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#6 /strony_www/orlandi-2019/Engine/Network/Request.php:94                    </div>
<div class="trace-details">
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#7 /strony_www/orlandi-2019/Engine/Core.php:813                    </div>
<div class="trace-details">
<div class="function-doc"></div>
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#9 /strony_www/orlandi-2019/Engine/Core.php:335                    </div>
<div class="trace-details">
<div class="function-doc"></div>
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#10 /strony_www/orlandi-2019/Application/Bootstrap.php:56                    </div>
<div class="trace-details">
...
[configuration] => array(...)
[mode] => 2
[cache_dir] => '/strony_www/orlandi-2019/Application/Cache'
)</span>)</div>
<div class="code">   51:     // Let's go!
52:     if ($core === null) {
53:         $core = new \Engine\Core();
54:     }
55:
<b>   56:     $core-&gt;bootstrap($configuration);
</b>   57:
58:     return $core;
59: }
</div>
...
<div class="level">
<div class="file" onclick="$(this).parent().find('.trace-details').slideToggle(100)">
#11 /strony_www/orlandi-2019/WebRoot/index.php:200                    </div>
<div class="trace-details">
<div class="function-doc"></div>
<div class="function">Called: initializeFrameworkCore(<span class="arg">2</span>)</div>
<div class="code">  195:
196: error_reporting(E_ALL);
197: require_once __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Application' . DIRECTORY_SEPARATOR . 'Bootstrap.php';
198:
199: // $core = initializeFrameworkCore(\Engine\Core::PRODUCTION_MODE);
<b>  200: $core = initializeFrameworkCore(\Engine\Core::DEVELOPMENT_MODE);
</b>  201:
202: $core-&gt;runController();
</div>
</div>
</div>
</div>
