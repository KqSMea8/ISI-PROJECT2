...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/animated_favicon1.gif" />
<link rel="shortcut icon" href="data/files/animated_favicon1.gif" />
<link rel="apple-touch-icon" href="data/files/animated_favicon1.gif" /><script>var tinyMcePath="/";</script><script src="/inc/js/tinymce/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Josefin+Sans|Josefin+Sans&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Josefin+Sans|Josefin+Sans&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<meta name="description" content="Fotografia studyjna, okolicznosciowa, plenerowa, produktowa,
Sesje narzeczenskie, ciazowe, noworodkowe.
Sluby, chrzty, komunie, urodziny i inne imprezy okolicznosciowe." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; FotoMoniki.pl Monika Ogloszka - Fotograf, fotografia.</title>
<script src="/inc/domeny.js" type="text/javascript"></script>
</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1500461089" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {} </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/logofotomonikikolor.png" style="border:0" id="WebsiteLogo" alt="Monika Ogloszka" /><span>Monika Ogloszka</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://www.fotomoniki.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="o-nas"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="galeria"><span>Galeria</span></a></li>
<li  ><a href="kontakt"><span>Kontakt&nbsp;/&nbsp;Dojazd</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/fotomoniki"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderContent" data-bgcolor="#90A4AE" class="koZeroPadding keditDark"  data-old-class="   koHeaderAutoHeight   " style="background:#90A4AE">
</div>
...
<div data-pcid="1252" id="kpg_532856" class="kedit keditRow koZeroPadding">
...
<div class="kedit" id="kpg_756434" ><div class="keditable keditable-auto"><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/fotomoniki"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div></div></div><div class="kedit" id="kpg_158032" ><div class="keditable"><br><br>(c)2017, Wszelkie Prawa Zastrzezone</div></div>
</div>
<div class="col-sm-3 keditColumn">

<div class="kedit" id="kpg_692889" ><div class="keditable keditable-auto"><img src="data/files/logofotomonikikolor.png"></div></div></div>
</div>
</div>
