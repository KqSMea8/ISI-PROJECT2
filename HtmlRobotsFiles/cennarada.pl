...
<meta  property="og:title" content="cennarada.pl - sklep z domenami internetowymi."  /><meta  property="og:description" content="1 domena na sprzedaz - polecam!"  /><meta  property="og:image" content="https://epremium.pl/view-shop1555306371/img/logo.png"  /> </head>
...
<div class="top-bar">
<div class="f-left">
<a href="http://cennarada.pl/" class="logo"><img src="https://epremium.pl/view-shop1555306371/style/shop/logo.png" alt="sklep premium.pl" /></a>
</div>
<div class="f-right">
...
<img src="https://premium.pl/token.png?_t=1556047164" id="token" alt="" class="mid" />
...
<a href="http://cennarada.pl/kategorie">
...
<div class="listcmp-container" id="listlist_6097421635cbf653c14694">
...
<div id="filters-top"
class="list-list_6097421635cbf653c14694 filters-top-list filters-top-simple"
style="display: none">
...
<form class="disable-prevent"  action="http://cennarada.pl/"
method="get"
...
<form action="http://cennarada.pl/" method="get">
<div>
...
<a href="http://cennarada.pl/?order=name&amp;desc=0&amp;page=0#oferty"
class="link-order"
>Domena</a>
...
<a href="http://cennarada.pl/?order=value_bn&amp;desc=0&amp;page=0#oferty"
class="link-order"
>Kup Teraz</a>
...
id="list_6097421635cbf653c14694_row_0_0">
...
<!--
var list_6097421635cbf653c14694_o = $('#listlist_6097421635cbf653c14694');

$(document).ready(function () {
list_6097421635cbf653c14694_o.find('.bottomtab a').click(function (e) {
var was_hidden = list_6097421635cbf653c14694_o.find('.' + $(this).children('span').attr('class').replace('tabname', 'tab')).is(':hidden');

list_6097421635cbf653c14694_o.find('.tab').hide();

if (was_hidden) {
list_6097421635cbf653c14694_o.find('.' + $(this).children('span').attr('class').replace('tabname', 'tab')).show();
}

if (list_6097421635cbf653c14694_o.find('.tab-filters:not(:hidden), .tab-report:not(:hidden), .tab-legend:not(:hidden)').length > 0) {
$('.bottomtab-container').addClass('sep-b');
} else {
list_6097421635cbf653c14694_o.find('.bottomtab-container').removeClass('sep-b');
}
