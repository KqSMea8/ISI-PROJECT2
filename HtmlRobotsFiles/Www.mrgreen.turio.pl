...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="../../../files/inc/js/menu.js?1556205485"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; MRGREEN - AGRO OGROD FUNGILITIC</title>
...
<link href="http://fonts.googleapis.com/css?family=Archivo+Black|Basic&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Archivo Black","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Basic","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1456783898" /><link type="text/css" rel="stylesheet" href="../../../files/style_extra.css?2.0.2" /><style>.container_top,.container_header,.container_splash2,.container_content{background:none;}</style><script src="../../../files/inc/js/jquery.backstretch.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/mrgreen_kolor_72dpi_poziom.jpg" style="border:0" id="WebsiteLogo" alt="MRGREEN" /></a>
...
<li ><a href="http://mrgreen.turio.pl/"><span>STRONA&nbsp;GLOWNA</span></a></li>
<li ><a href="index.php?p=1_2_oferta"><span>OFERTA</span></a></li>
<li ><a href="index.php?p=1_3_badania-dokumenty"><span>BADANIA&nbsp;DOKUMENTY</span></a></li>
<li ><a href="index.php?p=1_5_kontakt"><span>KONTAKT</span></a></li>
<li ><a href="index.php?p=1_6_promocje"><span>PROMOCJE</span></a></li>
<li ><a href="index.php?p=1_7_gdzie-kupi"><span>GDZIE&nbsp;KUPIC</span></a></li>
...
<h2><span class="CurrentPageName">Blad 404: Strona nie istnieje!<br /></span></h2>
<p>&nbsp;</p>
</div>
</div></div></div></div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-58078671-1']);
...
</div><script>/*splash-bg*/var k_Backstretch=0;function kBackstretch(){if(k_Backstretch>0)$(".backstretch").remove();$("body").backstretch("data/files/zborza2.jpg");k_Backstretch++;}kBackstretch();</script></body>
</html>
