...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556023944"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="EKOmetal skupuje zuzyte akumulatory olowiowe. Jesli posiadasz stare akumulatory sprzedaj je w naszej firmie. Prowadzimy skup w Zielonej Gorze i Legnicy." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; EKOmetal - skup akumulatorow Zielona Gora, Legnica</title>
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1421962070" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0" /><style>#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>SKUP AKUMULATOROW</h2><h4>Chron srodowisko naturalne</h4></div><!--Logo--></a>
...
<li ><a href="http://akumulatoryskup.pl/"><span>Home</span></a></li>
<li ><a href="index.php?p=1_2_o-nas"><span>O&nbsp;Nas</span></a></li>
<li ><a href="index.php?p=1_3_skup-akumulatorow"><span>Skup&nbsp;akumulatorow</span></a></li>
...
<li><a href="index.php?p=1_3_skup-akumulatorow"><span>Skup&nbsp;akumulatorow</span></a></li>
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
</ul>&nbsp;<br />&nbsp;EKOmetal - skup zuzytych akumulatorow kwasowo-olowiowych, tel: 602 258 944</div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?-->&nbsp;EKOmetal,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
