...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/theme/favicon.jpg" />
<link rel="shortcut icon" href="data/files/theme/favicon.jpg" />
<link rel="apple-touch-icon" href="data/files/theme/favicon.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Rubik|Josefin+Sans&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Rubik|Josefin+Sans&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Rubik","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Josefin Sans","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556046539"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Uslugi wideo rejestracji - filmy weselne, fotografia reportazowa. Filmy szkoleniowe, promocyjne. Archiwizacja nagran VHS, Video8, VHS-C." />
<meta name="keywords" content="wideo, wesele, wideofilmowanie, foto, fotografia, slub, film, vhs, video8" />
<title>Blad 404: Strona nie istnieje! &raquo; Film, Fotografia, Archiwizacja VHS</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1479943566" /><style> #headerMenu.koMenu4{background:#eee;border-top:0;border-bottom-width:10px;border-bottom-style:solid;margin-top:-50px;}    #headerMenu.koMenu4 li.active{background:#fff;}      .menuHolder li,#headerMenu .menuHolder, .logoLeft #headerMenu .menuHolder {     padding-top: 0px; padding-bottom: 0px;   }      #headerBanner,#subpageHeaderBanner{margin-top:150px}   .koTheme6 #subpageHeaderBanner,  .koTheme6 #headerBanner.koHeaderHide {     margin-bottom: 0; }   .logoCentered .menuHolder,.logoCentered .logoHolder,.logoCentered .logoReplacer {}      .logoHolder{position:absolute;top:-100px;left:0;right:0;}    .logoCentered .logoHolder{top:-110px}    .logoRight .logoHolder{text-align:right}   .logoCentered .logoHolder,.logoCentered .logoReplacer {margin:0 auto;width:100%;}   .koTheme6 #headerBanner.koHeaderAutoHeight .kedit,  .koTheme6 #headerBanner.koHeaderAutoHeight .k_Edit   {     margin-top: 0; }     </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/logocanox2016mini.jpg" style="border:0" id="WebsiteLogo" alt="Studio Video CANOX" /><span>Studio Video CANOX</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://canox.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_6_referencje.html"><span>Referencje</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/StudioCanox"><i class="fa fa-facebook-square"></i></a><a class="koSocialGoogleHover" target="_blank" href="http://plus.google.com/u/0/116940892093680368142"><i class="fa fa-google-plus-square"></i></a><a class="koSocialYouTubeHover" target="_blank" href="http://www.youtube.com/channel/UCxT_Q8UWNAFSwK1YRQYx1og"><i class="fa fa-youtube"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/theme/09b.jpg" data-align="keditLeft"  class=" keditDark  koHeaderAutoHeight  keditLeft  kfilter1 " style="background:#90A4AE url(data/files/theme/09b.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2016 Studio Video CANOX, All Rights Reserved.</div></div>
</div>
