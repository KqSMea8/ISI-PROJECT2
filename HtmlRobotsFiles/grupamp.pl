...
<title>grupamp.pl is parked</title>
<style>
...
<script>
var h = {
'en':'grupamp.pl is parked',
'no':'grupamp.pl er parkert',
'sv':'grupamp.pl ar parkerad'
};
...
var m = {
'en': 'grupamp.pl is registered, but the owner currently does not have an active website here. <br>Other services, such as e-mail, may be actively used by the owner.<br><br><a href="https://www.domainnameshop.com/whois">Who owns the domain?</a>',
'no': 'grupamp.pl er registrert, men har ingen aktiv nettside enna. <br>Andre tjenester, som f.eks. epost, kan vaere aktivt brukt av eieren.<br><br><a href="https://www.domeneshop.no/whois">Hvem eier domenet?</a>',
'sv': 'grupamp.pl ar registrerad, men har inte har nagon aktiv websida annu. <br>Andra tjanster, t.ex. epost, kan anvands aktivt av agaren.<br><br><a href="https://www.domainnameshop.com/whois?currency=SEK&lang=sv">Vem ager domanen?</a>',
};
...
<div class="container">
<h1 id="t">grupamp.pl is parked</h1>
<p  id="m">grupamp.pl is registered, but the owner currently does not have an active website here. <br>Other services, such as e-mail, may be actively used by the owner.<br><br><a href="https://www.domainnameshop.com/whois">Who owns the domain?</a></p>
