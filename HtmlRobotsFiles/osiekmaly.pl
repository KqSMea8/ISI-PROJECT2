...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556119892"></script>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Nazwa Firmy</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://osiekmaly.pl/"><span>O&nbsp;Nas</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#774829" data-background="data/files/theme/21-1.jpg" class=" keditDark " style="background:#774829 url(data/files/theme/21-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2018 Nazwa Firmy, All Rights Reserved.</div>
</div>
