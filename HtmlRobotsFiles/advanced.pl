...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556019373"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Advanced Business Services sp. z o.o.</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1513210412" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {color:#fff}#headerMenu.koMenu3 .topmenu a:hover {color:rgba(255,255,255,0.7);} </style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>Advanced Business Services sp. z o.o.</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://advanced.pl/"><span>O&nbsp;Nas</span></a></li>
</ul>
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">(c)2015, All Rights Reserved</div>
</div>
