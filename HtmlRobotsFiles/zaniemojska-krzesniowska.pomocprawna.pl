...
<title>Kancelaria Adwokacka Szczecin</title>
<meta name="description" content="PRAWO CYWILNE,PRAWO GOSPODARCZE,PRAWO KARNE,PRAWO RODZINNE I OPIEKUNCZE,PRAWO SPADKOWE,"/>
<meta name="keywords" content="PRAWO AUTORSKIE,PRAWO KOMPUTEROWE,PRAWO MIEDZYNARODOWE PRYWATNE,podatki lokalne,znaki towarowe (firmowe),prawa czlowieka,referendum,jakosc wyrobow i uslug,ruch i przewoz lotniczy,dodatki mieszkaniowe,wlasnosc lokali,rynki papierow wartosciowych,dochodowy - osoby fizyczne,podatek rolny i lesny,podatki posrednie (vat i akcyza),narodowe fundusze inwestycyjne,przedsiebiorstwa panstwowe,stowarzyszenia,towarzystwa ubezpieczen wzajemnych,choroby zawodowe,roszczenia w razie niewyplacalnosci pracodawcy,samorzad pracowniczy,strajki,urlopy,wypadki przy pracy,zwolnienia grupowe,prywatyzacja,listy przewozowe,rolnicze spoldzielnie produkcyjne,choroby zawodowe,Kasa Rolniczego Ubezpieczenia Spolecznego,powszechne ubezpieczenie zdrowotne,system ubezpieczen spolecznych,zasilki,Traktat o UE"/>
<meta name="author" content="web-world.pl" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta name="Robots" content="all" />
<meta name="geo.placename" content="Szczecin">
<meta name="geo.region" content="Polska zachodniopomorskie 70-780">
...
<div class="fl">
<p class="name">Kancelaria Adwokacka</p>
<ul itemscope itemtype="http://schema.org/LocalBusiness">
<li>
<address itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
<p><span itemprop="streetAddress">ul. Tryglawa 5-7</span>  <span itemprop="addressLocality"></span></p>
<p><span itemprop="postalCode">70-780</span> <span itemprop="addressRegion">Szczecin</span></p>
<p class="district">zachodniopomorskie</p>
</address>
</li>
<li>
T: <span itemprop="email"><a href="tel:(0 91) 461 43 05">(0 91) 461 43 05</a></span><br/>
T: <span itemprop="email"><a href="tel:0 506 419 143">0 506 419 143</a></span><br/>                            F: <span>(0 91) 461 48 34</span>                            <p itemprop="email">E-mail: <a href="mailto:elzbieta.zaniemojska@op.pl">elzbieta.zaniemojska@op.pl</a></p>                        </li>
</ul>
...
<li>PRAWO KARNE</li>
<li>PRAWO RODZINNE I OPIEKUNCZE</li>
...
<input type="hidden" name="account_id" value="384"/>
<h2>Kontakt</h2>
<div class="fl">
