...
<link rel="bookmark" href="data/files/logogifgjh.png" />
<link rel="shortcut icon" href="data/files/logogifgjh.png" />
<link rel="apple-touch-icon" href="data/files/logogifgjh.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556055942"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Srebro Pasja Sztuka. Autorska recznie robiona bizuteria. Pojedyncze, unikalne egzemplarze, tworzone tradycyjnymi metodami rzemieslniczymi. Wykonujemy zlecenia indywidualne. BEZ odlewow, BEZ plastiku, BEZ fuszerki! Srebrna bizuteria autorska, SKLEP, rekodzielo, srebro, pasja, sztuka, hand-made, rzemioslo, jubilerstwo, handmade, hand made, KUP" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Hirundo - srebrna bizuteria autorska, SKLEP, rekodzielo, srebro, pasja, sztuka, hand-made, rzemioslo, jubilerstwo</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1480384652" />
...
<a href="index.php" class="logo"><img src="data/files/logogifgjh.png" style="border:0" id="WebsiteLogo" alt="Hirundo" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://e-hirundo.pl/"><span>Start</span></a></li>
<li  ><a href="galeria"><span>Galeria</span></a></li>
<li  ><a href="artykuly"><span>Artykuly</span></a></li>
<li  ><a href="inter"><span>Interaktywnie</span></a></li>
<li  ><a href="2morgi"><span>Dwie&nbsp;Morgi</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#90A4AE" data-background="data/files/to.jpg" data-align="keditLeft"  class=" keditLeft " style="background:#90A4AE url(data/files/to.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#BDDEFD" class=" koHeaderAutoHeight  koHeaderHide " style="background:#BDDEFD">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2016 e-hirundo.pl, Wszelkie Prawa Zastrzezone</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Bizuterja"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 4666</span></div>
</div>
</div>
</div>
</div>
