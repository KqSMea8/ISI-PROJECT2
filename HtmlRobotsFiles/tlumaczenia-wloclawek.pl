...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/favicon.ico.png" />
<link rel="shortcut icon" href="data/files/favicon.ico.png" />
<link rel="apple-touch-icon" href="data/files/favicon.ico.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<a href="index.php" class="logo"><img src="data/files/tabliczka.jpg" style="border:0" id="WebsiteLogo" alt="" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://tlumaczenia-wloclawek.pl/"><span>Home</span></a></li>
<li  ><a href="1_7_firma.html"><span>Firma</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#774829" data-background="data/files/theme/21-3.jpg" class=" keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#774829 url(data/files/theme/21-3.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2017 Biuro Tlumacza Przysieglego, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Biuro-t%C5%82umacze%C5%84-274184049409072"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
