...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo_1464366710.png" />
<link rel="shortcut icon" href="data/files/logo_1464366710.png" />
<link rel="apple-touch-icon" href="data/files/logo_1464366710.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Avenir|Asap&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Avenir|Asap&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Avenir","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Asap","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556126108"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Wyszukiwanie i pozyskiwanie ofert firm z zakresu: Ochrona, Zabezpieczenia, Sprzatanie, Konserwacja, Przeglady okresowe budynkow" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; PRZYGOTOWANIE OFERTY NA OCHRONE OBIEKTOW SPRZATANIE KONSERWACJA PRZEGLADY ZABEZPIECZENIA</title>

</head>
<body class="koThemeDark" data-bgcolor="#212121" style="background:#212121" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1516827787" /><style>  .koTheme3 #headerMenu{position:absolute;top:-120px;} .koTheme3 #header{margin-top:150px}.koTheme3 #website{box-shadow:0 0 50px rgba(0,0,0,0.5)} .koTheme3 .koMenu3 .logoHolder h2 {color:rgba(0,0,0,0.8)}   .koTheme3 .koThemeDark #headerMenu.koMenu3 .topmenu a:hover,.koTheme3 .koThemeDark #headerMenu.koMenu3 .topmenu .active a {     color: rgba(255,255,255,0.7); border-color:#fff }          </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/logo_1464366710.png" style="border:0" id="WebsiteLogo" alt="smartsupport" /><span>smartsupport</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://smartsupport.pl/"><span>Oferta</span></a></li>
...
<!-- Content -->
<div class="WxEditableArea" id="contentArea"><script type="text/javascript" id="jsMenusSetup">ddlevelsmenu.setup("1", "sidebar","-4","-4");jQuery(function(){})</script>Blad 404: Strona nie istnieje!</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy;2016 Smartsupport.pl, Wszelkie Prawa Zastrzezone</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 2940</span></div>
</div>
</div>
</div>
</div>
