...
<link rel="bookmark" href="data/files/logogreens.jpg" />
<link rel="shortcut icon" href="data/files/logogreens.jpg" />
<link rel="apple-touch-icon" href="data/files/logogreens.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556138172"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Klub Sportowy Greens Slupno</title>
...
<style type="text/css">h1,h2,#content h3,.topmenu{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Varela Round","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(data/files/bez-nazwy14.jpg);}</style>

</head>
<body><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>/*repeat-splash-bg*/.container_top,.container_header,.container_splash2{background:none;}body{background:url(data/files/klubsportowygreenssupno3.jpg)}</style>
...
<a href="index.php" class="logo"><img src="data/files/logogreens.jpg" style="border:0" id="WebsiteLogo" alt="KLUB SPORTOWY GREENS SLUPNO" /></a>
...
<li ><a href="http://www.greens-slupno.pl/"><span>&nbsp;Strona&nbsp;Glowna</span></a></li>
<li ><a href="index.php?p=1_3_aktualnosci"><span>Aktualnosci</span></a></li>
<li ><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li ><a href="index.php?p=1_8_oboz-sportowy" rel="dropmenu_1_8"><span>Oboz&nbsp;sportowy</span></a></li>
<li ><a href="index.php?p=1_7_filmy"><span>Filmy</span></a></li>
<li ><a href="index.php?p=1_5_sponsorzy"><span>Sponsorzy&nbsp;&nbsp;&nbsp;&nbsp;</span></a></li>
...
<h5 style="text-align: center;"><span style="font-size: 25px; font-family: Georgia, helvetica, sans-serif; color: #ffffff;"><strong><em>Z milosci do sportu i pasji do koszykowki !!!</em></strong></span></h5>        </div>
</div>
</div>
</div>
