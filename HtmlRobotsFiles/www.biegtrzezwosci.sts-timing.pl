...
<html>
<head>
<title>STS-TIMING.PL - REJESTRACJA V Bieg Trzezwosci - Brzoza - 2014-09-20</title>
...
<tr valign="middle">
<td colspan="3">
<div class="center"><p class="head">STS-TIMING.PL - Rejestracja<br>V Bieg Trzezwosci<br>Brzoza - 2014-09-20</p></div>
<div class="center"><p class="head"> <a href="lista.php">Lista startowa - V Bieg Trzezwosci</a></p></div>
