...
<title>Blad 404: Strona nie istnieje! &raquo; silownia i fitness</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1527293146" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>silownia i fitness</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://silowniaifitness.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div class="kedit keditRow" id="kpg_720">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_621" ><div class="keditable keditable-auto">Copyright (c)2018 silownia i fitness, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_252" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/Facebook"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://twitter.com/Twitter"><i class="fa fa-twitter fa-2x fa-fw"></i></a><a target="_blank" href="http://www.youtube.com/YouTube"><i class="fa fa-youtube fa-2x fa-fw"></i></a></ul><style></style></div></div>
</div>
</div>
</div>
