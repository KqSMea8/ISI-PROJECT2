...
<meta name="Keywords" content="barabara.pl" />
<meta name="Description" content="barabara.pl" />
<meta name="Robots" content="ALL" />
<meta name="viewport" content="width=device-width, initial-scale=0.9, maximum-scale=0.9, user-scalable=0" />
<title>barabara.pl</title>
<!-- Domyslny -->
...
<div id="container">
<h1>barabara.pl</h1>
<p class="center">Domena na sprzedaz. Zapraszamy do skladania ofert.</p>
...
<p class="center" style="font-weight: bold">Cena sprzedazy: 1 800,00 PLN netto</p>
<p class="center"><input type="hidden" name="dodanieDomen" value="doKoszyka" />
<input type="hidden" name="domains[]" value="barabara.pl" />
