...
<meta name="google-site-verification" content="VDKtAVSeELEuBEN-RgssT30L-mJTuWq5qTbrla2KBwo" /><link rel="bookmark" href="editor_images/favicon.png" />
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556020241"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Profesjonalne wykonywanie fotografii i filmow z powietrza przy uzyciu drona DJI Inspire PRO. Obslugujemy Krakow i Malopolske oferujac konkurencyjne ceny." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; Zdjecia i filmy z lotu ptaka | z drona | Krakow | Malopolska |</title>
...
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1463658889" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style></style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>AERIAL MEDIA</h2><h4>Zdjecia i filmy z powietrza | z drona | Krakow | Malopolska</h4></div><!--Logo--></a>
...
<li ><a href="http://aerialmedia.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="index.php?p=1_2_oferta"><span>Oferta</span></a></li>
<li ><a href="index.php?p=1_5_galeria"><span>Galeria</span></a></li>
<li ><a href="index.php?p=1_7_filmy"><span>Filmy</span></a></li>
<li ><a href="index.php?p=1_3_aktualnosci"><span>Aktualnosci</span></a></li>
<li ><a href="index.php?p=1_6_cennik"><span>Cennik</span></a></li>
...
<li><a href="index.php?p=1_6_cennik"><span>Cennik</span></a></li>
<li><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
</ul> <br /> Zdjecia zamieszczone w galerii jak r&oacute;wniez inne nie bedace elementem graficznym strony, chronia prawa autorskie. Wykorzystywanie do cel&oacute;w komercyjnych bez zgody autora zabronione. Do cel&oacute;w prywatnych - po poinformowaniu autora. <br /><br /></div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> Lukasz Wypych,<br /> Wszelkie Prawa Zastrzezone</div>
<div class="margins"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/aerialmediapl"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a><a target="_blank" href="http://plus.google.com/b/117917229685473598580/+AerialmediaPl"><i class="fa fa-google-plus-square fa-2x fa-fw"></i></a><a target="_blank" href="http://instagram.com/aerialmedia.pl"><i class="fa fa-instagram fa-2x fa-fw"></i></a></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-85668421-1']);
