...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Coda|Coda&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Coda|Coda&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Coda","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Coda","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556126612"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; sprzatanie-bialystok.pl</title>

</head>
<body class="" data-bgcolor="#FFFF00" data-background="data/files/img-16051.jpg" style="background:#FFFF00 url(data/files/img-16051.jpg) no-repeat 50% 0px;background-size:cover" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1533059356" /><style>body{background:linear-gradient(to bottom,#fff 0%,#fff 100px, #888 100px,#888 200px, #eee 200px, #eee 100%)}.koTheme1 #website {margin-left:5%;margin-right:5%;box-shadow:0 0 20px rgba(0,0,0,0.5)}.koTheme1 #header,.koTheme1 #contentArea{background:#fff;box-shadow:0 0 30px rgba(0,0,0,0.2)}</style>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>sprzatanie-bialystok.pl</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://sprzatanie-bialystok.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_2_uslugi.html"><span>Uslugi</span></a></li>
<li  ><a href="1_5_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="1_6_oferty-pracy.html"><span>OFERTY&nbsp;PRACY</span></a></li>
</ul>
</div>
...
<div id="subpageHeaderBanner" data-bgcolor="#774829" data-background="data/files/theme/22-1.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditDark  keditLeft " style="background:#774829 url(data/files/theme/22-1.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2018 sprzatanie-bialystok.pl, All Rights Reserved.</div>
</div>
