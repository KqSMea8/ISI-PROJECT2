...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="/inc/js/menu.js?1556121758"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Fundacja TAURUS</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1485332136" /><style>#headerMenu.koMenu3 .topmenu .active a,#headerMenu.koMenu3 .topmenu a:hover {}#headerMenu.koMenu3 .topmenu a:hover {} </style>
...
<ul class="menuHolder topmenu"><li  ><a href="http://poradyprawne-taurus.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li  ><a href="1_3_cykl-o-mediacji.html"><span>Cykl&nbsp;o&nbsp;mediacji</span></a></li>
<li  ><a href="1_2_blog.html"><span>Blog</span></a></li>
<li  ><a href="1_5_biuletyny-prawne.html"><span>Biuletyny&nbsp;Prawne&nbsp;</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/FundacjaTaurus"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderContent" data-bgcolor="#90A4AE" data-background="data/files/theme/triangle.png" class=" keditDark " style="background:#90A4AE url(data/files/theme/triangle.png) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="kedit" id="kpg_211" ><div class="keditable keditable-auto">(c)2017, All Rights Reserved 2017 FUNDACJA TAURUS<br></div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_02" ><div class="footerHolder" id="keditFooterModule"><span id="footerHitCounter">Liczba odwiedzin: 7943</span></div></div>
</div>
</div>
</div>
