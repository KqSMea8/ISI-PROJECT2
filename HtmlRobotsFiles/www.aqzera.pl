...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/ikona2.png" />
<link rel="shortcut icon" href="data/files/ikona2.png" />
<link rel="apple-touch-icon" href="data/files/ikona2.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556132122"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; aQzera</title>
...
<link href="http://fonts.googleapis.com/css?family=Crete+Round|Bitter&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Crete Round","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Bitter","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_default.css?1433617524" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.1" /><style>/*repeat-splash-bg*/.container_splash2{background:none;}.container_splash2{background:url(data/templates/default/images/splash_bg.jpg)}</style>
...
<a href="index.php" class="logo"><img src="data/files/aqzera.png" style="border:0" id="WebsiteLogo" alt="aQzera" /></a>
...
<li ><a href="http://www.aqzera.pl/"><span>Strona&nbsp;Glowna</span></a></li>
<li ><a href="1_2_program-aqzera.html"><span>Program&nbsp;aQzera</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> aQzera,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> </div>
</div>        </div>
</div>
</div>
</div>
