...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/logo..jpg" />
<link rel="shortcut icon" href="data/files/logo..jpg" />
<link rel="apple-touch-icon" href="data/files/logo..jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Caveat+Brush|Cantarell&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Caveat+Brush|Cantarell&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Caveat Brush","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Cantarell","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556095828"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; InterDecora</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1482248916" /><style> hr { border-color: #2b3a42 } .dropmenudiv li a { background: #2b3a42; color: #fff } .topmenu a:hover, .topmenu .active a { background: #fff; color: #2b3a42 !important; box-shadow: 0 -20px 20px -20px #ff530d inset } #contentArea h1, #contentArea h2, #contentArea h3, #contentArea h4, .koThemeDark #contentArea .whiteShadowContainer strong, .koThemeDark #contentArea .whiteShadowContainer h1, .koThemeDark #contentArea .whiteShadowContainer h2, .koThemeDark #contentArea .whiteShadowContainer h3, .koThemeDark #contentArea .whiteShadowContainer h4 {  color: #2b3a42  } .WxEditableArea a:not(.btn) { color: #2b3a42  } #contentArea, .koThemeDark #contentArea .whiteShadowContainer { color: #2b3a42; font-size: 16px;} .swiper-container { max-width: 400px; max-height: 400px;} .thumbnail { margin-bottom: 0px;} .thumbnail-description { background: #fff; position: relative; z-index: 20 } #header { background: #2b3a42 } .koTheme2 #header .menuHolder li {} .koTheme2 #header .menuHolder li a { color: #fff; } .clearFloating { clear: none !important} .cm4all_com_widgets_Photo { margin-top: 20px; margin-left: 10px; float: left !important; max-width: 150px !important } .special-shadow { box-shadow: 0 7px 5px -5px rgba(0, 0, 0, 0.7) inset, 0 -7px 5px -5px rgba(0, 0, 0, 0.7) inset} .special-family { font-family: "Caveat Brush","Helvetica Neue",Helvetica,Arial,sans-serif } .koTheme2 #header .menuHolder li a { font-family: "Playfair Display","Helvetica Neue",Helvetica,Arial,sans-serif} .special-inner, #footerContent .row, .thumbnails { margin: 0 auto; max-width: 1200px;} .thumbnails > div { max-width: 200px; max-height: 200px; } </style>   <script> $(function() { var show = $('.show-thumbnails-text').data("show"); if( show == false) { return false;}  $( ".thumbnails a" ).each(function( index ) {   console.log( index + ": " + $( this ).attr("href") ); var href = $( this ).attr("href"); var e = href.split("/"); var length = e.length; var lastElement = e[length-1];  var end = lastElement.split('.'); var name = end[0];  var text = '<p class="thumbnail-description">' + name + '</p>'; $(this).parent().append(text); });   });   </script>
...
<a href="index.php" class="logo"><img src="data/files/logo..jpg" style="border:0" id="WebsiteLogo" alt="InterDecora" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://interdecora.pl/"><span>Start</span></a></li>
<li  ><a href="okleiny-sciene" rel="dropmenu_1_5"><span>Okleiny&nbsp;scienne</span></a></li>
<li  ><a href="wzory-wyprzeda-owe"><span>Wzory&nbsp;wyprzedazowe</span></a></li>
<li  ><a href="fototapety"><span>Fototapety</span></a></li>
<li  ><a href="reprodukcje-obrazow"><span>Reprodukcje&nbsp;obrazow</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/header.jpg" data-parallax="1"  data-align="keditLeft"  class=" parallax-window  keditDark  koHeaderAutoHeight  koHeaderHide  keditLeft " style="background: url(data/files/header.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<li><a href="okleiny-sciene-okleiny-winylowe"><span>Okleiny&nbsp;winylowe</span></a></li>
<li><a href="okleiny-sciene-okleiny-winylowe-bud-etowe"><span>Okleiny&nbsp;winylowe&nbsp;budzetowe</span></a></li>
<li><a href="okleiny-materialowe"><span>Okleiny&nbsp;materialowe</span></a></li>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#2b3a42" class=" keditDark  koHeaderAutoHeight  koHeaderHide " style="background:#2b3a42">
<div class="kedit keditFooter">
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div><iframe style="border: none; overflow: hidden;" src="https://www.facebook.com/plugins/page.php?href=https://www.facebook.com//InterDecoranew/&amp;tabs&amp;width=340&amp;height=130&amp;small_header=false&amp;adapt_container_width=true&amp;hide_cover=false&amp;show_facepile=false&amp;appId=390352034421993" width="340" height="130" frameborder="0" scrolling="no"></iframe></div>
<div>&nbsp;</div>
<div>Copyright &copy;2016 InterDecora, All Rights Reserved.</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/InterDecoranew"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>
</div>
</div>
</div>
