...
Stowarzyszenie JP2 - logowanie
</title><meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" /><link rel="stylesheet prefetch" href="//fonts.googleapis.com/css?family=Open+Sans" />
<style>
*, *:before, *:after {
...
position: relative;
height: 100%;
background-image: url("//www.astor.com.pl/images/Stowarzyszenie/vatican.jpg");
...
<form method="post" action="./logon.aspx?ReturnUrl=%2frobots.txt" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTYyODM5OTIyMmRkv74Mnh1pDiY0fbdA01/qbbkfvhfVcC6RJgjyutb409k=" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="574332E0" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAATfZrNlvTBQNUtbBA4D4Fk/Y3plgk0YBAefRz3MyBlTcA6Puailico2fWp193TJgzGKVZBXgGQ/GUR0UoSGGFdNI5KYxh6ECxGH/MB4Et2G5qtrAtkli7xmXK/j9wtI/1Y=" />

<div class="login__row">
<svg class="login__icon name svg-icon" viewBox="0 0 20 20"><path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" /></svg>
<input name="txtUserName" type="text" id="txtUserName" class="login__input name" placeholder="E-mail" />
&nbsp;
</div>
<div class="login__row">
<svg class="login__icon pass svg-icon" viewBox="0 0 20 20"><path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" /></svg>
<input name="txtUserPass" type="password" id="txtUserPass" class="login__input pass" placeholder="Haslo" />
&nbsp;
</div>
<input onclick="if (typeof(Page_ClientValidate) == 'function') Page_ClientValidate(''); " name="cmdLogin" type="submit" id="cmdLogin" class="login__submit" value="Zaloguj sie" />
</form>
</div>
</div>
</div>
...
if (jQuery("input#txtUserName").val() != '' && jQuery("input#txtUserPass").val() != '')
{
if (animating) return;
animating = true;
var that = this;
