...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/i.jpg" />
<link rel="shortcut icon" href="data/files/i.jpg" />
<link rel="apple-touch-icon" href="data/files/i.jpg" /><script>var tinyMcePath="/";</script><script src="/inc/js/tinymce/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Cabin|Didact+Gothic&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Cabin|Didact+Gothic&amp;text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
<style type="text/css">#website h1,#website h2,#website #content h3,#website .topmenu{font-family:"Cabin","Helvetica Neue",Helvetica,Arial,sans-serif}#website,#website p{font-family:"Didact Gothic","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{}</style>
...
<meta name="description" content="Profesjonalny marketing internetowy Poznan i cala Polska - tworzenie stron WWW -  prowadzenie kampanii Google AdWords - pozycjonowanie stron - reputacja firm." />
<meta name="keywords" content="Tworzenie stron internetowych, tworzenie stron www, projektowanie stron www, projektowanie stron internetowych, kampania google adwords, pozycjonowanie stron, marketing internetowy, marketing internetowy poznan, strony www poznan, strony internetowe poznan" />
<title>Blad 404: Strona nie istnieje! &raquo; Mocdar - Projektowanie stron internetowych WWW Poznan</title>

</head>
<body class="" style="background:" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1501614590" />
...
<a href="index.php" class="logo"><img src="data/files/logobyfreelogo.me12_1501135910.png" style="border:0" id="WebsiteLogo" alt="wsparcie marketingowe" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://mocdar.pl/"><span>O&nbsp;firmie</span></a></li>
<li  ><a href="1_2_oferta.html"><span>Oferta</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/mocdarbiznes"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderContent" data-bgcolor="#795548" data-background="data/files/tofulhd.jpg" data-parallax="1"  class=" parallax-window  keditDark " style="background:#795548 url(data/files/tofulhd.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<!-- Footer -->
<div id="footerContent" data-bgcolor="#d8d8d8" data-parallax="1"  class=" parallax-window  keditDark  kfilter3 " style="background:#d8d8d8">

<div class="kedit keditRow parallax-window keditDark kfilter1" id="kpg_140" data-bgcolor="#616161" data-parallax="1" style="background:#616161">
<div class="row">
<div class="col-sm-7 keditColumn">
<div class="kedit" id="kpg_281"><div class="keditable keditable-auto"><div>Copyright (c) 2017 Mocdar - Wszelkie Prawa Zastrzezone</div></div></div>
</div>
<div class="col-sm-5 keditColumn">
<div class="kedit" id="kpg_602" ><div class="footerHolder" id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/mocdarbiznes"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 6248</span></div></div>
</div>
</div>
</div>
