...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556115019"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; Biuro Rachunkowe LIBRO</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1506863928" /><style>#headerMenu.koMenu4 .topmenu .active a,#headerMenu.koMenu4 .topmenu a:hover {background:#fff;border-radius:4px;}#headerMenu.koMenu4 .topmenu a:hover {background:rgba(255,255,255,0.5);} </style>
...
<a href="index.php" class="logo"><h2><img src="data/files/theme/0_logo.png" style="border:0" id="WebsiteLogo" alt="Biuro Rachunkowe LIBRO" /><span>Biuro Rachunkowe LIBRO</span></h2></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://libro.biz.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderBanner" data-bgcolor="#203957" data-background="data/files/picjumbo.com_hnck8404.jpg" class=" keditDark " style="background:#203957 url(data/files/picjumbo.com_hnck8404.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2017 Biuro Rachunkowe LIBRO Monika Stachera, All Rights Reserved.</div>
</div>
