...
<h1 class="text-uppercase mb-3 tm-site-name">ArtShow</h1>
<p class="tm-site-description">Witaj na stronie ArtShow</p>
<p class="tm-site-description">szkoly muzycznej </p>
</div>
</div>
...
<footer class="row">
<div class="col-xl-12">
<p class="text-center p-4">Copyright &copy; <span class="tm-current-year">2019</span> ArtShow  <a href="#" class="tm-text-gray">ArtShow</a></p>
</div>
</footer>
</div> <!-- .container -->
