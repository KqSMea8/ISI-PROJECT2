...
<head>
<meta charset="utf-8">
<title>Biuro podrozy Europa - Tour</title>
<meta name="keywords" content="Biuro podrozy, Europa - Tour" />
<meta name="description" content="Biuro podrozy Europa - Tour oferuje bardzo duzy zakres wycieczek od wielu lat, nasze doswiadczenie jest bezcenne dla nowych i stalych klientow. Zapraszamy do zapoznania sie z nasza oferta" />


<link class="style_page"  rel="stylesheet" href="http://europa-tour.pl/robots.txt/RWD/styles/css/44234b8077b77b5e7824e71b9338d442/1846415/style.css"/>
<style type="text/css">
</style>
...
<script type="text/javascript" src="http://europa-tour.pl/robots.txt/RWD/script/md5/db7feea7_errorlog,jquery,_la,jqgrid,mgrid,qtip,mgrid_sbox,valid,cal,sbox,smap,jcarousel,mbasecal,mtp,masgg,mmultisel,loadscripts,mtrans,sel2,slider,bootstrap,main,qs,qtipinfomsg,welcomepopup,tcal,toe,dstpicker,sdynmap,experts,mcal,mscal,jqmcal,jqmtp,jqmasgg,jqmmultisel,airpmap,rmap,vellipsis,curr,offices,lang,basket,offrenderer,cart,jscrollpane,locmap,resize,jqlazyload,jqparallax,vue,webworker.js"></script><script>
...
var captchaUrl = 'http://europa-tour.pl/robots.txt/RWD/captcha/';
</script>
<script src="http://europa-tour.pl/robots.txt/RWD/script/md5/6cccb67d_b64_YXNzZXRzL2pzL21vZHVsZXMvY2FwdGNoYS5qcw==.js"></script>
<script type="text/javascript">
var baseRWDUri="http:\/\/europa-tour.pl\/robots.txt\/RWD",
overlayAdminPanel = '', // for use in formTemplate.volt and admin-boxes-controller
ajaxPrefix = "http://europa-tour.pl/robots.txt/RWD/";
...
<!--[if lt IE 9]>
<script src="http://europa-tour.pl/dist/html5shiv.js"></script>
<![endif]-->
<link rel="stylesheet" href="http://europa-tour.pl/css/reset.css">
<link rel="stylesheet" href="http://europa-tour.pl/css/style.css">
<link rel="stylesheet" href="http://europa-tour.pl/css/lista.css">
<!--[if lt IE 9]>
<link rel="stylesheet" href="http://europa-tour.pl/css/ie.css">
<![endif]-->
<!-- <script src="http://code.jquery.com/jquery-1.9.1.min.js"></script> -->
<script src="http://europa-tour.pl/js/front.js"></script>
<script type="text/javascript">
$(document).ready(function(){
// komunikaty form. kontakt
$('.komunikat, .komunikat_ok').delay(4000).slideUp('slow');

// przycisku autokarow na dole
$('#rezerwacja p a').hover(function(){
$('#rezerwacja').css('background-position', '0px -122px');
}, function(){
$('#rezerwacja').css('background-position', '0px 0px');
});
$('#zakup p a').hover(function(){
$('#zakup').css('background-position', '0px -122px');
}, function(){
$('#zakup').css('background-position', '0px 0px');
});
$('#zakup_inne p a').hover(function(){
$('#zakup_inne').css('background-position', '0px -122px');
}, function(){
$('#zakup_inne').css('background-position', '0px 0px');
});
});

// obsluga komunikatu o ciasteczkach
// funkcja zapisu
...
// ukrycie komunikatu i ustawienie ciasteczka
jQuery(function() {
jQuery('#cookie_kom_start').click(function(){
setCookie("komunikat", "t");
jQuery('#cookie_kom').slideUp('slow');
});
});
</script>
</head>
...
<div id="container">
<header>
<h1><a class="logo" href="http://europa-tour.pl/">Europa - Tour<br>Biuro podrozy</a></h1>
<div id="kontakt">
<p class="tel">71-361-44-00, 71-361-33-87<br />665-01-43-44</p>
<p class="mail"><a href="mailto:europatour@pvd.pl">europatour@pvd.pl</a></p>
</div>
</header>
...
<nav>
<ul>
<li><a href="http://europa-tour.pl/">Strona glowna</a></li>
<li><a href="http://europa-tour.pl/o_nas.php">O nas</a></li>
<li><a href="http://europa-tour.pl/wlasne.php">Imprezy wlasne</a>
<ul>
<li><a href="http://europa-tour.pl/wlasne.php">Aktualne</a></li>
<li><a href="http://europa-tour.pl/wlasne.php?old=1">Archiwum</a>
</ul>
</li>
<li><a href="http://europa-tour.pl/specjalne.php">Oferty specjalne</a></li>
<li style="border-right: none;"><a href="http://europa-tour.pl/kontakt.php">Kontakt</a></li>
</ul>
</nav>
</div>	<!-- end #menu -->
...
<div id="offer_div_1"><section class="promo-box
high
shadow-block br-block"
id="52198025" style="position: relative;"
>
<div class="carousel slide carousel-fade promobox" id="52198025_carousel"
>

<ol class="carousel-indicators pos-lr hidden-sm hidden-xs">
<li data-target="#52198025_carousel" data-slide-to="0" class="active background-color-7 background-color-4 text-color-3"></li>
<li data-target="#52198025_carousel" data-slide-to="1" class=" background-color-4 text-color-3"></li>
<li data-target="#52198025_carousel" data-slide-to="2" class=" background-color-4 text-color-3"></li>
</ol>
<div class="hidden-lg hidden-md">
<a class="left carousel-control" href="#52198025_carousel" role="button" data-slide="prev">
<div class="carousel-control-inner">
<i class="fa fa-angle-left"></i>
</div>
</a>
<a class="right carousel-control" href="#52198025_carousel" role="button" data-slide="next">
<div class="carousel-control-inner">
...
<div class="item">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52198025/52195645/"
target="_self"
class="animated fadeIn">

<div class="img-container scale-x-2" data-url="http://europa-tour.pl/robots.txt/RWD/image/getbyid/755/1278/677/2/7/100/770/408/2" style="background-color: rgba(255, 255, 255, 1); background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/755/1278/677/2/7/100/770/408/2);"></div>
...
<div class="item">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52198025/52195730/"
target="_self"
class="animated fadeIn">

<div class="img-container scale-x-1" data-url="http://europa-tour.pl/robots.txt/RWD/image/getbyid/972/1189/629/11/97/100/770/408/1" style="background-color: rgba(255, 255, 255, 1); background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/972/1189/629/11/97/100/770/408/1);"></div>
...
<div class="item">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52198025/52195800/"
target="_self"
class="animated fadeIn">

<div class="img-container scale-x-2" data-url="http://europa-tour.pl/robots.txt/RWD/image/getbyid/967/838/444/220/154/100/770/408/2" style="background-color: rgba(255, 255, 255, 1); background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/967/838/444/220/154/100/770/408/2);"></div>
...
<script src="http://europa-tour.pl/robots.txt/RWD/script/md5/5d7b9d77_b64_YXNzZXRzL2pzL21vZHVsZXMvbWVybGluLXByb21vYm94Lmpz.js"></script>
...
var promo = new MerlinPromoBox(config, $('#52198025_carousel'), $('#52198025').parent());

</script>
</section></div><div id="offer_div_2"><section id="52197895"
...
<a href="#52197895-0" data-toggle="tab"
...
<a href="#52197895-1" data-toggle="tab"
class="text-color-9" data-inactive-color=""
>
<span>Autokarem</span>
</a>
...
data-icon="star" 					style="width: 33.333333333333%">
<a href="#52197895-2" data-toggle="tab"
class="text-color-9" data-inactive-color=""
>
...
id="52197895-0"
>
<form action="http://europa-tour.pl/robots.txt/RWD/index/samolotem/">
...
id="52197895-1"
>
<form action="http://europa-tour.pl/robots.txt/RWD/index/autokarem/">
<div class="inputs fields-container-wrapper">
<input type="hidden" value="trip" name="transport"/>
...
id="52197895-2"
>
<form action="http://europa-tour.pl/robots.txt/RWD/index/dojazd_wlasny/">
<div class="inputs fields-container-wrapper">
<input type="hidden" value="trip" name="transport"/>
...
window['sbDefaultValues']['widget52197895'] = [{},{},{}];
$('#52197895').searchBox(true);
...
setTimeout(function () {
$('#52197895 ').removeClass('searchbox-loading');
}, 100);
</script></section>
</div><div id="offer_div_3"><section id="52198495"
...
<form action="http://europa-tour.pl/robots.txt/RWD/index/kolonie/">
<div class="inputs fields-container-wrapper">
<input type="hidden" value="trip" name="transport"/>
...
<div class="col-xs-6 input-container br-input searchbox-element searchbox-dd-item "></div>
...
<div class="col-xs-12 sb-elem-fullsize searchbox-element searchbox-dd-item
"
data-field-type="transporttype">


<div class="mc-input-container br-input select2-container-multi mc-select text-color-19">

<ul class="mc-input select2-choices br-input text-color-9 select2-choices-empty"
data-placeholder="Typ transportu">

<li class="mc-placeholder mc-base select2-default">Typ transportu</li>
</ul>

<input type="hidden"
placeholder="Typ transportu"
title="Typ transportu"
...
if (typeof window['sbDefaultValues'] == 'undefined') window['sbDefaultValues'] = {};
window['sbDefaultValues']['widget52198495'] = [{}];
$('#52198495').searchBox(true);
...
// For optimization task (loading scripts at the end of the body element)
setTimeout(function () {
$('#52198495 ').removeClass('searchbox-loading');
}, 100);
</script></section>
</div><div id="offer_div_4"><section class="promo-box
high
shadow-block br-block"
id="52198000" style="position: relative;"
>
<div class="carousel slide carousel-fade promobox" id="52198000_carousel"
>

<ol class="carousel-indicators pos-ll hidden-sm hidden-xs">
<li data-target="#52198000_carousel" data-slide-to="0" class="active background-color-7 background-color-4 text-color-3"></li>
<li data-target="#52198000_carousel" data-slide-to="1" class=" background-color-4 text-color-3"></li>
</ol>
<div class="hidden-lg hidden-md">
<a class="left carousel-control" href="#52198000_carousel" role="button" data-slide="prev">
<div class="carousel-control-inner">
<i class="fa fa-angle-left"></i>
</div>
</a>
<a class="right carousel-control" href="#52198000_carousel" role="button" data-slide="next">
<div class="carousel-control-inner">
<i class="fa fa-angle-right"></i>
</div>
</a>
...
<div class="item">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52198000/52195490/"
target="_self"
class="animated fadeIn">

<div class="img-container scale-x-1" data-url="http://europa-tour.pl/robots.txt/RWD/image/getbyid/533/1281/447/0/138/100/1170/408/1" style="background-color: rgba(255, 255, 255, 1); background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/533/1281/447/0/138/100/1170/408/1);"></div>

<div class="text-container textpos-lr textsize-l bgstyle-dg" data-textcolor="t|255,255,255,1">
<h2 class="slide-pbox_text">Nurkowanie w Egipcie</h2>
<h3 class="slide-pbox_addtext">Oferty all inclusive juz od   849PLN</h3>
</div>
</a>
</div><!-- / item -->

<div class="item">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52198000/52195575/"
target="_self"
class="animated fadeIn">

<div class="img-container scale-x-1" data-url="http://europa-tour.pl/robots.txt/RWD/image/getbyid/344/1281/447/0/172/100/1170/408/1" style="background-color: rgba(255, 255, 255, 1); background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/344/1281/447/0/172/100/1170/408/1);"></div>

<div class="text-container textpos-lr textsize-l bgstyle-lg" data-textcolor="t|1,32,66,1">
<h2 class="slide-pbox_text">Egzotyka</h2>
<h3 class="slide-pbox_addtext">Dalekie kierunki juz od:   1099PLN</h3>
</div>
</a>
</div><!-- / item -->
...
var promo = new MerlinPromoBox(config, $('#52198000_carousel'), $('#52198000').parent());

</script>
</section></div><div id="offer_div_5"><section class="offerlist-box br-block">
...
style="background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/314/885/280/224/180/100/null/null/1);">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52198255/0/"
class="inner"></a>
</div>
</div>
<div class="img-mobile-container visible-xs visible-sm ">
<img src="http://europa-tour.pl/robots.txt/RWD/image/getbyid/314/885/280/224/180/100/null/null/1" class="scalable-x">
</div>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52198255/0_15:/">
...
href="http://europa-tour.pl/robots.txt/RWD/index/52198255/0_14:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52198255/0_26:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52198255/0_11:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
</div><div id="offer_div_6"><section class="offerlist-box br-block">
<div class="section shadow-block br-block ">
<div class="section-header background-color-1 text-color-12 br-block-top">
<div class="sh-inner">
<h2> All Inclusive </h2>
...
<div class="img-container-wrapper hidden-xs hidden-sm">
<div class="img-container scale-x-1 hidden-xs hidden-sm  "
style="background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/1108/1198/511/0/160/100/370/158/1);">
<a href="http://europa-tour.pl/robots.txt/RWD/index/52197975/0/"
class="inner"></a>
</div>
</div>
<div class="img-mobile-container visible-xs visible-sm ">
<img src="http://europa-tour.pl/robots.txt/RWD/image/getbyid/1108/1198/511/0/160/100/370/158/1" class="scalable-x">
</div>
...
<li class="text-color-19 border-bottom text-hover-18">
<a title=" Wczasy Cypr  "
href="http://europa-tour.pl/robots.txt/RWD/index/52197975/0_6:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
<li class="text-color-19 border-bottom text-hover-18">
<a title=" Wczasy Egipt  "
href="http://europa-tour.pl/robots.txt/RWD/index/52197975/0_11:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
<span class="text-nowrap">Egipt</span>
...
<li class="text-color-19 border-bottom text-hover-18">
<a title=" Wczasy Hiszpania  "
href="http://europa-tour.pl/robots.txt/RWD/index/52197975/0_15:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
<span class="text-nowrap">Hiszpania</span>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52197975/0_3:/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
</div><div id="offer_div_7"><section class="offerlist-box br-block">
<div class="section shadow-block br-block ">
<div class="section-header background-color-1 text-color-12 br-block-top">
<div class="sh-inner">
<h2> Dla aktywnych </h2>
...
<div class="img-container-wrapper hidden-xs hidden-sm">
<div class="img-container scale-x-1 hidden-xs hidden-sm  "
style="background-image: url(http://europa-tour.pl/robots.txt/RWD/image/getbyid/1209/1201/204/0/304/100/1170/200/1);">
</div>
</div>
<div class="img-mobile-container visible-xs visible-sm ">
<img src="http://europa-tour.pl/robots.txt/RWD/image/getbyid/1209/1201/204/0/304/100/1170/200/1" class="scalable-x">
</div>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52197950/2/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52197950/3/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
href="http://europa-tour.pl/robots.txt/RWD/index/52197950/4/">
<span class="name text-color-1">
<div class="fixed-table">
<div>
...
<div id="ubezp">
<h1 class="tytul">Firma ubezpieczeniowa<span class="v">&nbsp;</span></h1>
<a href="https://online.erv.pl/insurance/?Referer=001176900000" target="_blank"><img src="images/ubezp.jpg" alt="Firma ubezpieczeniowa"></a>
</div>

<div id="rezerwacja">
<h1 class="tytul">Bilety autokarowe,<br />sys. Voyager<span class="b">&nbsp;</span></h1>
<p><a href="bilety_autokarowe_vayager.php">Kliknij, aby zarezerwowac bilet</a></p>
</div>

<div id="zakup" class="box right">
<h1 class="tytul">Bilety autokarowe,<br />sys. euroTICKET<span class="b">&nbsp;</span></h1>
<p><a href="bilety_autokarowe_euroticket.php">Kliknij, aby zarezerwowac bilet</a></p>
</div>

<div id="zakup_inne" class="box right">
<h1 class="tytul">Zakup innych biletow<span class="b">&nbsp;</span></h1>
<p><a href="inne_bilety.php">Kliknij, aby wyslac zapytanie</a></p>
</div>
</div>

<footer>
<p>Wszelkie prawa zastrzezone 2013 przez Europa Tour - Biuro Podrozy</p>
<p id="realizacja">Realizacja: <a href="http://web4d.pl" target="_blank">web4d.pl</a></p>
</footer>
</div> <!-- end #content-->
