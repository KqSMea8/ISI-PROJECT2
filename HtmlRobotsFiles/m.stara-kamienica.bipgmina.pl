...
<a href=""><img src="https://bi.idcom-web.pl/logo/logo_w250.png" alt="Blad 401" border="0" /></a>
<br /><br />
<a href='http://www.idcom.pl' target='_blank'>IDcom.pl</a><span>&nbsp;</span><a href="mailto:biuro@idcom-web.pl">biuro@idcom-web.pl</a>
</div>
</div>
</body>
</html>
