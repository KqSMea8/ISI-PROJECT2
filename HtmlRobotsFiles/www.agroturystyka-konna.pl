...
<title>Serwer - Futurehost.pl</title>
<meta name="keywords" content="serwery, hosting, serwer www" />
<meta name="description" content="Domena utrzymywana na serwerach Futurehost.pl" />
...
<link rel="SHORTCUT ICON" href="//futurehost.pl/img/favicon.ico" />
<style>
html {
height: 100%;
}
...
<body>
<div class="Content">
<a href="https://futurehost.pl" class="Logo" title=""><img src="//futurehost.pl/img/futurehost.png" alt="Serwery www - hosting dla wymagajacych" /></a>
<h2>Ta domena juz dziala!</h2>
<h3>Juz teraz mozesz <a href="https://futurehost.pl/pomoc/poradniki/wgrywanie-usuwanie-i-aktualizowanie-plikow-na-serwerze?c=9&a=31">wgrac</a> swoje pliki do katalogu: <br /><em>domains&nbsp;/&nbsp;www.agroturystyka-konna.pl&nbsp;/&nbsp;public_html&nbsp;/</em></h3>
<br />
<h3>lub <a href="https://futurehost.pl/pomoc/poradniki/tworzenie-stron/strona-internetowa-w-10-minut-wordpress?c=10&a=25">utworzyc</a> swoja witryne w kilka minut!</h3>
<h1>Domena utrzymywana jest na serwerach <a href="https://futurehost.pl">Futurehost.pl</a></h1>
</div>
</body>
</html>
