...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/bullseyemeatslogo.png" />
<link rel="shortcut icon" href="data/files/bullseyemeatslogo.png" />
<link rel="apple-touch-icon" href="data/files/bullseyemeatslogo.png" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556041725"></script>
...
<title>Blad 404: Strona nie istnieje! &raquo; BEEF JERKY SUPER PREMIUM</title>

</head>
<body class=""  id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1481626570" /><style>.logoHolder img { max-height: 100px;} .koTheme1 .logoCentered #headerBanner {height: 70vh;}.koTheme1 #subpageHeaderBanner, .koTheme1 #headerBanner.koHeaderHide { height: 350px;} .swiper-container-autoheight, .swiper-container-autoheight .swiper-slide { height: 500px; }</style>
...
<a href="index.php" class="logo"><img src="data/files/bullseyemeatslogo.png" style="border:0" id="WebsiteLogo" alt="BEEF JERKY SUPER PREMIUM" /></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://beef-jerky.pl/"><span>Start</span></a></li>
<li  ><a href="1_2_o-nas.html"><span>O&nbsp;Nas</span></a></li>
<li  ><a href="1_3_nasze-produkty.html"><span>Nasze&nbsp;Produkty</span></a></li>
<li  ><a href="1_5_media-o-nas.html"><span>Media&nbsp;o&nbsp;nas</span></a></li>
<li  ><a href="1_4_kontakt.html"><span>Kontakt</span></a></li>
<li class="topmenuSocial"><span><a class="koSocialFacebookHover" target="_blank" href="http://www.facebook.com/beefjerkysklep"><i class="fa fa-facebook-square"></i></a></span></li></ul>
</div>

<!-- Header/Splash -->


<div id="subpageHeaderBanner" data-background="data/files/bif_48730507_cm-a.jpg" data-parallax="1"  class=" parallax-window  keditDark  kfilter1 " style="background: url(data/files/bif_48730507_cm-a.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent">Copyright &copy2016 BEEF JERKY SUPER PREMIUM, All Rights Reserved.</div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/beefjerkysklep"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style><span id="footerHitCounter">Liczba odwiedzin: 1665</span></div>
</div>
</div>
</div>
</div>
