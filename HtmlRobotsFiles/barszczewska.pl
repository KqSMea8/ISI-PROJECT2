...
<link href="http://barszczewska.pl/css/style.css" rel="stylesheet" type="text/css" />
<link href="http://barszczewska.pl/css/responsive.css" rel="stylesheet" type="text/css" />
<link href="http://barszczewska.pl/css/print.css" rel="stylesheet" type="text/css" media="print" />
<link rel="stylesheet" href="http://barszczewska.pl/css/lightbox.css" type="text/css" media="screen" />


<script src="http://barszczewska.pl/js/jquery-1.7.2.min.js"></script>
<script src="http://barszczewska.pl/js/jquery-ui-1.8.18.custom.min.js"></script>
<script src="http://barszczewska.pl/js/jquery.smooth-scroll.min.js"></script>
<script src="http://barszczewska.pl/js/lightbox.js"></script>


<script src="http://barszczewska.pl/js/script.js"></script>


<link href="http://barszczewska.pl/perfect-scrollbar-0.4.8/src/perfect-scrollbar.css" rel="stylesheet">
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<script src="http://barszczewska.pl/perfect-scrollbar-0.4.8/src/jquery.mousewheel.js"></script>
<script src="http://barszczewska.pl/perfect-scrollbar-0.4.8/src/perfect-scrollbar.js"></script>


<script src="http://barszczewska.pl/mediaelement-master/build/mediaelement-and-player.js"></script>
<link rel="stylesheet" href="http://barszczewska.pl/mediaelement-master/build/mediaelementplayer.css" />

</head>
<body>
<div id="tresc-strony">

<div style="background-image: url(http://barszczewska.pl/img/tlo_all.jpg);
...
jQuery(".foto-podstrona").css("background-image", "url(http://barszczewska.pl/img/img_robots.txt.jpg)");
...
<div class="submenu"><div><a href="http://barszczewska.pl/robots.txt/menu/1/home" class="ajax">HOME</a></div><div><a href="http://barszczewska.pl/robots.txt/menu/2/biografia" class="ajax">BIOGRAFIA</a></div><div><a href="http://barszczewska.pl/robots.txt/menu/3/role" class="ajax">ROLE</a></div><div><a href="http://barszczewska.pl/robots.txt/menu/4/galeria" class="ajax">GALERIA</a></div><div><a href="http://barszczewska.pl/robots.txt/menu/5/co-gdzie-kiedy" class="ajax">CO-GDZIE-KIEDY</a></div><div><a href="http://barszczewska.pl/robots.txt/menu/6/kontakt" class="ajax">KONTAKT</a></div></div>
</div>
...
<audio id="player1" src="http://barszczewska.pl/grazyna.mp3" controls="controls"></audio>
<script>
