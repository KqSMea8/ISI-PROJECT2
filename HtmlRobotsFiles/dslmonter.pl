...
<head>
<!--RSS-->
<link rel="bookmark" href="data/files/d717-big.jpg" />
<link rel="shortcut icon" href="data/files/d717-big.jpg" />
<link rel="apple-touch-icon" href="data/files/d717-big.jpg" /><script>var tinyMcePath="";</script><script src="tiny_mce/plugins/media/js/embed.js" type="text/javascript"></script>
...
<!--Google Fonts-->
<link href="//fonts.googleapis.com/css?family=Fira+Sans|Didact+Gothic&subset=latin,latin-ext" rel="stylesheet" type="text/css" /><link href="//fonts.googleapis.com/css?family=Fira+Sans|Didact+Gothic&text=eoaslzzcnEOASLZZCN" rel="stylesheet" type="text/css" />
...
</script><script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556055037"></script>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Sprzedaz,Montaz,drzwi ,fachowe doradztwo, okucia,klamki." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; DSL Monter s.c. drzwi do lepszego swiata</title>

</head>
<body class="" data-bgcolor="#B0BEC5" style="background:#B0BEC5" id="body"><link type="text/css" id="css_kColors" rel="stylesheet" href="data/template.colors.css?1507054066" />
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>D.S.L.MONTER s.c.</h2></div><!--Logo--></a>
</div>
<ul class="menuHolder topmenu"><li  ><a href="http://dslmonter.pl/"><span>Strona&nbsp;Glowna</span></a></li>
...
<div id="subpageHeaderBanner" data-background="data/files/zdkatalog-nova.jpg" data-parallax="1"  data-align="keditRight"  class=" parallax-window  keditDark  koHeaderAutoHeight  koHeaderHide  keditRight " style="background: url(data/files/zdkatalog-nova.jpg) no-repeat 50% 0px;background-size:cover">
</div>
...
<li><a href="1_10_klamki.html"><span>Klamki</span></a></li>
<li><a href="1_5_drzwi-dewro.html"><span>Drzwi&nbsp;Dewro</span></a></li>
</ul>Blad 404: Strona nie istnieje!</div>
...
<div class="row">
<div class="col-sm-7">
<div id="keditFooterEditable" data-kedit="footerContent"><div>Copyright &copy;2016<span style="color: #993366;"> mkopec29</span>, Wszelkie Prawa Zastrzezone</div></div>
</div>
<div class="col-sm-5 footerHolder">
<div id="keditFooterModule"><span id="footerHitCounter">Liczba odwiedzin: 1174</span></div>
</div>
</div>
</div>
</div>
