...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556068436"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Geodezja Geodeta Obsluga Budowy Zgorzelec Bogatynia Luban Boleslawiec Jelenia Gora - Podzial Inwentaryzacja Tyczenie" />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; GeoRepro Geodezja Jacek Januchta Geodeta</title>
...
<a href="index.php" class="logo"><div id="logoReplacer" style="text-align:center"><h2>GeoRepro</h2><h4>Geodezja i Kartogrtafia</h4></div><!--Logo--></a>
...
<li ><a href="index.php?p=1_2_firma"><span>Firma</span></a></li>
<li ><a href="index.php?p=1_3_uslugi"><span>Uslugi</span></a></li>
<li ><a href="index.php?p=1_4_kontakt"><span>Kontakt</span></a></li>
<li ><a href="index.php?p=1_5_rekomendacje"><span>Rekomendacje</span></a></li>
...
<div class="margins">Copyright (c)<!--?php echo date("Y")?--> GEOREPRO,<br /> Wszelkie Prawa Zastrzezone <br /> <br /> <ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/GeoRepro-337574113562592"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></div>
</div>        </div>
</div>
</div>
</div>
