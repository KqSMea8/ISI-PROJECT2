...
<script>var menuCaption = "Wybierz Strone";</script><script type="text/javascript" src="inc/js/menu.js?1556055796"></script>

<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="description" content="Dzwigi 15 - 60 ton - wynajem samojezdnych zurawi teleskopowych - uslugi dzwigowe: Gdansk, Gdynia, Rumia, Reda, Wejherowo, Lebork, Puck, Wladyslawowo, Jastarnia, Hel, Chwaszczyno, Koleczkowo, Lezyce, Trojmiasto." />
<meta name="keywords" content="" />
<title>Blad 404: Strona nie istnieje! &raquo; MGT - uslugi dzwigowe Kolinski - Gdynia, Rumia, Puck, pomorskie</title>
...
<link href="http://fonts.googleapis.com/css?family=Armata|Armata&subset=latin-ext" rel="stylesheet" type="text/css" />
<style type="text/css">h1,h2,#content h3,#footer h3,.topmenu{font-family:"Armata","Helvetica Neue",Helvetica,Arial,sans-serif}body,p{font-family:"Armata","Helvetica Neue",Helvetica,Arial,sans-serif}.container_content{background-image:url(mobile crane);}</style>

</head>
<body><link type="text/css" id="css_kColors" rel="stylesheet" href="data/colors_wall.css?1530362479" /><link type="text/css" rel="stylesheet" href="style_extra.css?2.0.2" /><style>#splash .splashText{text-shadow: 2px 2px 15px rgba(0,0,0,1),1px 1px 5px rgba(0,0,0,0.5),1px 1px 2px rgba(0,0,0,0.7);}</style>
...
<a href="index.php" class="logo"><img src="data/files/mgtcranesoryginaszary_1530359864.png" style="border:0" id="WebsiteLogo" alt="MGT zurawie teleskopowe. Uslugi dzwigowe MeGatron Piotr Kolinski" /></a>
...
<li ><a href="http://dzwigi-megatron.pl/"><span>Witamy&nbsp;</span></a></li>
<li ><a href="oferta"><span>Oferta</span></a></li>
<li ><a href="parametry"><span>Parametry</span></a></li>
<li ><a href="dojazd"><span>Dojazd</span></a></li>
...
<div class="container_splash2 adminTipHolder"><div class="container"><div class="grid_16" id="splash2"><h3 style="text-align: center;"><span style="color: #c0c0c0; font-size: 20px;"><a title="Zasady dzialania dzwigow samojezdnych" href="http://dzwigi-megatron.pl/#opis"><span style="color: #c0c0c0;">ZURAWIE&nbsp; SAMOJEZDNE</span></a></span></h3></div></div></div>
...
<div class="margins"><span style="color: #000000;"><strong><span style="font-size: 20px;">NIP&nbsp;&nbsp; 9580996043<br /></span></strong></span><span style="color: #000000;"><strong><span style="font-size: 20px;">Regon&nbsp;&nbsp; 222176075<br /><br />PKO BP&nbsp;&nbsp; 56 1020 1912 0000 9102 0125 6924<br /></span></strong></span></div>
</div>
<div class="FooterCopyright span4 footerSpan">
<div class="margins"><span style="color: #000000;">Copyright (c) 2015<!--?php echo date("Y")?--> MEGATRON</span><br /><span style="color: #000000;"> Wszelkie Prawa Zastrzezone</span> <br /> <br /> <span style="color: #000000;"><ul class="social_fa social_bw social_bwh social_footer"><a target="_blank" href="http://www.facebook.com/MGT.Kolinski"><i class="fa fa-facebook-square fa-2x fa-fw"></i></a></ul><style></style></span></div>
</div>        </div>
</div>
</div>
</div>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-137365927-1']);
